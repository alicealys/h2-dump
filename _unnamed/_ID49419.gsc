...
_ID616()
{
    thread _unknown_0616();
    thread _unknown_0631();
    level._ID1426["cold_breath"] = _func_155( "fx/misc/cold_breath" );
    ...
    level._ID1426["smoke_geotrail_icbm"] = _func_155( "fx/smoke/smoke_geotrail_icbm" );
    level._ID1426["icbm_launch"] = _func_155( "fx/smoke/icbm_launch" );
    level._ID1426["tree_explosion"] = _func_155( "fx/explosions/tree_trunk_explosion" );
    level._ID1426["tree_explosion_small"] = _func_155( "fx/explosions/tree_trunk_explosion" );
    level._ID1426["thermal_missle_flash_inverted"] = _func_155( "fx/muzzleflashes/thermal_missle_flash_inverted" );
    level._ID1426["missle_flash"] = _func_155( "fx/muzzleflashes/missile_flash_wv" );
    level._ID1426["uav_explosion"] = _func_155( "fx/explosions/aerial_explosion_predator" );
    level._ID1426["btr_explosion"] = _func_155( "fx/explosions/vehicle_explosion_btr80_snow" );
    level._ID1426["btr_spotlight"] = _func_155( "fx/misc/spotlight_btr80" );
    level._ID1426["flashlight"] = _func_155( "fx/misc/flashlight" );
    level._ID1426["tear_gas_submarine"] = _func_155( "fx/smoke/tear_gas_submarine" );
    level._ID1426["tree_snow_dump_fast"] = _func_155( "fx/snow/tree_snow_dump_fast" );
    level._ID1426["tree_snow_dump_fast_small"] = _func_155( "fx/snow/tree_snow_dump_fast_small" );
    level._ID1426["tree_snow_fallen_heavy"] = _func_155( "fx/snow/tree_snow_fallen_heavy" );
    level._ID1426["tree_snow_fallen"] = _func_155( "fx/snow/tree_snow_fallen" );
    level._ID1426["tree_snow_fallen_small"] = _func_155( "fx/snow/tree_snow_fallen_small" );
    level._ID1426["price_landing"] = _func_155( "fx/snow/snow_price_landing" );
    level._ID1426["price_sliding"] = _func_155( "fx/snow/snow_price_sliding" );
    level._ID1426["footstep_snow_price_laying_down"] = _func_155( "vfx/snow/footstep_snow_price_laying_down" );
    level._ID1426["tree_snow_dump_runner"] = _func_155( "fx/snow/tree_snow_dump_runner" );
    level._ID1426["snow_spray_detail_contingency_runner_0x400"] = _func_155( "fx/snow/snow_spray_detail_contingency_runner_0x400" );
    level._ID1426["snow_spray_detail_oriented_runner_0x400"] = _func_155( "fx/snow/snow_spray_detail_oriented_runner_0x400" );
    level._ID1426["snow_spray_detail_oriented_runner_400x400"] = _func_155( "fx/snow/snow_spray_detail_oriented_runner_400x400" );
    level._ID1426["snow_spray_detail_oriented_runner"] = _func_155( "fx/snow/snow_spray_detail_oriented_runner" );
    level._ID1426["snow_spray_detail_oriented_runner_large"] = _func_155( "fx/snow/snow_spray_detail_oriented_large_runner" );
    level._ID1426["snow_spray_large_oriented_runner"] = _func_155( "fx/snow/snow_spray_large_oriented_runner" );
    level._ID1426["snow_vortex_runner_cheap"] = _func_155( "fx/snow/snow_vortex_runner_cheap" );
    level._ID1426["room_smoke_200"] = _func_155( "fx/smoke/room_smoke_200" );
    level._ID1426["heater"] = _func_155( "fx/distortion/heater" );
    level._ID1426["footstep_snow_small"] = _func_155( "fx/impacts/footstep_snow_small" );
    level._ID1426["footstep_snow"] = _func_155( "fx/impacts/footstep_snow" );
    level._ID1426["snow_light"] = _func_155( "fx/snow/snow_light_contingency" );
    level._ID1426["submarine_red_light_contingency"] = _func_155( "fx/misc/submarine_red_light_contingency" );
    level._ID1426["submarine_green_light_contingency"] = _func_155( "fx/misc/submarine_green_light_contingency" );
    level._ID1426["godray_foliage_contingency"] = _func_155( "vfx/map/greece/godray_foliage_contingency" );
    level._ID1426["contingency_mountain_clouds"] = _func_155( "vfx/cloud/contingency_mountain_clouds" );
    level._ID1426["snow_spray_detail_flatground_directional"] = _func_155( "fx/snow/snow_spray_detail_flatground_directional" );
    level._ID1426["light_wall_contingency"] = _func_155( "vfx/lights/light_wall_contingency" );
    level._ID1426["heat_distortion_food_heater"] = _func_155( "vfx/map/mp_lost/heat_distortion_food_heater" );
    level._ID1426["snow_spray_detail_oriented_runner_shadowed"] = _func_155( "fx/snow/snow_spray_detail_oriented_runner_shadowed" );
    level._ID1426["godray_contingency"] = _func_155( "vfx/lights/godray_contingency" );
    level._ID1426["vent_snow_contingency"] = _func_155( "vfx/snow/vent_snow_contingency" );
    level._ID1426["snow_spray_detail_flatground_indoor"] = _func_155( "fx/snow/snow_spray_detail_flatground_indoor" );
    level._ID1426["tread_snow_slush_btr80_set"] = _func_155( "fx/treadfx/tread_snow_slush_btr80_set" );
    level._ID1426["contingency_btr80_tree_explosion_01"] = _func_155( "vfx/explosion/contingency_btr80_tree_explosion_01" );
    level._ID1426["contingency_fallingtree_followthrough_01"] = _func_155( "fx/snow/contingency_fallingtree_followthrough_01" );
    level._ID1426["contingency_fallingtree_impact_snow"] = _func_155( "vfx/smoke/contingency_fallingtree_impact_snow" );
    level._ID1426["tree_snow_dump"] = _func_155( "fx/snow/tree_snow_dump" );
    level._ID1426["contingency_btr_snow_impact_runner"] = _func_155( "vfx/weaponimpact/contingency_btr_snow_impact_runner" );
    level._ID1426["airdust_contingency"] = _func_155( "vfx/lights/airdust_contingency" );
    level._ID1426["lighthaze_snow_headlights"] = _func_155( "fx/misc/lighthaze_snow_headlights" );
    level._ID1426["car_taillight_uaz_l"] = _func_155( "fx/misc/car_taillight_uaz_l" );
    level._ID1426["contingency_mountain_wind_01"] = _func_155( "vfx/cloud/contingency_mountain_wind_01" );
    level._ID1426["tread_snow_slush_btr80_right_brake_set"] = _func_155( "fx/treadfx/tread_snow_slush_btr80_right_brake_set" );
    level._ID1426["bmp_flash_wv"] = _func_155( "fx/muzzleflashes/bmp_flash_wv" );
    level._ID1426["contingency_btr80_straffing_flashes"] = _func_155( "fx/muzzleflashes/contingency_btr80_straffing_flashes" );
    level._ID1426["helicopter_crash_explosion_02"] = _func_155( "vfx/explosion/helicopter_crash_explosion_02" );
    level._ID1426["emergency_light_contingency"] = _func_155( "vfx/lights/emergency_light_contingency" );
    level._ID1426["birds_tree_flyout_contingency"] = _func_155( "vfx/animal/birds_tree_flyout_contingency" );
    level._ID1426["bird_vulture_circle_a_loop"] = _func_155( "vfx/animal/bird_vulture_circle_a_loop" );
    level._ID1426["bird_seagull_flock_large"] = _func_155( "vfx/animal/bird_seagull_flock_large" );
    level._ID1426["contingency_submarine_snow_cover_puff"] = _func_155( "vfx/snow/contingency_submarine_snow_cover_puff" );
    level._ID1426["soft_haze_window_white"] = _func_155( "vfx/lights/soft_haze_window_white" );
    level._ID1426["goldenpath_door"] = _func_155( "vfx/unique/godray_path_door_contingency" );
    level._ID1426["sunflare"] = _func_155( "vfx/lensflare/fx_sunflare_contingency" );
    level._ID1426["btrattack_cannon_impact"] = _func_155( "vfx/weaponimpact/30mm_snow_impact_1" );
    level._ID1426["tree_snow_fall_staged"] = _func_155( "fx/snow/tree_snow_fall_staged" );
    level._ID1426["bushes_snow_reaction"] = _func_155( "fx/misc/bushes_snow_reaction" );
    level._ID1426["snow_spray_detail_oriented_gravity_runner"] = _func_155( "fx/snow/snow_spray_detail_oriented_gravity_runner" );
    level._ID1426["contingency_btr80_tree_explosion_02"] = _func_155( "vfx/explosion/contingency_btr80_tree_explosion_02" );
    level thread _unknown_05E2();
    level thread _unknown_0555();
    level thread _unknown_056F();
    level thread _unknown_054D();
...
_ID54162()
{
    ...
    for (;;)
    {
        _func_156( level._ID1426["snow_light"], var_0._ID740 + ( 0, 0, 300 ), var_0._ID740 + ( 0, 0, 350 ) );
        wait 0.075;
    }
}
...
_ID52984()
{
    animscripts\utility::_ID32631( "snow", _func_155( "fx/impacts/footstep_snow" ) );
    animscripts\utility::_ID32631( "ice", _func_155( "fx/impacts/footstep_ice" ) );
    animscripts\utility::_ID32631( "slush", _func_155( "fx/impacts/footstep_snow_slush" ) );
    animscripts\utility::_ID32632( "snow", _func_155( "fx/impacts/footstep_snow_small" ) );
    animscripts\utility::_ID32632( "ice", _func_155( "fx/impacts/footstep_ice" ) );
    animscripts\utility::_ID32632( "slush", _func_155( "fx/impacts/footstep_snow_slush_small" ) );
    animscripts\utility::_ID32706( "bodyfall small", "J_SpineLower", "snow", _func_155( "fx/impacts/bodyfall_snow_small_runner" ), "bodyfall_", "_small" );
    animscripts\utility::_ID32706( "bodyfall small", "J_SpineLower", "ice", _func_155( "fx/impacts/bodyfall_snow_small_runner" ), "bodyfall_", "_small" );
    animscripts\utility::_ID32706( "bodyfall large", "J_SpineLower", "snow", _func_155( "fx/impacts/bodyfall_snow_large_runner" ), "bodyfall_", "_large" );
    animscripts\utility::_ID32706( "bodyfall large", "J_SpineLower", "ice", _func_155( "fx/impacts/bodyfall_snow_large_runner" ), "bodyfall_", "_large" );
    animscripts\utility::_ID32706( "knee fx left", "J_Knee_LE", "snow", _func_155( "fx/impacts/footstep_snow" ) );
    animscripts\utility::_ID32706( "knee fx left", "J_Knee_LE", "ice", _func_155( "fx/impacts/footstep_snow" ) );
    animscripts\utility::_ID32706( "knee fx left", "J_Knee_LE", "slush", _func_155( "fx/impacts/footstep_snow" ) );
    animscripts\utility::_ID32706( "knee fx right", "J_Knee_RI", "snow", _func_155( "fx/impacts/footstep_snow" ) );
    animscripts\utility::_ID32706( "knee fx right", "J_Knee_RI", "ice", _func_155( "fx/impacts/footstep_snow" ) );
    animscripts\utility::_ID32706( "knee fx right", "J_Knee_RI", "slush", _func_155( "fx/impacts/footstep_snow" ) );
    level._ID1426["landing_snow"] = _func_155( "fx/snow/snow_price_landing" );
    level._ID1426["landing_snow_small"] = _func_155( "fx/snow/snow_price_landing" );
    level._ID1426["crawling_snow"] = _func_155( "fx/impacts/h2_fx_crawling_snow" );
}
