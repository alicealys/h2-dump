...
_id_C525()
{
    ...
    {
        var_1 = var_0 gettagorigin( "tag_driver" ) + ( 0.0, 0.0, 30.0 );
...
_id_AFD3()
{
    ...
    var_3 = maps\_utility::spawn_anim_model( "snowmobile_player_detached", var_2.origin - ( 0.0, 0.0, 60.0 ), var_2.angles );
    var_3 linkto( var_2 );
    ...
    for (;;)
    {
        ...
        if ( var_9 <= 0.0 )
        {
            var_2.slidevelocity = ( 0.0, 0.0, 0.0 );
            continue;
        }
