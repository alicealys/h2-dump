...
_id_BD5C()
{
    ...
    level._id_D2D2 = spawn( "script_model", ( 0.0, 0.0, 0.0 ) );
...
_id_B885()
{
    ...
    var_0 = 0.8;
    level.ground_ref_ent rotateto( ( 0.0, 0.0, 0.0 ), var_0, var_0 * 0.5, var_0 * 0.5 );
    wait(var_0);
...
_id_BEBD()
{
    ...
    for (;;)
    {
        ...
        var_7 = var_8;
        var_12 = distance( ( 0.0, 0.0, 0.0 ), level.player getvelocity() );
        var_2 += var_12 * 0.06;
