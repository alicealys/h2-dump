...
_ID19906()
{
    ...
    if ( !_func_02F( level._ID15079["create_triggerfx"] ) )
        level._ID15079["create_triggerfx"] = ::_unknown_0305;

    if ( !_func_02F( level._ID1461 ) )
        level._ID1461 = _func_1A5();
    ...
    if ( _func_03A( "serverCulledSounds" ) == 1 )
    ...
    for ( var_1 = 0; var_1 < level._ID9242.size; var_1++ )
    {
        ...
        if ( _func_02F( var_2._ID40005["stop_on_exploder"] ) )
            var_2 thread _ID42229::_ID43432();

        var_2 _unknown_017C( var_0 );
        case "oneshotfx":
        case "loopfx":
        case "reactive_fx":
...
{
    if ( _func_039( "debug" ) == "1" )
        return;
}

_ID26770()
{
    if ( _func_02F( self._ID40005["platform"] ) && _func_02F( level._ID227 ) )
    {
...
_ID13629( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16, var_17 )
{
    if ( 1 )
    {
        ...
        if ( _func_02F( var_4 ) )
            var_18._ID40005["angles"] = _func_11A( var_4 - var_2 );
    ...
    var_20._ID740 = var_2;
    var_20._ID65 = _func_11A( var_4 - var_2 );
    ...
    var_21 = _func_11F( var_20._ID65 );
    var_21 *= 150;
    var_20._ID37339 = var_2 + var_21;

    if ( !_func_02F( level._ID1585 ) )
        level._ID1585 = [];
...
_ID22655( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( _func_02F( var_3 ) )
        var_7._ID40005["angles"] = _func_11A( var_3 - var_1 );
...
_ID9164()
{
    self._ID22654 = _func_15A( level._ID1426[self._ID40005["fxid"]], self._ID40005["delay"], self._ID40005["origin"], 0, self._ID40005["forward"], self._ID40005["up"] );
    _unknown_055D();
}
...
_ID9165()
{
    ...
    if ( !_func_02F( self._ID40005["soundalias"] ) )
        return;
    ...
    if ( _func_02F( self._ID40005["stopable"] ) && self._ID40005["stopable"] )
        var_1 = "stop_loop";
    else if ( level._ID1461._ID32161 && _func_02F( self._ID40005["server_culled"] ) )
...
_ID9158()
{
    ...
    if ( _func_02F( self._ID40005["stopable"] ) && self._ID40005["stopable"] || level._ID9228 )
    {
...
_ID9138()
{
    ...
    if ( !_func_02F( self._ID40005["ambiencename"] ) )
        return;
    ...
    if ( _func_02F( self._ID9679 ) )
        level._ID794 _meth_848D( self._ID9679._ID39468 );

    self._ID9679 = _func_1A5();
...
_ID22662()
{
    ...
    for (;;)
    {
        ...
        if ( _func_02F( self._ID37742 ) )
            thread _unknown_07C5( self._ID37742 );

        if ( _func_02F( self._ID15293 ) )
...
{
    self endon( "death" );
    var_1 waittill( "effect id changed",  var_1  );
}
...
{
    self endon( "death" );
    var_1 waittill( "effect delay changed",  var_1  );
}
...
{
    level thread _unknown_086D( var_0, var_1, var_2 );
}
...
{
    thread _unknown_08AF( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 );
}
...
_ID17518( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_13 = var_2;
    var_14 = var_3 - var_2;
    var_15 = _func_15B( level._ID1426[var_0], var_1 );
    ...
    for (;;)
    {
        var_16 = var_13 + _func_0B7( var_14 );

        for ( var_17 = 0; var_17 < var_16; var_17++ )
        {
            _func_15C( var_15 );
            wait(var_11 + _func_0B8( var_12 ));
        }

        wait(var_9 + _func_0B8( var_10 ));
    }
}

_ID17519( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    thread _unknown_098E( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 );
}
...
_ID17520( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_14 = var_3;
    var_15 = var_4 - var_3;
    var_2 = _func_119( var_2 - var_1 );
    var_16 = _func_15B( level._ID1426[var_0], var_1, var_2 );
    ...
    for (;;)
    {
        var_17 = var_14 + _func_0B7( var_15 );

        for ( var_18 = 0; var_18 < _func_0C1( var_17 / level._ID15273 ); var_18++ )
        {
            _func_15C( var_16 );
            var_19 = var_12 + _func_0B8( var_13 ) * level._ID15273;
        ...
        wait(var_12 + _func_0B8( var_13 ));
        wait(var_10 + _func_0B8( var_11 ));
    }
}
...
_ID33057()
{
    if ( !_func_02F( self._ID31220 ) || !_func_02F( self._ID31219 ) || !_func_02F( self._ID916 ) )
        return;
    ...
    if ( _func_02F( self._ID31221 ) )
        var_2 = self._ID31221;

    var_3 = undefined;

    if ( _func_02F( self._ID31222 ) )
        var_3 = self._ID31222;

    if ( self._ID31219 == "OneShotfx" )
        _unknown_0925( self._ID31220, self._ID740, self._ID916, var_0 );

    if ( self._ID31219 == "loopfx" )
        _unknown_09A8( self._ID31220, self._ID740, self._ID916, var_0, var_2, var_3 );

    if ( self._ID31219 == "loopsound" )
        _unknown_0AA6( self._ID31220, self._ID740, self._ID916 );
...
_ID6444()
{
    ...
    var_2 = self._ID740;
    wait 1;
    level thread _unknown_0B96( var_0, var_2, var_1 );
    self _meth_80B7();
}
...
_ID6445( var_0, var_1, var_2 )
{
    for (;;)
    {
        _func_156( var_2, var_1 );
        wait(30 + _func_0B8( 40 ));
    }
}

_ID9184()
{
    if ( !_unknown_0C1C( self._ID40005["fxid"] ) )
        return;
    ...
    if ( _func_02F( self._ID40005["tintcolor"] ) || _func_02F( self._ID40005["tintalpha"] ) || _func_02F( self._ID40005["emissive"] ) || _func_02F( self._ID40005["sizescale"] ) )
    {
        ...
        self._ID22654 = _func_15B( level._ID1426[self._ID40005["fxid"]], self._ID40005["origin"], self._ID40005["forward"], self._ID40005["up"], var_0, var_1, var_2, var_3 );
    }
    else
        self._ID22654 = _func_15B( level._ID1426[self._ID40005["fxid"]], self._ID40005["origin"], self._ID40005["forward"], self._ID40005["up"] );

    _func_15C( self._ID22654, self._ID40005["delay"] );
    var_4 = _func_02F( self._ID40005["kill_on_delete"] ) && self._ID40005["kill_on_delete"] || level._ID9228;

    if ( var_4 )
        _func_15E( self._ID22654, 1 );

    if ( !level._ID9228 )
        self._ID22654 _meth_80E8();
...
_ID1933()
{
    ...
    if ( !_ID42237::_ID20913() && _func_039( "createfx" ) == "" )
        return;

    if ( !_func_02F( level._ID1461._ID29075 ) )
    {
        level._ID1461._ID29075 = 1;
        level thread _unknown_0E25();
    }

    if ( !_func_02F( level._ID1461._ID29072 ) )
...
_ID29073()
{
    ...
    for (;;)
    {
        level waittill( "code_damageradius",  var_3, var_2, var_0, var_1  );
        var_4 = _unknown_0EB0( var_2, var_0 );
        var_5 = var_4;

        for ( var_7 = _func_1DA( var_5 ); _func_02F( var_7 ); var_7 = _func_1BF( var_5, var_7 ) )
        {
            var_6 = var_5[var_7];
            var_6 thread _unknown_0F23( var_7 );
        }
...
_ID34965( var_0, var_1 )
{
    ...
    for ( var_7 = _func_1DA( var_4 ); _func_02F( var_7 ); var_7 = _func_1BF( var_4, var_7 ) )
    {
        ...
        if ( _func_0F5( var_0, var_5._ID40005["origin"] ) < var_6 )
    ...
    {
        var_5 = var_8[var_13];
        var_9 = _unknown_0F5A( var_5._ID40005["origin"] - level._ID794._ID740 );
        var_10 = _unknown_0F67( var_0 - level._ID794._ID740 );
        var_11 = _func_119( var_9 );
        var_12 = _func_119( var_10 );
        var_5._ID11651 = _func_0FB( var_11, var_12 );
    }
...
_ID27035( var_0 )
{
    ...
    self._ID24771 = _func_03D() + 3000;
    var_1._ID740 = self._ID40005["origin"];
    var_1._ID20591 = 1;
    wait(var_0 * _func_0BA( 0.05, 0.1 ));

    if ( _ID42237::_ID20913() )
    {
        var_1 _meth_80A1( self._ID40005["soundalias"], "sounddone" );
        var_1 waittill( "sounddone" );
    }
    else
    {
        var_1 _meth_80A1( self._ID40005["soundalias"] );
        wait 2;
    }
...
_ID48953( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_2 && _func_02F( var_1._ID49814 ) )
        var_0[var_1._ID49814] = 1;

    if ( var_3 && _func_02F( var_1._ID49523 ) )
...
_ID51293( var_0, var_1, var_2 )
{
    ...
    if ( _func_0D3( var_0 ) )
    {
        ...
        {
            var_5 = var_4[var_6];
            var_3 = _unknown_11B8( var_3, var_5, var_1, var_2 );
        }
        ...
        var_3 = _unknown_11CE( var_3, var_0, var_1, var_2 );
...
_ID51666()
{
    ...
    if ( _func_02F( level._ID43431 ) )
        var_3[var_3.size] = level._ID43431;

    var_4 = _unknown_1203( var_3 );
    var_5 = var_4;

    for ( var_7 = _func_1DA( var_5 ); _func_02F( var_7 ); var_7 = _func_1BF( var_5, var_7 ) )
    {
        var_6 = var_5[var_7];
        thread _unknown_1243( var_7 );
    }
...
_ID50726()
{
    if ( _func_02F( level._ID46048 ) )
    {
        if ( level._ID46048 == _func_03D() )
            return;
    ...
    level._ID46048 = _func_03D();
    waitframe;
    var_0 = 0;
    var_1 = 50;

    if ( _func_02F( level._ID45157 ) )
    ...
    for ( var_9 = _func_1DA( var_5 ); _func_02F( var_9 ); var_9 = _func_1BF( var_5, var_9 ) )
    {
        ...
        if ( !_func_02F( var_6 ) || !_func_02F( var_6._ID40005["fx_volume_groups"] ) )
            continue;

        var_7 = var_6 _unknown_1373();
        var_8 = _func_02F( var_6._ID22654 );
        ...
        var_0 = _unknown_131D( var_0, var_1 );
    }
    ...
    for ( var_11 = _func_1DA( var_10 ); _func_02F( var_11 ); var_11 = _func_1BF( var_10, var_11 ) )
    {
        ...
        var_0 = _unknown_1344( var_0, var_1 );
    }
    ...
    for ( var_13 = _func_1DA( var_12 ); _func_02F( var_13 ); var_13 = _func_1BF( var_12, var_13 ) )
    {
        ...
        if ( _func_02F( var_6._ID22654 ) && !_func_02F( var_6._ID40005["kill_on_delete"] ) || _func_02F( var_6._ID40005["kill_on_delete"] ) && !var_6._ID40005["kill_on_delete"] )
        {
            var_4[var_4.size] = var_6._ID22654;
            _func_15E( var_6._ID22654, 1 );
        }

        var_0 = _unknown_13BC( var_0, var_1 );
    }
...
_ID50157()
{
    ...
    if ( !_func_02F( self._ID40005["fx_volume_groups"] ) )
        return 1;
    ...
    {
        var_2 = [];
        var_3 = self._ID40005["fx_volume_groups"];
        ...
        var_clear_3
        var_clear_0
        var_0 = _unknown_141A( var_2, 1, 0 );
        var_1 = _unknown_1422( var_2, 0, 1 );
    }
    else if ( _func_02F( level._ID43431 ) )
    {
        var_0 = _unknown_1423( var_0, level._ID43431, 1, 0 );
        var_1 = _unknown_142E( var_1, level._ID43431, 0, 1 );
    }
    ...
    if ( var_1.size != 0 )
    {
        ...
        for ( var_10 = _func_1DA( var_12 ); _func_02F( var_10 ); var_10 = _func_1BF( var_12, var_10 ) )
        {
            var_9 = var_12[var_10];
