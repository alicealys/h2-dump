...
_ID20951()
{
    ...
    if ( isdefined( self._ID322 ) && self seerecently( self._ID322, 1.5 ) && distancesquared( self._ID740, self._ID322._ID740 ) < 250000 )
...
_ID6911( var_0 )
{
    ...
    if ( isdefined( self._ID322 ) && distancesquared( self._ID322._ID740, var_0._ID740 ) < 65536 )
        return 0;
...
_ID10668( var_0 )
{
    ...
    if ( isdefined( var_0._ID3370 ) )
        var_4 = var_0._ID3370;
    else if ( isdefined( var_0._ID170 ) && var_0._ID170 == "script_origin" )
        var_4 = "stand";
    else
...
_ID16132( var_0, var_1 )
{
    if ( var_1 == "stand_saw" )
    {
        ...
        var_3 = anglestoforward( ( 0, var_0._ID39350._ID65[1], 0 ) );
        var_4 = anglestoright( ( 0, var_0._ID39350._ID65[1], 0 ) );
...
_ID7413( var_0, var_1, var_2 )
{
    ...
    {
        if ( animscripts\utility::_ID1735( vectortoyaw( var_1 ) - var_2._ID65[1] + 180 ) < 60 )
            return 0;
    }
...
_ID8863( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( abs( self getmotionangle() ) > 45 && isdefined( self._ID322 ) && vectordot( anglestoforward( self._ID65 ), vectornormalize( self._ID322._ID740 - self._ID740 ) ) > 0.8 )
        return 0;
    ...
    {
        if ( isdefined( self._ID322 ) && self cansee( self._ID322 ) && distancesquared( self._ID740, self._ID322._ID740 ) < 65536 )
        {
            if ( vectordot( anglestoforward( self._ID65 ), self._ID322._ID740 - self._ID740 ) > 0 )
                return 0;
        }
    }
...
_ID3265( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        var_4 = distance( self._ID740, self._ID762 );
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            var_9 = vectornormalize( var_2._ID54001 - self._ID740 );
        ...
        if ( level._ID912 == "scoutsniper" && self getanimweight( %h1_sprint_loop ) > 0.5 )
            var_10 *= 1.25;
...
_ID36105( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_9 = vectordot( var_4, anglestoforward( var_5._ID65 ) ) >= 0;
    ...
    if ( var_10 <= 6 && var_9 )
    {
        ...
        var_11 = vectornormalize( var_1 - self._ID740 );
...
_ID7415( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_12 = distancesquared( var_0, self._ID740 );
    ...
    if ( var_12 < var_13 * 2 * 2 )
    {
        ...
        if ( !var_6 )
        {
            var_14 = vectornormalize( self._ID8869 - self._ID740 );
...
_ID11502()
{
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            ...
            if ( isdefined( self._ID8869 ) && isdefined( self._ID762 ) && distance2d( self._ID8869, self._ID762 ) < 1 )
                continue;
...
_ID13708( var_0, var_1 )
{
    ...
    {
        if ( !self._ID373 && ( !isdefined( var_0 ) || var_0._ID1244 == "Path" || var_0._ID1244 == "Path 3D" ) )
            return 0;
    ...
    if ( !self maymovetopoint( self._ID762, 1, 0, level._ID49979 ) )
        return 0;
...
_ID13755( var_0 )
{
    ...
    if ( self._ID199 == "cover" && issentient( self._ID322 ) && gettime() - self lastknowntime( self._ID322 ) > 15000 )
        return 0;

    if ( _ID42237::_ID14385( "_cloaked_stealth_enabled" ) )
        return self cansee( self._ID322 );

    return sighttracepassed( self._ID322 getshootatpos(), self._ID762 + ( 0, 0, 60 ), 0, undefined );
}
...
_ID52311()
{
    var_0 = vectornormalize( self._ID762 - self._ID740 );
    return var_0;
}
...
_ID43389( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self._ID13754 ) )
        ...
        var_3 = vectortoyaw( self._ID322._ID740 - self._ID762 );
    else
    {
...
_ID11501()
{
    ...
    if ( isdefined( self._ID458 ) && isdefined( self._ID458._ID19 ) && self._ID458._ID19 == self )
        return;
    ...
    if ( isdefined( var_2 ) && isdefined( self._ID762 ) && !isdefined( self._ID11007 ) )
        var_3 = distancesquared( self._ID762, var_2._ID740 ) < var_1;
    else
        var_3 = 0;
    ...
    while ( isdefined( self._ID762 ) && isdefined( var_7 ) && distancesquared( self._ID740, self._ID762 ) > var_7 )
    {
        var_4 = _ID52311();
        var_5 = _ID43389( var_4, var_2, var_3 );
        var_6 = _ID48724( var_4, var_5, var_2, var_3, var_0 );
    ...
    var_8 = distance( self._ID740, self._ID762 );

    if ( abs( var_8 - var_6 ) > 8 )
        return;

    var_9 = vectortoyaw( self._ID762 - self._ID740 );

    if ( isdefined( self._ID18328 ) && var_3 )
    {
        var_10 = var_5 - animscripts\utility::_ID22635( "cover_trans_angles", var_0, self._ID3262 );
        var_11 = _ID16137( self._ID762, var_5, var_0, self._ID3262 );
    }
    ...
    else if ( var_6 > 0 )
    {
        ...
        if ( !isdefined( self._ID13754 ) || self._ID373 )
        {
            var_10 = var_9 - var_13;
        ...
        var_14 = var_8 - var_6;
        var_11 = self._ID740 + vectornormalize( self._ID762 - self._ID740 ) * var_14;
    }
    else
    {
        var_10 = self._ID65[1];
