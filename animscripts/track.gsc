...
_ID38149( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    for (;;)
    {
        ...
        else if ( isdefined( var_24 ) && isdefined( self._ID50737 ) && isdefined( self._ID322 ) )
            var_24 = self._ID322 getshootatpos();
        ...
        if ( isdefined( self._ID700 ) && isdefined( self._ID700._ID46953 ) && self._ID700._ID46953 != 0 )
            var_25 = 1;
        ...
        if ( self._ID7._ID28253 == "prone" )
        {
            ...
            var_30 = clamp( var_30, var_32._ID307, var_32._ID1252 );
            var_31 = clamp( var_31, var_32._ID590, var_32._ID894 );
        }
        else
        {
            var_32 = spawnstruct();
...
_ID38150( var_0, var_1 )
{
    ...
    {
        var_2 = self._ID322 getshootatpos() - self._ID322._ID740;
        var_3 = self lastknownpos( self._ID322 ) + var_2;
    ...
    if ( isdefined( self._ID700 ) && isdefined( anim._ID20711[self._ID700._ID1244] ) && distancesquared( self._ID740, self._ID700._ID740 ) < 16 )
        var_5 = angleclamp180( self._ID65[1] - self._ID700._ID65[1] );
    else
    {
        ...
        if ( isdefined( var_6 ) )
        {
            var_5 = angleclamp180( self._ID65[1] - var_6[1] );
...
_ID38153( var_0, var_1 )
{
    ...
    {
        var_7 = angleclamp180( self._ID278 - self._ID65[1] ) * 0.5;
...
_ID38151( var_0, var_1, var_2 )
{
    ...
    else
    {
        if ( self._ID475 )
            ...
            var_1 = clamp( var_1, self._ID590, self._ID894 );

        var_0 = clamp( var_0, self._ID307, self._ID1252 );
    }
...
_ID38154( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_6 > 0 )
    {
        var_11 = clamp( var_6 / self._ID50389._ID894 * self._ID7._ID2433, 0, 1 );
        var_10 = 1;
    }
    else if ( var_6 < 0 )
    {
        var_9 = clamp( var_6 / self._ID50389._ID590 * self._ID7._ID2433, 0, 1 );
        var_10 = 1;
    }
