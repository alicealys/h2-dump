...
main()
{
    ...
    self startscriptedanim( self._ID8196["notifyName"], self._ID8196["origin"], self._ID8196["angles"], self._ID8196["anim"], self._ID8196["animMode"], self._ID8196["root"], self._ID8196["goalTime"] );
    self._ID8196 = undefined;

    if ( isdefined( self._ID31544 ) || isdefined( self._ID13765 ) )
    {
