...
function CreateOptions( f7_arg0 )
	f7_arg0:AddButton( nil, nil, GamepadDisabledFunc, nil, nil, {
		...
		button_left_func = function ( f2_arg0, f2_arg1 )
		...
		button_right_func = function ( f3_arg0, f3_arg1 )
			return MouseDvarChange( f7_arg0.exclusiveController, SliderBounds.MouseSensitivity.Min, SliderBounds.MouseSensitivity.Max, SliderBounds.MouseSensitivity.Step, "sensitivity" )
		end,
...
LUI.LookControls.new = function ( f9_arg0, f9_arg1 )
	...
	f9_local1:registerEventHandler( "options_window_refresh", LUI.Options.OptionsWindowRefresh )
	f9_local1:registerEventHandler( "menu_close", OptionsMainClose )
	f9_local1:registerEventHandler( "popup_inactive", RefreshFunc( f9_local1 ) )
	f9_local1:addElement( LUI.H1MenuTab.new( {
		...
		top = f9_local0 + LUI.MenuTemplate.ListTop,
		...
		skipChangeTab = true,
		exclusiveController = f9_local1.exclusiveController
	} ) )
	CreateOptions( f9_local1 )
	LUI.Options.AddOptionTextInfo( f9_local1 )
	LUI.PCControlOptions.AddResetToDefaultButton( f9_local1 )
	f9_local1:AddBackButton()
	return f9_local1
end
