		...
		if not f3_local9 then
			...
			if f3_arg1 == "left" then
				...
				if not self then
					...
					local f3_local13 = LUI.UIImage.new( f3_local5 )
					f3_local13.id = "tab_select_arrow_id_" .. f3_arg1
					local f3_local14 = f3_local13
					local f3_local15 = f3_local13.registerAnimationState
					...
					f3_local15( f3_local14, f3_local16, f3_local17 )
					f3_local14 = f3_local13
					f3_local15 = f3_local13.registerAnimationState
					f3_local16 = "pulse"
					f3_local17 = {
						topAnchor = true
					}
					...
					f3_local15( f3_local14, f3_local16, f3_local17 )
					f3_local13:registerEventHandler( "button_over", MBh.AnimateToState( "buttonOver" ) )
					f3_local13:registerEventHandler( "button_up", MBh.AnimateToState( "default" ) )
					self:addElement( f3_local13 )
					if f0_local2 == f3_arg1 then
						f3_local13:animateInSequence( {
							{
								"buttonOver",
								0
							},
					...
					if f3_local8 then
						...
						if not f3_local14 then
							...
							f3_local15.top = f3_local14
							f3_local15.width = f3_arg3.shoulderButtonTextWidth
							if f3_local8 then
								f3_local14 = CoD.TextSettings.TitleFontMediumLarge.Height
								if not f3_local14 then
								
								else
									f3_local15.height = f3_local14
									f3_local15.alignment = LUI.Alignment.Center
									if f3_local8 then
										f3_local14 = CoD.TextSettings.TitleFontMediumLarge.Font
										if not f3_local14 then
										
										else
											f3_local15.font = f3_local14
											if not f3_arg2 then
												f3_local15.alpha = 0.5
											end
											f3_local14 = nil
											if f3_local8 then
												f3_local14 = LUI.UIText.new( f3_local15 )
												f3_local14:setText( Engine.ToUpperCase( Engine.Localize( f3_local2 ) ) )
											else
												f3_local14 = LUI.UIButtonText.new( f3_local15, Engine.ToUpperCase( Engine.Localize( f3_local2 ) ), f3_arg1 == "right", f3_arg2 )
											end
											f3_local14.id = "button_change_act_text_id_" .. f3_arg1
											f3_local14.requireFocusType = FocusType.MouseOver
							...
							f3_local14 = LUI.UIButtonText.height
						end
					end
					f3_local14 = 2
				end
...
function CreateTabSelectBarElements( f8_arg0, f8_arg1 )
	...
	local f8_local3 = CoD.CreateState( nil, f8_arg1.tabChangeBarsTop and f8_arg1.tabChangeBarsTop or LUI.H1MenuTab.tabChangeBarsTop, f8_arg1.width, nil, CoD.AnchorTypes.TopLeft )
	...
	for f8_local6 = 1, f8_local0, 1 do
		self:addElement( CreateBarElement( f8_arg0, f8_local6, (f8_local6 - 1) * (f8_local1 + f8_local2), f8_local2, f8_arg1 ) )
	end
	return self
end
...
function ConstructMenuTab( f11_arg0, f11_arg1 )
	...
	if f11_arg1.title then
		...
		f11_local4.font = CoD.TextSettings.H2TitleFont.Font
...
LUI.H1MenuTab.new = function ( f16_arg0 )
	...
	assert( f16_arg0.clickTabBtnAction, "Require function clickTabBtnAction(self, event, index) to know what action doing tab!" )
	...
	f16_local0.shoulderButtonWidth = f16_local0.shoulderButtonWidth and f16_local0.shoulderButtonWidth or LUI.H1MenuTab.shoulderButtonWidth
	f16_local0.shoulderButtonTextWidth = f16_local0.shoulderButtonTextWidth and f16_local0.shoulderButtonTextWidth or LUI.H1MenuTab.shoulderButtonTextWidth
	f16_local0.arrowHOffset = f16_local0.arrowHOffset and f16_local0.arrowHOffset or LUI.H1MenuTab.arrowHOffset
	f16_local0.arrowHOffsetTextButton = f16_local0.arrowHOffsetTextButton and f16_local0.arrowHOffsetTextButton or LUI.H1MenuTab.arrowHOffsetTextButton
	f16_local0.arrowBoxSize = f16_local0.arrowBoxSize and f16_local0.arrowBoxSize or LUI.H1MenuTab.arrowBoxSize
	f16_local0.tabChangeHeight = f16_local0.tabChangeHeight and f16_local0.tabChangeHeight or LUI.H1MenuTab.tabChangeHeight
	...
	f16_local1.height = f16_local0.tabChangeHoldingElementHeight and f16_local0.tabChangeHoldingElementHeight or LUI.H1MenuTab.tabChangeHoldingElementHeight
