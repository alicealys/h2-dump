...
main( var_0, var_1, var_2, var_3 )
{
    ...
    maps\_vehicle::build_deathfx( "fx/fire/helicopter_fire_engin", "tag_engine_right", undefined, 1, 0.5, undefined, undefined, 1, undefined );
    maps\_vehicle::build_deathfx( "fx/fire/helicopter_fire_engin", "tag_engine_left", undefined, 1, 0.5, undefined, 0.15, 1, undefined );
    maps\_vehicle::build_deathfx( "vfx/fire/helicopter_damaged_fire_ignition", "tag_origin", "hind_helicopter_secondary_exp", undefined, undefined, undefined, 1.5, 1, undefined );
    maps\_vehicle::build_deathfx( "vfx/fire/helicopter_damaged_fire_m", "tag_origin", undefined, 1, 0.5, undefined, 1.5, 1, undefined );
    maps\_vehicle::build_deathfx( "fx/fire/helicopter_main_rotor_explosion", "tag_origin", undefined, undefined, undefined, undefined, 1, 1, undefined );
    ...
    maps\_vehicle::build_deathfx( "fx/fire/helicopter_rotor_smoke_trail", "tail_rotor_jnt", "hind_helicopter_dying_loop", 1, 0.05, 1, 0.5, 1, undefined );
