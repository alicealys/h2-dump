...
saygenericdialogue( var_0 )
{
    ...
    switch ( self.voice )
    {
        ...
        case "delta":
            var_3 = "friendly";
            var_4 = anim.numfriendlyvoices;
            break;
        default:
            var_3 = "enemy";
            var_4 = anim.numenemyvoices;
            var_2 = 1;
    }
    ...
    switch ( var_0 )
    {
        ...
        case "dogdeathshort":
        case "death":
            if ( isdefined( self.attacker ) && isplayer( self.attacker ) && var_2 )
                var_0 += "_kbp";
    ...
    {
        var_7 = self.generic_voice_override + "_" + var_0 + "_" + var_3;
    ...
    thread playfacethread( var_5, var_7, var_6 );
}
...
get_eye_relative_dir()
{
    ...
    if ( isdefined( self.eye_move_counter ) && self.eye_move_counter > 4 && isdefined( self.script ) && self.script != "scripted" && self.script != "death" && self.script != "civilian_death" )
    {
