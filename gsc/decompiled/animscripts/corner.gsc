...
{
    if ( isdefined( self._id_BAD6 ) && self._id_BAD6 )
        return 0;
...
shouldlean()
{
    if ( !animscripts\utility::_id_BF95() && self.a.pose != "stand" )
        return 0;
...
stepout()
{
    ...
    if ( isdefined( self._id_BB9C ) && self._id_BB9C )
        return 0;
    ...
    if ( var_4 )
    {
        self.stepoutyaw = self.angles[1] + getmovedelta( var_3, 0, 1 );
...
{
    if ( self.a.pose == "crouch" && _id_C35D( self ) )
        return 0;
...
cornerreload()
{
    ...
    var_2 = animscripts\utility::animarraypickrandom( var_0 );
    var_3 = animscripts\combat_utility::_id_AEA4();
...
idle()
{
    ...
    {
        _id_B15F();
        var_1 = common_scripts\utility::ter_op( animscripts\utility::_id_BF29(), "alert_idle_twitch", "alert_idle_twitch_noHat" );

        if ( isdefined( self.nocornertwitchanim ) && self.nocornertwitchanim || var_0 > gettime() )
            var_2 = 0;
        else
            var_2 = randomint( 2 ) == 0 && isdefined( self.a.array[var_1] ) && animscripts\utility::animarrayanyexist( var_1 );
        ...
        if ( var_2 )
        {
            ...
            var_3 = animscripts\utility::animarraypickrandom( var_1 );
        }
        else
            var_3 = animscripts\utility::animarray( "alert_idle" );

        playidleanimation( var_3, var_2 );
    }
}
