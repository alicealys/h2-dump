...
_id_B3C8()
{
    if ( self.a.pose == "crouch" )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            animscripts\shared::donotetracks( "transition", ::_id_B115 );
        }
    }
}
...
_id_C23A()
{
    if ( isdefined( self._id_AA7A ) && self.a.pose == "prone" )
    {
        var_0 = undefined;
        var_1 = undefined;
...
_id_BBCB()
{
    if ( isdefined( self._id_C1C6 ) && self._id_C1C6 )
    {
        if ( self.a.pose == "crouch" && self.prevscript == "move" )
        {
...
transitiontocombat()
{
    ...
    if ( self.prevscript == "stop" && !animscripts\utility::iscqbwalking() && self.a.pose == "stand" && !self _meth_816F() )
    {
        resetanimmode();
        var_0 = undefined;
...
cantseeenemybehavior()
{
    ...
    else if ( isdefined( self.enemy ) && self seerecently( self.enemy, 2 ) || var_0 > self.a.scriptstarttime + 1200 )
    {
        ...
        else if ( isdefined( self.color_node ) && isdefined( self.animarchetype ) && self.animarchetype == "riotshield" && self.team == "allies" )
        {
            var_3 = 0;
            var_3 = common_scripts\utility::ter_op( self.color_node.type == "Cover Left", 68, var_3 );
            var_3 = common_scripts\utility::ter_op( self.color_node.type == "Cover Right", -68, var_3 );
            var_1 = angleclamp180( self.angles[1] - angleclamp( self.color_node.angles[1] + var_3 ) );
        }
    ...
    var_4 = self.a.nextgiveuponenemytime < var_0;
    var_5 = 0;

    if ( var_4 )
        var_5 = 0.99999;

    if ( exposedreload( var_5 ) )
        return 1;

    if ( var_4 && animscripts\utility::usingsidearm() )
    {
...
doturn( var_0, var_1 )
{
    ...
    if ( self.a.pose == "crouch" )
    {
        ...
        else if ( isdefined( self.turntomatchnode ) && isdefined( self.covernode ) && self.covernode.type == "Cover Crouch" )
        {
            var_9 = "exposed2cover_" + var_8;
            var_10 = 0.1;
        }

        if ( isdefined( self.a.array[var_9] ) )
        {
            var_8 = var_9;
            var_4 = var_10;
        }
    ...
    var_11 = animscripts\utility::animarray( var_8 );
    ...
    if ( isdefined( self.turntomatchnode ) )
        ...
        self animmode( "angle deltas", 0 );
    else if ( isanimdeltaingoal( var_11 ) )
        resetanimmode();
    else
        self animmode( "angle deltas", 0 );
    ...
    combat_playfacialanim( var_11, "aim" );
    self notify( "turning" );
...
exposedreload( var_0 )
{
    if ( animscripts\combat_utility::needtoreload( var_0 ) )
    {
        ...
        else
        {
            ...
            if ( isdefined( var_2 ) )
                var_1 = animscripts\utility::animarraypickrandom( "reload_" + var_2 );
            else
            ...
            {
                if ( isdefined( var_2 ) )
                    var_1 = animscripts\utility::animarraypickrandom( "reload_crouchhide_" + var_2 );
                else
...
switchtosidearm( var_0 )
{
    ...
    thread _id_B592( "switched_to_sidearm" );
    animscripts\combat_utility::endfireandanimidlethread();
    self.swapanim = var_0;
...
switchtolastweapon( var_0, var_1 )
{
    ...
    thread _id_B592( "switched_to_lastweapon" );
    animscripts\combat_utility::endfireandanimidlethread();
    self.swapanim = var_0;
