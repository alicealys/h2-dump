...
{
    wait 0.1;
    self._id_B505 = self.meleeingplayer.gs.dog_presstime / dog_vs_player_anim_rate();
    thread _id_C81D();
...
_id_B543()
{
    ...
    if ( isdefined( self.meleeingplayer._id_C5F4 ) )
    {
        self.meleeingplayer.doghintelem maps\_hud_util::destroyelem();
        self.meleeingplayer._id_C5F4 maps\_hud_util::destroyelem();
        self.meleeingplayer._id_CB53 maps\_hud_util::destroyelem();
        self.meleeingplayer._id_AB62 maps\_hud_util::destroyelem();
    }
...
_id_D4F7()
{
    ...
    if ( level.player common_scripts\utility::is_player_gamepad_enabled() )
    {
        ...
        maps\_utility::_id_BD5A( &"SCRIPT_PLATFORM_DOG_HINT", &"SCRIPT_PLATFORM_DOG_HINT_KEYBOARD", undefined, undefined, var_0 );
        thread maps\_utility::_id_B55D();
        self.meleeingplayer.doghintelem = level.player._id_B1FD;
    }
    else
    {
        ...
        self.meleeingplayer.doghintelem.hidewheninmenu = 1;
        self.meleeingplayer.doghintelem.alpha = 0.25;
        self.meleeingplayer.doghintelem.sort = -1;
        self.meleeingplayer.doghintelem thread common_scripts\utility::_id_BAF1( level.player, &"SCRIPT_PLATFORM_DOG_HINT_KEYBOARD", &"SCRIPT_PLATFORM_DOG_HINT", "clearing_dog_hint" );
        self.meleeingplayer._id_C5F4 = maps\_hud_util::createicon( "h1_hud_tutorial_blur", 225, 20 );
        self.meleeingplayer._id_CB53 = maps\_hud_util::createicon( "h1_hud_tutorial_border", 225, 1 );
        self.meleeingplayer._id_AB62 = maps\_hud_util::createicon( "h1_hud_tutorial_border", 225, 1 );
        self.meleeingplayer._id_C5F4.x = 0;
        self.meleeingplayer._id_C5F4.y = 20;
        self.meleeingplayer._id_C5F4.sort = -3;
        self.meleeingplayer._id_C5F4.alignx = "center";
        self.meleeingplayer._id_C5F4.aligny = "middle";
        self.meleeingplayer._id_C5F4.horzalign = "center";
        self.meleeingplayer._id_C5F4.vertalign = "middle";
        self.meleeingplayer._id_C5F4.foreground = 1;
        self.meleeingplayer._id_C5F4.hidewheninmenu = 1;
        self.meleeingplayer._id_C5F4.alpha = 0.225;
        self.meleeingplayer._id_CB53.x = 0;
        self.meleeingplayer._id_CB53.y = 10;
        self.meleeingplayer._id_CB53.sort = -2;
        self.meleeingplayer._id_CB53.alignx = "center";
        self.meleeingplayer._id_CB53.aligny = "middle";
        self.meleeingplayer._id_CB53.horzalign = "center";
        self.meleeingplayer._id_CB53.vertalign = "middle";
        self.meleeingplayer._id_CB53.foreground = 1;
        self.meleeingplayer._id_CB53.hidewheninmenu = 1;
        self.meleeingplayer._id_CB53.alpha = 0.0125;
        self.meleeingplayer._id_AB62.x = 0;
        self.meleeingplayer._id_AB62.y = 30;
        self.meleeingplayer._id_AB62.sort = -2;
        self.meleeingplayer._id_AB62.alignx = "center";
        self.meleeingplayer._id_AB62.aligny = "middle";
        self.meleeingplayer._id_AB62.horzalign = "center";
        self.meleeingplayer._id_AB62.vertalign = "middle";
        self.meleeingplayer._id_AB62.foreground = 1;
        self.meleeingplayer._id_AB62.hidewheninmenu = 1;
        self.meleeingplayer._id_AB62.alpha = 0.0125;
    }

    _id_C0C3::_id_B95B( 1, 1 );
}
...
_id_C81D()
{
    ...
    var_0 = self._id_B505 / 1000;

    if ( !level.player common_scripts\utility::is_player_gamepad_enabled() )
    {
        self.meleeingplayer._id_AB62.alpha = 0.05;
        self.meleeingplayer._id_CB53.alpha = 0.05;
        self.meleeingplayer._id_C5F4.alpha = 0.9;
    }
...
_id_B72D()
{
    ...
    if ( level.player common_scripts\utility::is_player_gamepad_enabled() )
    {
        level thread maps\_utility::_id_BA76();
        return;
    }
...
_id_A864()
{
    ...
    if ( isdefined( self.meleeingplayer._id_C5F4 ) )
    {
        ...
        self.meleeingplayer._id_C5F4 fadeovertime( var_0 );
        self.meleeingplayer._id_CB53 fadeovertime( var_0 );
        self.meleeingplayer._id_AB62 fadeovertime( var_0 );
        self.meleeingplayer.doghintelem.alpha = 0;
        self.meleeingplayer._id_C5F4.alpha = 0;
        self.meleeingplayer._id_CB53.alpha = 0;
        self.meleeingplayer._id_AB62.alpha = 0;
        wait( var_0 );
        _id_B543();
    }
    else
    ...
    for (;;)
    {
        if ( !var_0 )
        {
            if ( player_attacked() )
            {
                ...
                {
                    if ( gettime() - self.melee_able_timer <= self._id_B505 )
                    {
                        ...
                        maps\_utility::_id_D4F3( self.origin, "melee", 50 );
...
meleestrugglevsdog()
{
    ...
    maps\_utility::delaythread( getanimlength( var_0[1] ) * 0.5, ::setspecial );
    ...
    while ( self.meleeseq < var_1 )
    {
        ...
        if ( self.meleeseq == 2 )
            self.a.special = "dog_attack";
        else if ( self.meleeseq == 3 && var_1 != 3 )
            self.a.special = "dog_attack";
...
_id_A8B2()
{
    var_0 = angleclamp180( self.meleeingplayer.angles[1] - self.angles[1] );
    var_1 = "back";
    ...
    self.meleeingplayer _meth_84C7( "h2_player_react_dog_attack_" + var_1 );
    wait( getanimlength( %h2_player_react_dog_attack_front ) );
    self.meleeingplayer _meth_84C7( 0 );
}
