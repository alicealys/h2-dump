...
melee_playchargesound()
{
    ...
    if ( isdefined( self.enemy ) && isplayer( self.enemy ) || randomint( 3 ) == 0 )
    {
        if ( gettime() > self.a.nextmeleechargesound )
        {
            ...
            if ( !isdefined( self.a.nextmeleesound ) )
                self.a.nextmeleesound = gettime() + 1900;
        }
    }
}
...
{
    if ( !isdefined( self.a.nextmeleesound ) )
        self.a.nextmeleesound = 0;

    if ( isdefined( self.enemy ) && isplayer( self.enemy ) || randomint( 3 ) == 0 )
    {
        if ( gettime() > self.a.nextmeleesound )
        {
            animscripts\face::saygenericdialogue( "meleeattack" );
            self.a.nextmeleesound = gettime() + 500;
        }
    }
}

melee_aivsai_exposed_chooseanimationandposition_flip( var_0, var_1 )
{
    var_2 = 90;
    var_3 = 900;
    var_4 = 2025;
    ...
    if ( self.melee.winner )
    {
        ...
        var_5.melee.animname = animscripts\utility::lookupanim( "melee", "aivai_exposed_attackerwins_defend" );
        var_5.melee.surviveanimname = animscripts\utility::lookupanim( "melee", "aivai_exposed_attackerwins_defend_survive" );
    }
    else
    {
        ...
        var_5.melee.animname = animscripts\utility::lookupanim( "melee", "aivai_exposed_defenderwins_defend" );
    }

    return 1;
}

melee_aivsai_exposed_chooseanimationandposition_wrestle( var_0, var_1 )
{
    var_2 = 100;
    ...
    if ( isdefined( var_3.meleealwayswin ) )
        return 0;

    self.melee.winner = 1;
    self.melee.animname = animscripts\utility::lookupanim( "melee", "aivai_wrestle_attackerwins_attack" );
    var_3.melee.animname = animscripts\utility::lookupanim( "melee", "aivai_wrestle_attackerwins_defend" );
    var_3.melee.surviveanimname = animscripts\utility::lookupanim( "melee", "aivai_wrestle_attackerwins_defend_survive" );
    return 1;
}

_id_CC40( var_0, var_1 )
{
    var_2 = 90;
    var_3 = 6400;
    ...
    var_4.melee.animname = animscripts\utility::lookupanim( "melee", "aivai_exposed_defenderwins_defend_kick" );
    return 1;
}

melee_aivsai_exposed_chooseanimationandposition_behind( var_0, var_1 )
{
    if ( -90 > var_0 || var_0 > 0 )
        return 0;
    ...
    var_2.melee.animname = animscripts\utility::lookupanim( "melee", "aivai_behind_attackerwins_defend" );
    return 1;
}
...
{
    if ( isdefined( self._id_ADC0 ) && !self._id_ADC0 )
        return 0;
    ...
    var_4 = melee_aivsai_exposed_chooseanimationandposition_buildexposedlist();

    for ( var_5 = 0; var_5 < var_4.size; var_5++ )
    {
        if ( [[ var_4[var_5] ]]( var_3, var_1 ) )
        {
            self.melee.startangles = ( 0, var_2[1], 0 );
...
melee_decide_winner()
{
    ...
    if ( isdefined( self.magic_bullet_shield ) )
        ...
        self.melee.winner = 0;
    else if ( var_0 maps\_utility::doinglongdeath() || var_0.delayeddeath )
        self.melee.winner = 1;
    else
...
melee_partnerendedmeleemonitorthread()
{
    ...
    {
        if ( ( !isdefined( self.pose ) || self.pose != "stand" ) && ( isdefined( self.a.onback ) && self.a.onback == 1 ) )
        {
            self orientmode( "face default" );
            animscripts\utility::exitpronewrapper( 1.0 );
            animscripts\notetracks::setpose( "stand" );
        }
...
melee_handlenotetracks( var_0 )
{
    ...
    else
    {
        if ( var_0 == "melee_effort_vo" )
        {
            ...
            thread maps\_utility::play_sound_on_tag( var_1 );
            return;
        }
