...
startmovetransition()
{
    ...
    if ( isdefined( self._id_B313 ) )
        var_2 = self [[ self._id_B313 ]]( var_4 );
    ...
    if ( isdefined( self._id_C152 ) )
    {
        if ( !self [[ self._id_C152 ]]( var_4 ) )
            return;
    }
    ...
    if ( !var_3 && !isdefined( self._id_B313 ) )
        var_2 = determinenonnodeexittype();

    if ( isdefined( var_4 ) && isdefined( var_4._id_D507 ) )
    {
        if ( isdefined( self getnegotiationstartnode() ) )
        {
            if ( self.a.pose != "stand" )
            {
                var_8 = maps\_utility::getanim_generic( var_4._id_D507 );
    ...
    var_10 = getmaxdirectionsandexcludedirfromapproachtype( var_4 );
    var_11 = var_10.maxdirections;
    var_12 = var_10.excludedir;
    var_13 = spawnstruct();
    calculatenodetransitionangles( var_13, var_2, 0, var_1, var_9, var_11, var_12 );
    ...
    for ( var_16 = 1; var_16 <= var_15; var_16++ )
    {
        ...
        if ( checknodeexitpos( var_0, var_1, var_2, var_7, var_14 ) )
            break;
    }
    ...
    var_17 = distancesquared( self.origin, self.coverexitpos ) * 1.25;

    if ( distancesquared( self.origin, self.pathgoalpos ) < var_17 )
        return;

    donodeexitanimation( var_2, var_14 );
}
...
determinenodeexittype( var_0 )
{
    ...
    if ( var_1 == "prone" && !isdefined( self._id_B709 ) )
        var_1 = "crouch";
...
checktransitionpreconditions()
{
    ...
    if ( self.a.pose == "prone" && !isdefined( self._id_B709 ) )
        return 0;

    if ( self.stairsstate != "none" )
        return 0;

    if ( !self isstanceallowed( "stand" ) && !isdefined( self.heat ) && !isdefined( self._id_B709 ) )
        return 0;
...
checknodeexitpos( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_13 = animscripts\utility::lookuptransitionanim( "cover_exit_postdist", var_2, var_4 );
    var_9 = var_6 * var_13[0];
    var_10 = var_7 * var_13[1];
    var_14 = var_11 + var_9 - var_10;
    self.coverexitpos = var_14;
...
_id_CA45( var_0 )
{
    ...
    childthread animscripts\stairs_utility::_id_C547( var_0, 0, 0.1, ::_id_C26F );
    ...
    if ( !isdefined( self._id_B709 ) || self.a.pose != "prone" )
        self.a.pose = "stand";

    self.a.movement = "run";
    self.ignorepathchange = undefined;
    animscripts\move::_id_BF22();
    animscripts\utility::_id_B477( var_0 );
    self orientmode( "face motion" );
    self animmode( "none", 0 );
    childthread animscripts\stairs_utility::_id_C547( var_0, 0, 0.1 );
