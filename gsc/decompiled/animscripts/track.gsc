...
trackloop( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    for (;;)
    {
        ...
        else if ( isdefined( var_24 ) && isdefined( self._id_C631 ) && isdefined( self.enemy ) )
        ...
        if ( isdefined( self.node ) && isdefined( self.node._id_B769 ) && self.node._id_B769 != 0 )
            var_25 = 1;
...
trackloop_setanimweights( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_6 > 0 )
    {
        var_11 = clamp( var_6 / self._id_C4D5.rightaimlimit * self.a.aimweight, 0, 1 );
        var_10 = 1;
    }
    else if ( var_6 < 0 )
    {
        var_9 = clamp( var_6 / self._id_C4D5.leftaimlimit * self.a.aimweight, 0, 1 );
        var_10 = 1;
    }
