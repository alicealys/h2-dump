...
pronestill()
{
    ...
    {
        if ( self.prevscript == "move" && isdefined( self._id_B597 ) && isdefined( self._id_B30B ) && self._id_B30B == "prone" )
        {
            var_3 = getanimlength( self._id_B597 ) * ( 1 - self getanimtime( self._id_B597 ) );

            if ( var_3 > 0.05 )
            {
                var_2 = self getanimtime( self._id_B597 );
                var_1 = self._id_B597;
            }
        }
        else
