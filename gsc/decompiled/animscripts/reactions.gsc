...
init_animset_reactions()
{
    ...
    anim.archetypes["soldier"]["running_react_to_bullets_hero"] = var_0;
...
_id_B939()
{
    if ( !isdefined( level._id_C53E ) )
        level._id_C53E = 0;

    level._id_C53E = !level._id_C53E;
    return level._id_C53E;
}

_id_CD22()
{
    if ( !isdefined( level._id_AD87 ) || level._id_AD87.size == 0 )
        level._id_AD87 = common_scripts\utility::array_randomize( [ 0, 1, 2, 3 ] );

    var_0 = level._id_AD87[0];
    level._id_AD87 = common_scripts\utility::array_remove( level._id_AD87, var_0 );
    return var_0;
}
...
bulletwhizbyreaction()
{
    ...
    if ( isdefined( self._id_B0A3 ) || var_1 || _id_B939() )
    {
