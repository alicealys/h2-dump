...
handletraversedrop()
{
    ...
    if ( var_9.size > 0 )
    {
        ...
        var_8 = var_10;
        var_11 = getangledelta( self.traverseanim, var_1, var_10 );
    ...
    {
        var_13 = getangledelta( self.traverseanim, var_1, 1.0 );
        var_12 = ( 0, self.angles[1], 0 );
...
dog_handle_traverse_notetracks( var_0 )
{
    ...
    if ( var_2 )
    {
        ...
        var_6 = var_5[0];
        var_7 = getangledelta( self.traverseanim, 0, var_5[0] );
        var_8 = var_7[2];
        var_7 = getangledelta( self.traverseanim, 0, var_1[0] );
        var_9 = var_7[2];
        var_10 = var_1[0];
        ...
        if ( var_3 )
        {
            var_7 = getangledelta( self.traverseanim, 0, 1 );
