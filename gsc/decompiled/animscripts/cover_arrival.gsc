...
handlestartaim( var_0 )
{
    if ( var_0 == "start_aim" )
    {
        if ( isdefined( self.a._id_C9FE ) && self.a._id_C9FE )
            return;
...
abortapproachifthreatened()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self.animarchetype ) && self.animarchetype == "riotshield" && !isdefined( self.color_node ) )
            return;
...
approachwaittillclose( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_2 ) )
        {
            var_5 = _id_CC57();
            var_6 = 1;
            var_7 = _id_A97D( var_5, var_0, var_6 );
            var_8 = _id_BE54( var_5, var_7, var_0, var_6, var_2.approachtype );
            var_9 = vectornormalize( var_2._id_D2F1 - self.origin );
            var_3 = checkarrivalenterpositions( var_2._id_D2F1, var_2._id_B199, var_2.approachtype, var_9, var_2.maxdirections, var_2.excludedir, var_2._id_CF9F );
...
startcoverapproach( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_10 <= 6 && var_9 )
    {
        ...
        var_12._id_D2F1 = var_1;
        var_12._id_CF9F = var_9;
        var_12.excludedir = var_8;
        var_12.maxdirections = var_7;
        var_12._id_B199 = var_3;
    ...
    if ( animscripts\utility::_id_BB4A() )
    {
        ...
        self._id_D58F = self _meth_857B( self.coverenterpos, var_13, 0, self.arrivalanim, var_14 );
    }
    else
        self._id_D58F = self startcoverarrival( self.coverenterpos, var_13, 0 );
}
...
exposedapproachconditioncheck( var_0, var_1 )
{
    ...
    if ( !self maymovetopoint( self.pathgoalpos, 1, 0, level._id_C33B ) )
        return 0;
...
_id_BE54( var_0, var_1, var_2, var_3, var_4 )
{
    var_1 = _id_A97D( var_0, var_2, var_3 );
    var_5 = spawnstruct();
    animscripts\exit_node::calculatenodetransitionangles( var_5, var_4, 1, var_1, var_0, 9, -1 );
    var_6 = 1;
    ...
    self.approachnumber = var_5.transindex[var_6];
    self.approachtype = var_4;
    var_8 = animscripts\utility::lookuptransitionanim( "cover_trans", var_4, self.approachnumber );

    if ( !isdefined( var_8 ) || isdefined( self.disableapproach ) )
        return;

    var_9 = length( animscripts\utility::lookuptransitionanim( "cover_trans_dist", var_4, self.approachnumber ) );
    return var_9;
}
...
_id_A97D( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.faceenemyarrival ) )
        var_3 = self.angles[1];
    else if ( faceenemyatendofapproach( var_1 ) )
        var_3 = vectortoyaw( self.enemy.origin - self.pathgoalpos );
    else
    {
        var_4 = isdefined( var_1 ) && var_2;
        var_4 = var_4 && var_1.type != "Path" && var_1.type != "Path 3D" && ( var_1.type != "Ambush" || !animscripts\utility::recentlysawenemy() );

        if ( var_4 )
            var_3 = animscripts\utility::getnodeforwardyaw( var_1 );
        else
        {
...
dolastminuteexposedapproach()
{
    ...
    var_4 = _id_CC57();
    var_5 = _id_A97D( var_4, var_2, var_3 );
    var_6 = _id_BE54( var_4, var_5, var_2, var_3, var_0 );

    if ( !isdefined( var_6 ) )
        return;

    var_7 = _id_C0CB( var_6 );
    ...
    else if ( isdefined( self.a._id_AD98 ) && self.a._id_AD98 )
    {
    ...
    if ( animscripts\utility::_id_BB4A() )
    {
        ...
        self._id_D58F = self _meth_857B( var_11, var_10, 0, self.arrivalanim, var_15 );
    }
    else
        self._id_D58F = self startcoverarrival( var_11, var_10, 0 );
}
