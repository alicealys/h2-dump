...
init_animset_pain()
{
    ...
    var_0["covercrouch_all"] = common_scripts\utility::array_flatten( [ var_0["covercrouch_longdeath"], var_0["covercrouch_default"], var_0["covercrouch_left_arm"], var_0["covercrouch_right_arm"] ] );
...
_id_C1E0()
{
    if ( isdefined( self._id_C60C ) && self._id_C60C )
        return 1;
...
main()
{
    if ( !animscripts\utility::_id_BF95() )
        self._id_C60C = 1;
...
getdamageshieldpainanim()
{
    ...
    if ( isdefined( self.a.painonstairs ) && self.a.painonstairs )
        return;
...
_id_A9CB()
{
    ...
    if ( isdefined( self._id_A860 ) && !self._id_A860 || var_0 == "" )
        return "none";
...
getstandpainanim()
{
    ...
    var_0 = [];
    var_1 = [];
    var_2 = animscripts\stairs_utility::_id_D458();

    if ( animscripts\utility::damagelocationisany( "torso_upper" ) )
    {
        var_3 = common_scripts\utility::ter_op( var_2, "torso_upper_stairs", "torso_upper" );
        var_0 = animscripts\utility::lookupanim( "pain", var_3 );
        var_1 = animscripts\utility::lookupanim( "pain", "torso_upper_extended" );
    }
    else if ( animscripts\utility::damagelocationisany( "torso_lower" ) )
    {
        var_3 = common_scripts\utility::ter_op( var_2, "torso_lower_stairs", "torso_lower" );
        var_0 = animscripts\utility::lookupanim( "pain", var_3 );
    ...
    {
        var_3 = common_scripts\utility::ter_op( var_2, "head_stairs", "head" );
        var_0 = animscripts\utility::lookupanim( "pain", var_3 );
    ...
    {
        var_3 = common_scripts\utility::ter_op( var_2, "right_arm_stairs", "right_arm" );
        var_0 = animscripts\utility::lookupanim( "pain", var_3 );
    ...
    {
        var_3 = common_scripts\utility::ter_op( var_2, "left_arm_stairs", "left_arm" );
        var_0 = animscripts\utility::lookupanim( "pain", var_3 );
        var_1 = animscripts\utility::lookupanim( "pain", "left_arm_extended" );
    }
    else if ( animscripts\utility::damagelocationisany( "left_leg_upper", "right_leg_upper" ) )
    {
        var_3 = common_scripts\utility::ter_op( var_2, "leg_stairs", "leg" );
        var_0 = animscripts\utility::lookupanim( "pain", var_3 );
    ...
    {
        var_3 = common_scripts\utility::ter_op( var_2, "foot_stairs", "foot" );
        var_0 = animscripts\utility::lookupanim( "pain", var_3 );
    ...
    if ( var_0.size < 2 )
    {
        if ( !self.a.disablelongdeath && !var_2 )
    ...
    if ( !self.damageshield && !self.a.disablelongdeath && !var_2 )
    {
...
getcrouchpainanim()
{
    _id_D06D();
    var_0 = [];
    var_1 = common_scripts\utility::ter_op( animscripts\utility::should_play_specific_covercrouch_anim(), "cover", "" );

    if ( !self.damageshield && !self.a.disablelongdeath )
        var_0 = animscripts\utility::lookupanim( "pain", var_1 + "crouch_longdeath" );

    var_0 = common_scripts\utility::array_combine( var_0, animscripts\utility::lookupanim( "pain", var_1 + "crouch_default" ) );

    if ( animscripts\utility::damagelocationisany( "left_hand", "left_arm_lower", "left_arm_upper" ) )
        var_0 = common_scripts\utility::array_combine( var_0, animscripts\utility::lookupanim( "pain", var_1 + "crouch_left_arm" ) );

    if ( animscripts\utility::damagelocationisany( "right_hand", "right_arm_lower", "right_arm_upper" ) )
        var_0 = common_scripts\utility::array_combine( var_0, animscripts\utility::lookupanim( "pain", var_1 + "crouch_right_arm" ) );
...
specialpain( var_0 )
{
    ...
    switch ( var_0 )
    {
        case "cover_left":
            ...
            {
                var_1 = animscripts\utility::lookupanim( "pain", "cover_left_crouch" )[animscripts\corner::_id_C35D( self )];
                dopainfromarray( var_1 );
                var_2 = 1;
            }
            else
        ...
        case "cover_right":
            ...
            {
                var_1 = animscripts\utility::lookupanim( "pain", "cover_right_crouch" )[animscripts\corner::_id_C35D( self )];
                dopainfromarray( var_1 );
                var_2 = 1;
            }
            else
...
crawlingpain()
{
    ...
    if ( self.a.pose == "prone" && enemyisingeneraldirection( anglestoforward( self.angles ) ) )
        return 0;
...
setcrawlingpaintransanim( var_0 )
{
    ...
    else if ( self.a.pose == "crouch" )
    {
        if ( animscripts\utility::should_play_specific_covercrouch_anim() )
            var_1 = animscripts\utility::lookupanim( "crawl_death", "covercrouch_transition" );
        else
...
crawlingpistol()
{
    ...
    if ( self.a.pose != "prone" || !enemyisingeneraldirection( anglestoforward( self.angles ) ) )
    {
        ...
        {
            if ( !( isdefined( level._id_B43A ) && self.enemy == level._id_B43A ) )
                self setlookatentity( self.enemy );
        }

        decidenumcrawls();

        while ( shouldkeepcrawling() && enemyisingeneraldirection( anglestoforward( self.angles ) ) )
        {
...
stumblingpain()
{
    ...
    var_0 = getangledelta( self.a.stumblingpainanimseq[2] );
...
dyingcrawl()
{
    ...
    if ( self.a.pose != "prone" )
    {
        var_0 = self.a.pose + "_2_crawl";

        if ( animscripts\utility::should_play_specific_covercrouch_anim() )
            var_0 = "covercrouch_2_crawl";

        var_1 = animscripts\utility::lookupanim( "crawl_death", var_0 );
        ...
        pain_setflaggedanimknob( "falling", var_2, 1, 0.5, 1 );
    ...
    self.a.special = "dying_crawl";
    decidenumcrawls();
    var_3 = animscripts\utility::lookupanim( "crawl_death", "crawl" );

    if ( isdefined( self.a.array ) && isdefined( self.a.array["crawl"] ) )
        var_3 = self.a.array["crawl"];

    while ( shouldkeepcrawling() )
    {
        if ( !iscrawldeltaallowed( var_3 ) )
            return 1;

        if ( isdefined( self.custom_crawl_sound ) )
            self playsound( self.custom_crawl_sound );

        pain_setflaggedanimknobrestart( "crawling", var_3, 1, 0.1, 1.0 );
    ...
    var_4 = animscripts\utility::lookupanim( "crawl_death", "death" );

    if ( isdefined( self.a.array ) && isdefined( self.a.array["death"] ) )
        var_4 = self.a.array["death"];
    ...
    if ( !isdefined( self._id_BC2E ) || !self._id_BC2E )
        animscripts\death::playdeathanim( var_5, 0 );
...
dyingcrawlbloodsmear()
{
    ...
    if ( isdefined( self.a._id_C299 ) )
        var_1 = self.a._id_C299;
