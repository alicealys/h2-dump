...
main( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            var_4 = isenemyvisiblefromexposed();
            var_5 = animscripts\utility::cansuppressenemyfromexposed();
        }
...
_id_A85D()
{
    _id_B98F( "cqb_stationary_turn" );
}

_id_B547()
{
    _id_B98F( "casual_stationary_turn" );
}

set_standing_turns()
{
    _id_B98F( "exposed_turn" );
}

set_standing_cover_turns()
{
    _id_B98F( "coverstand_turn" );
}

set_crouching_turns()
{
    _id_B98F( "exposed_turn_crouch" );
}
        ...
        if ( abs( var_7 ) > 45 )
        {
            ...
            else if ( self.a.pose == "stand" )
            {
                if ( isdefined( self.animarchetype ) && self.animarchetype == "s1_soldier" )
                {
                    ...
                    _id_A85D();
                else if ( animscripts\utility::_id_C6BB() )
                    _id_B547();
                else
                    set_standing_turns();
            }
