...
playblendtransitionstandrun( var_0 )
{
    ...
    var_2 = animscripts\stairs_utility::_id_B79B();
...
blendintostandrun()
{
    ...
    if ( animscripts\stairs_utility::_id_C670() )
        return 0;
...
blendintocrouchrun()
{
    ...
    else
    {
        ...
        {
            if ( isdefined( self.animarchetype ) && self.animarchetype == "riotshield" )
                var_0 = animscripts\utility::lookupanim( "start_run", "riotshield_crouch" )[2];
            else
...
standtocrouch()
{
    ...
    if ( isdefined( self.animarchetype ) && self.animarchetype == "riotshield" )
        var_1 = animscripts\utility::lookupanim( "cover_trans", "riotshield_crouch" )[8];
    else
        var_1 = %exposed_stand_2_crouch;

    playtransitionanimation( var_1, "crouch", "stop", undefined, var_0 );
}
