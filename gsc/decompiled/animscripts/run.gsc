...
getrunanim()
{
    ...
    if ( var_1 )
    {
        var_3 = animscripts\stairs_utility::_id_D210();
    ...
    {
        var_4 = animscripts\slopes_utility::_id_AD0C();

        if ( isdefined( var_4 ) )
        {
            var_0 = animscripts\utility::lookupanim( "run", "straight_" + var_4 );
            return var_0;
        }
    }
    ...
    var_5 = animscripts\utility::getmoveanim( "straight_twitch" );
    ...
    var_6 = animscripts\utility::getrandomintfromseed( self.a.runloopcount, 4 );

    if ( var_6 == 0 )
    {
        var_0 = animscripts\utility::_id_B9E0( var_5 );
        return var_0;
    }
...
_id_A905( var_0, var_1 )
{
    ...
    var_5 = animscripts\utility::lookupanimarray( var_4 );

    if ( animscripts\stairs_utility::ismovingonstairs() )
    {
        var_6 = animscripts\stairs_utility::_id_D210();
        var_7 = var_5[var_6];
    ...
    {
        if ( isdefined( self._id_C8C2 ) )
        {
            self clearanim( self._id_C8C2, 0.1 );
            self._id_C8C2 = undefined;
        }
        ...
        {
            var_11 = floor( self.runngunweight / self.runnguntransitionpoint );
            var_12 = 4 + var_11;
            var_13 = var_12 + 1;
            var_10 = ( self.runngunweight - var_11 * var_0 ) / var_0;
        ...
        if ( isdefined( self.casual_killer ) && self.casual_killer && var_2 > var_0 )
            self _meth_85C9( 0 );
        else
            self _meth_85C9( 1 );
...
runningreacttobullets()
{
    ...
    if ( self.team == "allies" && self.damageshield )
        var_0 = animscripts\utility::lookupanimarray( "running_react_to_bullets_hero" );
    else
...
shouldsprintforvariation()
{
    ...
    if ( !self.facemotion || animscripts\stairs_utility::_id_D458() )
        return 0;
...
_id_BBE4()
{
    if ( isdefined( self._id_BDF8 ) )
    {
        var_0 = gettime() - self._id_BDF8;
        return var_0 < 500;
    }
...
standrun_combatnormal()
{
    ...
    var_4 = animscripts\utility::_id_B8C3();
...
move_checkstairstransition()
{
    ...
    self._id_C4D3 = undefined;
    var_1 = animscripts\stairs_utility::_id_C1A2( var_0["anim"], 1, var_0["updateTime"] );

    if ( !isdefined( var_1 ) )
        return 0;

    animscripts\stairs_utility::_id_AFAC();
    ...
    if ( isdefined( self._id_C4D3["startTime"] ) )
        var_6 = var_4[0] - self._id_C4D3["startTime"];
    else
    ...
    if ( isdefined( self._id_C4D3["startTime"] ) )
        self setanimtime( var_2, self._id_C4D3["startTime"] );
    ...
    childthread animscripts\stairs_utility::_id_BB81( var_2, self.origin, self._id_C4D3, var_4[0], var_9, var_10 );
    thread animscripts\stairs_utility::_id_C9D6( var_2, var_4[0] );
    animscripts\shared::donotetracks( "runanim" );
    self.ignorepathchange = undefined;
    self._id_CD4E = gettime();
...
{
    self endon( "movemode" );
    var_0 = animscripts\stairs_utility::_id_D458();
