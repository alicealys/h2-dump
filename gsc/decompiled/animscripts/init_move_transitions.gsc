...
inittransdistandanglesforarchetype( var_0 )
{
    ...
    for ( var_2 = 1; var_2 <= 6; var_2++ )
    {
        ...
        for ( var_3 = 0; var_3 < var_1.size; var_3++ )
        {
            ...
            {
                anim.archetypes[var_0]["cover_trans_dist"][var_4][var_2] = getangledelta( anim.archetypes[var_0]["cover_trans"][var_4][var_2], 0, 1 );
                anim.archetypes[var_0]["cover_trans_angles"][var_4][var_2] = getmovedelta( anim.archetypes[var_0]["cover_trans"][var_4][var_2], 0, 1 );
                anim.archetypes[var_0]["cover_trans_move_end"][var_4][var_2] = _id_C132( anim.archetypes[var_0]["cover_trans"][var_4][var_2] );
            }
            ...
            if ( isdefined( anim.archetypes[var_0]["cover_exit"][var_4] ) && isdefined( anim.archetypes[var_0]["cover_exit"][var_4][var_2] ) )
            {
                ...
                anim.archetypes[var_0]["cover_exit_dist"][var_4][var_2] = getangledelta( anim.archetypes[var_0]["cover_exit"][var_4][var_2], 0, var_5 );
                anim.archetypes[var_0]["cover_exit_angles"][var_4][var_2] = getmovedelta( anim.archetypes[var_0]["cover_exit"][var_4][var_2], 0, 1 );
            }
        }
    }
...
_id_BF89( var_0, var_1 )
{
    ...
    var_3 = spawnstruct();
    var_3._id_B5D3 = getangledelta( var_0, 0, var_1 );
    var_3._id_ADAA = getangledelta( var_0, 0, var_2 ) - var_3._id_B5D3;
    var_3._id_C68E = getmovedelta( var_0, 0, 1 );
    return var_3;
}
    ...
    for ( var_6 = var_1; var_6 <= var_2; var_6++ )
    {
        if ( isdefined( anim.archetypes[var_0]["cover_trans"] ) )
        {
            foreach ( var_11, var_8 in var_4 )
            {
                ...
                {
                    var_9 = _id_B2C5( anim.archetypes[var_0]["cover_trans"][var_11][var_6], 1, var_3 );
                    var_10 = _id_BF89( anim.archetypes[var_0]["cover_trans"][var_11][var_6], var_9 );
                    anim.archetypes[var_0]["cover_trans_predist"][var_11][var_6] = var_10._id_B5D3;
                    anim.archetypes[var_0]["cover_trans_dist"][var_11][var_6] = var_10._id_ADAA;
                    anim.archetypes[var_0]["cover_trans_angles"][var_11][var_6] = var_10._id_C68E;
                    anim.archetypes[var_0]["cover_trans_move_end"][var_11][var_6] = _id_C132( anim.archetypes[var_0]["cover_trans"][var_11][var_6] );
                }
            }
        }
        ...
        if ( isdefined( anim.archetypes[var_0]["cover_exit"] ) )
        {
            foreach ( var_11, var_8 in var_5 )
            {
                ...
                {
                    var_9 = _id_B2C5( anim.archetypes[var_0]["cover_exit"][var_11][var_6], 0, var_3 );
                    var_10 = _id_BF89( anim.archetypes[var_0]["cover_exit"][var_11][var_6], var_9 );
                    anim.archetypes[var_0]["cover_exit_dist"][var_11][var_6] = var_10._id_B5D3;
                    anim.archetypes[var_0]["cover_exit_postdist"][var_11][var_6] = var_10._id_ADAA;
                    anim.archetypes[var_0]["cover_exit_angles"][var_11][var_6] = var_10._id_C68E;
                }
            }
        }
    }
...
_id_B2C5( var_0, var_1, var_2 )
{
    ...
    for ( var_9 = 0; var_9 < var_5; var_9++ )
    {
        ...
        if ( var_1 )
            var_11 = _id_B83C( var_4 - var_11, 180 - var_3 );
