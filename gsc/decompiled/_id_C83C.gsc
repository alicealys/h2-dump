...
_id_AEF4( var_0 )
{
    ...
    for ( var_3 = 0; var_3 < var_0.size; var_3++ )
    {
        ...
        _id_B42C( var_4.z, var_8, var_9, ( 0, 0.5, 1 ), 1, 1, 50000 );
        ...
        _id_B42C( var_4.z, var_8, var_10, ( 0, 0.5, 1 ), 1, 1, 50000 );
        _id_B42C( var_4.z, var_9, var_11, ( 0, 0.5, 1 ), 1, 1, 50000 );
        ...
        foreach ( var_16 in var_4.col_lines )
        {
            ...
            _id_B42C( var_4.z, var_17, var_18, ( 1, 0, 0 ), 1, 1, 50000 );
        }
    }
}
    ...
    for (;;)
    {
        ...
        if ( var_0.wipeout )
        {
            ...
            if ( isdefined( var_0._id_BBBC ) && var_0._id_BBBC )
            {
                ...
                var_0 common_scripts\utility::delaycall( var_5 + 0.25, ::_meth_823A, ( 0, 0, 1 ), 10, var_6, 2 );
            }
