...
main( var_0, var_1, var_2 )
{
    ...
    maps\_vehicle::build_deathmodel( "vehicle_pickup_roobars", "vehicle_pickup_roobars_destroyed" );
...
setanims()
{
    ...
    var_0[3].idle = %pickup_passenger_rr_idle;
    var_0[4].idle = %pickup_passenger_rr_idle;
    var_0[5].idle = %pickup_passenger_rr_idle;
    ...
    var_0[4].getout = %pickup_passenger_rr_climb_out;
    var_0[5].getout = %pickup_passenger_rl_climb_out;
