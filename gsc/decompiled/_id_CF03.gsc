...
main( var_0, var_1, var_2 )
{
    ...
    maps\_vehicle::build_deathmodel( "vehicle_bm21_mobile_cover_snow", "vehicle_bm21_mobile_cover_dstry" );
    ...
    maps\_vehicle::build_deathfx( "fx/explosions/huge_vehicle_explosion_bm21", "tag_fx_cab", "truck_explode", undefined, undefined, undefined, 0 );
