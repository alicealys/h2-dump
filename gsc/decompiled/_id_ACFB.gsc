...
main()
{
    common_scripts\_destructible::destructible_create( "toy_ceiling_fan_housing01", "tag_origin", 0, undefined, 32 );
    common_scripts\_destructible::destructible_state( "tag_origin", "h2_us_ceiling_fan_housing_01", 150 );
    common_scripts\_destructible::destructible_fx( "tag_fx", "fx/explosions/h2_us_ceiling_fan_housing_01_dest" );
