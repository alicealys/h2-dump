...
precache()
{
    character\character_opforce_arctic_smg_l1::precache();
    character\character_opforce_arctic_smg_b_l1::precache();
    character\character_opforce_arctic_smg_c_l1::precache();
    precacheitem( "kriss" );
