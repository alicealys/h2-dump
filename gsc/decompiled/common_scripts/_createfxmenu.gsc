...
init_menu()
{
    ...
    addoption( "int", "kill_on_delete", "Kill FX on delete", 1, "fx" );
    addoption( "int", "ignore_fx_volume_groups", "Ignore FX volume groups", 1, "fx" );
    level.effect_list_offset = 0;
    level.effect_list_offset_max = 10;
    level.effect_list_current_size = 0;
    level.help_list_offset = 0;
    level.help_list_offset_max = 15;
...
menu_create_select()
{
    ...
    common_scripts\_createfx::_id_B452();
...
menu_none()
{
    ...
    if ( entities_are_selected() && !level.createfx_help_active )
    {
...
menu_select_by_name()
{
    ...
    common_scripts\_createfx::_id_D374();
    select_by_name();
}
...
prepare_option_for_change( var_0, var_1 )
{
    ...
    else
    {
        ...
        common_scripts\_createfx::createfx_centerprint( var_2 );
    }
...
draw_help_list( var_0 )
{
    ...
    {
        var_3 = ceil( var_2.size / level.help_list_offset_max );
        var_4 = floor( level.help_list_offset / level.help_list_offset_max ) + 1;
        common_scripts\_createfx::set_fx_hudelement( "[" + var_0 + " (page " + var_4 + " of " + var_3 + ")]" );
    }
    else
        common_scripts\_createfx::set_fx_hudelement( "[" + var_0 + "]" );

    for ( var_5 = level.help_list_offset; var_5 < var_2.size; var_5++ )
    {
        var_1 += 1;
        common_scripts\_createfx::set_fx_hudelement( var_2[var_5] );
    ...
    common_scripts\_createfx::set_fx_hudelement( "(x, h) Exit >" );
}
...
increment_help_list_offset()
{
    ...
    if ( level.help_list_offset >= var_0.size )
        level.help_list_offset = 0;
}
...
decrement_help_list_offset()
{
    ...
    {
        var_0 = level.createfx_help_keys;
        var_1 = ceil( var_0.size / level.help_list_offset_max );
        level.help_list_offset = int( ( var_1 - 1 ) * level.help_list_offset_max );
    }
}
