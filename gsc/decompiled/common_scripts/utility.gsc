...
{
    var_1 = 0;
    var_2 = ter_op( var_0.size, var_0.size, 1 );
...
_id_D0EA( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_1 > var_2 )
            return _id_D0EA( var_0, var_2, var_1 );
    }
...
_id_B6EF( var_0, var_1, var_2 )
{
    var_3 = spawn_tag_origin();
...
loop_fx_sound_interval_with_angles( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    for (;;)
    {
        ...
        thread play_sound_in_space_with_angles( var_0, var_1, var_2, undefined );
...
convertlegacyfog( var_0 )
{
    if ( !isdefined( var_0.hdrcolorintensity ) )
    {
        if ( _func_242() )
        {
            ...
            var_2 = evfromluminancenits( var_1 * getculldist() );
...
set_fog_to_ent_values( var_0, var_1 )
{
    ...
    if ( isdefined( var_0.atmosfogenabled ) )
    {
        ...
        {
            if ( isplayer( self ) )
                self playersetatmosfog( var_1, var_0.atmosfogsunfogcolor, var_0.atmosfoghazecolor, var_0.atmosfoghazestrength, var_0.atmosfoghazespread, var_0.atmosfogextinctionstrength, var_0.atmosfoginscatterstrength, var_0._id_BE60, var_0._id_CFD8, var_0._id_C92F, var_0._id_BB60, var_0.atmosfoghalfplanedistance, var_0.atmosfogstartdistance, var_0.atmosfogdistancescale, int( var_0.atmosfogskydistance ), var_0.atmosfogskyangularfalloffenabled, var_0.atmosfogskyfalloffstartangle, var_0.atmosfogskyfalloffanglerange, var_0.atmosfogsundirection, var_0.atmosfogheightfogenabled, var_0.atmosfogheightfogbaseheight, var_0.atmosfogheightfoghalfplanedistance );
            else
                setatmosfog( var_1, var_0.atmosfogsunfogcolor, var_0.atmosfoghazecolor, var_0.atmosfoghazestrength, var_0.atmosfoghazespread, var_0.atmosfogextinctionstrength, var_0.atmosfoginscatterstrength, var_0._id_BE60, var_0._id_CFD8, var_0._id_C92F, var_0._id_BB60, var_0.atmosfoghalfplanedistance, var_0.atmosfogstartdistance, var_0.atmosfogdistancescale, int( var_0.atmosfogskydistance ), var_0.atmosfogskyangularfalloffenabled, var_0.atmosfogskyfalloffstartangle, var_0.atmosfogskyfalloffanglerange, var_0.atmosfogsundirection, var_0.atmosfogheightfogenabled, var_0.atmosfogheightfogbaseheight, var_0.atmosfogheightfoghalfplanedistance );
        }
        else
            set_fog_to_ent_values_dfog( var_0, var_1 );
    }
...
_id_C203( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = ( 0, 0, 0 );
    else
    ...
    var_5 = var_1 _id_B6EF( var_2, var_3, var_4 );
    var_1 _id_B82B( var_0, var_2, var_5 );
    playfxontag( var_0, var_5, "tag_origin" );
}

_id_B82B( var_0, var_1, var_2 )
{
    if ( !isdefined( self._id_D110 ) )
        self._id_D110 = [];

    var_1 = tolower( var_1 );

    if ( !isdefined( self._id_D110[var_1] ) )
        self._id_D110[var_1] = [];

    if ( !isdefined( self._id_D110[var_1][var_0] ) )
        self._id_D110[var_1][var_0] = [];

    var_3 = self._id_D110[var_1][var_0].size;
    self._id_D110[var_1][var_0][var_3] = var_2;
}

_id_AC02( var_0, var_1, var_2, var_3 )
{
    _id_D047( var_0, var_1, var_2, ::stopfxontag, var_3 );
}

_id_C0D0( var_0, var_1, var_2, var_3 )
{
    _id_D047( var_0, var_1, var_2, ::killfxontag, var_3 );
}

_id_D047( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = 0;

    var_1 _id_C6DB( var_0, var_2, var_3 );

    if ( !var_4 )
        call [[ var_3 ]]( var_0, var_1, var_2 );
}

_id_C6DB( var_0, var_1, var_2 )
{
    if ( !isdefined( self._id_D110 ) )
        return;
    ...
    var_3 = self._id_D110[var_1][var_0];
    ...
    self._id_D110[var_1][var_0] = undefined;

    if ( self._id_D110[var_1].size == 0 )
        self._id_D110[var_1] = undefined;
}

_id_AE1E( var_0, var_1, var_2, var_3, var_4 )
{
    self endon( "death" );
    ...
    if ( level.console || !isdefined( var_2 ) )
    ...
    else
    {
        ...
        var_6 = !var_0 is_player_gamepad_enabled();
        ...
        while ( isdefined( self ) )
        {
            ...
            if ( var_6 != var_0 is_player_gamepad_enabled() )
            {
                var_6 = var_0 is_player_gamepad_enabled();
...
_id_BAF1( var_0, var_1, var_2, var_3 )
{
    self endon( "death" );
    ...
    var_4 = var_0 is_player_gamepad_enabled();
    var_5 = var_1;
    ...
    while ( isdefined( self ) )
    {
        ...
        {
            var_4 = var_6;
            var_5 = ter_op( var_5 == var_1, var_2, var_1 );
            self settext( var_5 );
        }
...
_id_C1D5( var_0, var_1 )
{
    return _id_B4C3( var_0 / var_1 );
}

_id_AFC4( var_0, var_1, var_2 )
{
    if ( var_1 > var_2 )
        return _id_AFC4( var_0, var_2, var_1 );

    var_3 = var_2 - var_1;
    return _id_C1D5( var_0, var_3 ) - _id_C1D5( var_1, var_3 );
}
...
_id_B9AA( var_0, var_1 )
{
    return _id_B6CF( _id_B4C3( var_0 ), var_1 );
}
