...
setup_hints()
{
    foreach ( var_1 in level.elevators )
    {
        ...
        var_2 thread common_scripts\utility::_id_AE1E( level.player, &"ELEVATOR_USE_HINT", &"ELEVATOR_USE_HINT_PC", "trigger" );
    }

    foreach ( var_7 in level.elevator_callbuttons )
    {
        var_7 setcursorhint( "HINT_NOICON" );
        var_7 thread common_scripts\utility::_id_AE1E( level.player, &"ELEVATOR_CALL_HINT", &"ELEVATOR_CALL_HINT_PC", "trigger" );
    }
}
