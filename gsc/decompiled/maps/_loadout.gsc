...
give_loadout()
{
    ...
    maps\_loadout_code::loadout( "cliffhanger", undefined, undefined, undefined, undefined, "viewhands_arctic", "british" );
    maps\_loadout_code::loadout( "airport", "m240", "m4_grenadier_airport", "fraggrenade", "flash_grenade", "viewhands_airport", "american" );
    maps\_loadout_code::loadout( "favela", "masada_grenadier_acog", "m1014", "fraggrenade", "flash_grenade", "viewhands_tf141_favela", "taskforce" );
    ...
    maps\_loadout_code::loadout( "favela_escape", "ump45_acog", "glock", "fraggrenade", "flash_grenade", "viewhands_tf141_favela", "taskforce" );
    maps\_loadout_code::loadout( "arcadia", "scar_h_reflex", "beretta", "fraggrenade", "flash_grenade", "viewmodel_base_viewhands", "american" );
    maps\_loadout_code::loadout( "oilrig", "m4m203_silencer_reflex", "scar_h_thermal_silencer", "fraggrenade", "flash_grenade", "viewhands_udt", "seal" );
    maps\_loadout_code::loadout( "gulag", "m14_scoped_arctic", undefined, "fraggrenade", "flash_grenade", "viewhands_udt", "seal" );
    maps\_loadout_code::loadout( "dcburning", "m4m203_eotech", "beretta", "fraggrenade", "flash_grenade", "viewmodel_base_viewhands", "american" );
    maps\_loadout_code::loadout( "contingency", "m21_scoped_arctic_silenced", "usp_silencer", "fraggrenade", "flash_grenade", "viewhands_arctic", "american" );
    maps\_loadout_code::loadout( "dcemp", "m4m203_eotech", "beretta", "fraggrenade", "flash_grenade", "viewhands_us_army_dmg", "american" );
    maps\_loadout_code::loadout( "dc_whitehouse", "m4_grenadier", "beretta", "fraggrenade", "flash_grenade", "viewhands_us_army_dmg", "american" );
    maps\_loadout_code::loadout( "estate", "masada_digital_grenadier_eotech", "beretta", "fraggrenade", "flash_grenade", "viewhands_tf141", "british" );
    maps\_loadout_code::loadout( "boneyard", "m14_scoped_silencer", "mp5_silencer_reflex", "fraggrenade", "flash_grenade", "viewhands_marine_sniper", "american" );
    maps\_loadout_code::loadout( "af_caves", "cheytac_silencer_desert", "kriss_acog_silencer", "fraggrenade", "flash_grenade", "viewhands_tf141", "american" );
    maps\_loadout_code::loadout( "af_chase", "uzi", "rpd", "fraggrenade", "flash_grenade", "viewhands_tf141", "american" );
    maps\_loadout_code::loadout( "ending", "uzi", "rpd", "fraggrenade", "flash_grenade", "viewhands_tf141", "american" );
