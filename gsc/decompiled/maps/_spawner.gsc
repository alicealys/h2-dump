...
trigger_reinforcement_spawn_guys()
{
    ...
    for (;;)
    {
        ...
        var_2 = var_0 trigger_spawner_spawns_guys();
...
drop_akimbo()
{
    ...
    {
        var_1 = common_scripts\utility::ter_op( maps\_utility::hastag( var_0.model, "TAG_AKIMBO" ), "TAG_AKIMBO", "TAG_FLASH" );
        var_0 attach( var_0.model, var_1 );
    }
}
...
_id_D451( var_0, var_1, var_2 )
{
    ...
    if ( var_3 )
    {
        if ( !isdefined( level._id_C86D ) )
            level._id_C86D = 1;
        else
        {
            level._id_C86D++;

            if ( level._id_C86D == 20 )
...
ai_lasers()
{
    ...
    self.custom_laser_function = ::_id_AE9D;
    maps\_utility::_id_D295();
    self waittill( "death" );
...
spawner_swap_drone_to_ai( var_0 )
{
    ...
    for ( var_7 = 5; var_5 && var_6 < var_7; var_5 = maps\_utility::spawn_failed( var_4 ) )
    {
        if ( getfreeaicount() == 0 )
            break;
    ...
    {
        var_4 attach( var_0.hatmodel );
        var_4.hatmodel = var_0.hatmodel;
    }
...
{
    level.player _meth_85CC( "total_kills", 1 );
}

hero_stats_headshots()
{
    if ( self.damagelocation == "head" )
        level.player _meth_85CC( "headshots", 1 );
}
...
death_achievements()
{
    ...
    thread achieve_slowmo_breach_kills( var_0 );
    thread achieve_downed_kills( var_0 );
...
achieve_headbanger( var_0, var_1, var_2 )
{
    ...
    if ( !animscripts\utility::damagelocationisany( "head", "neck", "helmet" ) )
        return;

    maps\_utility::giveachievement_wrapper( "HEADBANGER" );
}

_id_B98E( var_0, var_1 )
{
    if ( self.team != "axis" )
        return;
    ...
    wait 4;
    level._id_B98E = undefined;
}

_id_AAA9( var_0, var_1 )
{
    if ( self.team != "axis" )
        return;
    ...
    {
        level._id_AAA9 = undefined;
        return;
    }

    if ( !isdefined( level._id_AAA9 ) )
        level._id_AAA9 = 1;
    else
        level._id_AAA9++;
...
_id_AD48( var_0 )
{
    ...
    if ( isdefined( level._id_B24D ) )
    {
        maps\_utility::giveachievement_wrapper( "ROADKILL" );
        level._id_B24D = undefined;
    }
    else
    {
        level._id_B24D = 1;
...
achieve_some_like_hot_thermal( var_0, var_1 )
{
    ...
    if ( var_0.achieve_some_like_hot_thermal == 6 )
        var_0 maps\_utility::player_giveachievement_wrapper( "SOME_LIKE_IT_HOT" );
...
achieve_2_birds_1_stone( var_0, var_1 )
{
    ...
    if ( isdefined( var_0.drivingvehicle ) )
    {
    ...
    if ( var_0.achieve_2_birds_1_stone == 2 )
        var_0 maps\_utility::player_giveachievement_wrapper( "TWO_BIRDS_WITH_ONE_STONE" );
...
achieve_driveby( var_0 )
{
    ...
    if ( var_0.achieve_driveby >= 20 )
        var_0 maps\_utility::player_giveachievement_wrapper( "DRIVE_BY" );
}
...
achieve_harder_they_fall( var_0 )
{
    ...
    if ( var_0.achieve_harder_they_fall == 2 )
        var_0 maps\_utility::player_giveachievement_wrapper( "THE_HARDER_THEY_FALL" );
...
achieve_riotshield_melee( var_0, var_1 )
{
    ...
    var_0 maps\_utility::player_giveachievement_wrapper( "UNNECESSARY_ROUGHNESS" );
}

achieve_slowmo_breach_kills( var_0 )
{
    if ( !isplayer( var_0 ) )
        return;

    if ( !isdefined( var_0.isbreaching ) )
    {
        var_0.achieve_slowmo_breach_kills = undefined;
        return;
    }

    if ( !isdefined( var_0.achieve_slowmo_breach_kills ) )
        var_0.achieve_slowmo_breach_kills = 1;
    else
        var_0.achieve_slowmo_breach_kills++;
    ...
    if ( var_0.achieve_slowmo_breach_kills == 4 && var_0.breaching_shots_fired <= 4 )
        var_0 maps\_utility::player_giveachievement_wrapper( "KNOCK_KNOCK" );
}

achieve_downed_kills( var_0 )
{
    if ( !isplayer( var_0 ) )
        return;
    ...
    if ( !var_0.laststand )
    {
        var_0.achieve_downed_kills = undefined;
        return;
    }

    if ( !isdefined( var_0.achieve_downed_kills ) )
        var_0.achieve_downed_kills = 1;
    else
        var_0.achieve_downed_kills++;

    if ( var_0.achieve_downed_kills == 4 )
        var_0 maps\_utility::player_giveachievement_wrapper( "DOWNED_BUT_NOT_OUT" );
}
...
achieve_one_man_army( var_0, var_1, var_2 )
{
    ...
    if ( var_0.achieve_one_man_army.size == 5 )
        var_0 maps\_utility::player_giveachievement_wrapper( "ONE_MAN_ARMY" );
}
...
achieve_akimbo( var_0, var_1 )
{
    ...
    if ( var_0.achieve_akimbo == 10 )
        var_0 maps\_utility::player_giveachievement_wrapper( "LOOK_MA_TWO_HANDS" );
}
...
achieve_stealth_knife( var_0, var_1 )
{
    ...
    if ( !maps\_utility::ent_flag( "_stealth_normal" ) )
        return;
    ...
    var_0 maps\_utility::player_giveachievement_wrapper( "NO_REST_FOR_THE_WARY" );
}
...
achieve_threesome( var_0, var_1, var_2 )
{
    ...
    if ( var_0.achieve_threesome == 3 )
        var_0 maps\_utility::player_giveachievement_wrapper( "THREESOME" );
    ...
    if ( isdefined( self.headmodel ) )
    {
        switch ( self.headmodel )
        {
            case "head_opforce_arab_d_hat":
                codescripts\character::sethatmodel( "hat_opforce_arab_d" );
                break;
            case "head_opforce_merc_b_hat":
                codescripts\character::sethatmodel( "hat_opforce_merc_b" );
                break;
            case "head_militia_bb_blk_hat":
                codescripts\character::sethatmodel( "hat_militia_bb_blk" );
                break;
        }
    }
}
