...
pre_load()
{
    ...
    level._id_B8AB = "viewbody_udt_wet";
    level.scr_model["worldbody"] = "viewbody_udt_wet";
    _id_AAAB::main();
...
{
    level.scr_model["player_rig"] = "viewhands_udt_wet";
    level.player setviewmodel( "viewhands_udt_wet" );
    common_scripts\utility::flag_wait( "obj_c4_ambush_plant_complete" );
    level.scr_model["player_rig"] = "viewhands_udt";
    level.player setviewmodel( "viewhands_udt" );
    level.scr_model["h2_active_breacher_rig"] = "viewbody_udt";
    level.scr_model["worldbody"] = "viewbody_udt";
}
