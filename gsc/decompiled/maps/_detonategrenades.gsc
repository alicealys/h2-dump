...
{
    level._effect["explosion_overlay_" + var_0 + "_left"] = loadfx( "vfx/explosion/explosion_overlay_" + var_0 + "_left" );
    level._effect["explosion_overlay_" + var_0 + "_bottom"] = loadfx( "vfx/explosion/explosion_overlay_" + var_0 + "_middle" );
    level._effect["explosion_overlay_" + var_0 + "_right"] = loadfx( "vfx/explosion/explosion_overlay_" + var_0 + "_right" );
}

setgrenadeexplosionfxoverride( var_0, var_1 )
{
    level._effect["explosion_overlay_" + var_0 + "_left"] = common_scripts\utility::getfx( "explosion_overlay_" + var_1 + "_left" );
    level._effect["explosion_overlay_" + var_0 + "_bottom"] = common_scripts\utility::getfx( "explosion_overlay_" + var_1 + "_bottom" );
    level._effect["explosion_overlay_" + var_0 + "_right"] = common_scripts\utility::getfx( "explosion_overlay_" + var_1 + "_right" );
}
...
getgrenadeexplosionfx( var_0, var_1 )
{
    ...
    if ( isdefined( level._effect[var_2] ) )
        return level._effect[var_2];
