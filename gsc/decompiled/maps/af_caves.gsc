...
_id_AD89()
{
    ...
    objective_position( var_0, ( 3006, 11756, -1834 ) );
...
_id_AA4C()
{
    ...
    while ( maps\_utility::_id_D325( self.origin + ( 0, 0, 48 ), undefined, 1 ) || distancesquared( level.player.origin, self.origin ) <= var_0 )
    {
...
_id_D544()
{
    ...
    var_0 = maps\_utility::groundpos( ( 4563, 9222, -3565 ) );
...
_id_AB8E()
{
    ...
    wait 5;
    level.price setgoalpos( maps\_utility::groundpos( ( 5207, 9566, -3499 ) ) );
}
