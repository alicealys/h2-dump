...
_id_C888()
{
    ...
    level.scr_model["player_bigjump"] = "h2_viewbody_stoccom";
    ...
    level.scr_model["worldbody"] = "h2_viewbody_stoccom";
    ...
    level.scr_model["viewhands"] = "viewhands_player_tf141_favela";
