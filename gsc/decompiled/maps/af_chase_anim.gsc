...
_id_C7A7( var_0 )
{
    ...
    var_2 linkto( level._id_B416, var_1, ( 1.5, 0, 0 ), ( 0, 180, 0 ) );
    var_3 = 2;
...
_id_CF6D( var_0 )
{
    ...
    level._id_C381 moveto( ( 65, 0, 0 ), var_0, var_0 * 0.5, var_0 * 0.5 );
}
...
player_animations()
{
    ...
    level.scr_model["player_rig"] = "viewbody_tf141_wet";
    ...
    level.scr_model["dizzy_stumble"] = "viewhands_tf141";
...
_id_BE08( var_0 )
{
    common_scripts\utility::_id_C203( common_scripts\utility::getfx( "footstep_dust_sandstorm_runner" ), var_0, "J_Ball_RI", ( 0, 0, 0 ), ( 0, -90, 90 ) );
}

_id_D106( var_0 )
{
    common_scripts\utility::_id_C203( common_scripts\utility::getfx( "footstep_dust_sandstorm_runner" ), var_0, "J_Ball_LE", ( 0, 0, 0 ), ( 0, -90, 90 ) );
}
...
_id_B14E( var_0 )
{
    ...
    var_1 = 0.5;
    level._id_C381 moveto( ( 40, 0, 0 ), var_1, 0, var_1 );
}
