...
special_death_hint( var_0, var_1, var_2 )
{
    ...
    if ( level.gameskill == 0 && var_1 == "MOD_RIFLE_BULLET" && isdefined( var_0 ) && isdefined( var_0.destructible_type ) && var_0.exploding == 1 && var_0.exploded == 1 )
        var_1 = "MOD_EXPLOSIVE";
    ...
    switch ( var_1 )
    {
        ...
        case "MOD_EXPLOSIVE":
            ...
            if ( level.player _id_AB39( var_0 ) )
                return;
...
destructible_death( var_0 )
{
    ...
    else
    {
        ...
        thread set_death_icon( "hud_destructibledeathicon", 50, 50 );
    }
