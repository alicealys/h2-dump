...
guy_enter( var_0, var_1 )
{
    ...
    var_2 = maps\_vehicle_code::_id_B80B( self.classname );
...
guy_runtovehicle( var_0, var_1, var_2, var_3, var_4 )
{
    var_1 endon( "stop_loading" );
    var_5 = 1;
    ...
    var_6 = level.vehicle_aianims[var_1.classname];
    ...
    {
        if ( isdefined( var_6[var_11].getin ) )
            var_10 = 1;
    }
    ...
    var_12 = var_1 get_availablepositions( var_3 );

    if ( isdefined( var_0.script_startingposition ) )
        var_8 = var_1 vehicle_getinstart( var_0.script_startingposition );
    else if ( !var_1.usedpositions[0] )
    {
        var_8 = var_1 vehicle_getinstart( 0 );
    ...
    else if ( var_12.availablepositions.size )
        var_8 = common_scripts\utility::getclosest( var_0.origin, var_12.availablepositions );
    else
        var_8 = undefined;

    if ( !var_12.availablepositions.size && var_12.nonanimatedpositions.size )
    {
        var_0 notify( "enteredvehicle" );
        var_1 guy_enter( var_0, var_5 );
        return;
    ...
    if ( isdefined( var_4 ) )
    {
        ...
        var_17 = maps\_utility::_id_C32D( var_15, var_4 );
    ...
    var_0.forced_startingposition = var_8.vehicle_position;
    var_1.usedpositions[var_8.vehicle_position] = 1;
    ...
    var_18 = anim_pos( var_1, var_8.vehicle_position );

    if ( isdefined( var_18.delay ) )
    {
        var_0.delay = var_18.delay;

        if ( isdefined( var_18.delayinc ) )
            self.delayer = var_0.delay;
    }

    if ( isdefined( var_18.delayinc ) )
    {
        self.delayer += var_18.delayinc;
        var_0.delay = self.delayer;
    }

    var_1 link_to_sittag( var_0, var_18.sittag, var_18.sittag_offset, var_18.linktoblend );
    var_0.allowdeath = 0;
    var_18 = var_6[var_8.vehicle_position];

    if ( isdefined( var_8 ) )
    {
        if ( isdefined( var_18.vehicle_getinanim ) )
        {
            if ( isdefined( var_18.vehicle_getoutanim ) )
            {
                var_19 = isdefined( var_0.no_vehicle_getoutanim );

                if ( !var_19 )
                    var_1 clearanim( var_18.vehicle_getoutanim, 0 );
            }

            var_1 = var_1 getanimatemodel();
            var_1 thread setanimrestart_once( var_18.vehicle_getinanim, var_18.vehicle_getinanim_clear );
            level thread maps\_anim::start_notetrack_wait( var_1, "vehicle_anim_flag" );
        }

        if ( isdefined( var_18.vehicle_getinsoundtag ) )
            var_9 = var_1 gettagorigin( var_18.vehicle_getinsoundtag );
        else
            var_9 = var_1.origin;

        if ( isdefined( var_18.vehicle_getinsound ) )
            thread common_scripts\utility::play_sound_in_space( var_18.vehicle_getinsound, var_9 );

        var_20 = undefined;
        var_21 = undefined;

        if ( isdefined( var_18.getin_enteredvehicletrack ) )
        {
            var_20 = [];
            var_20[0] = var_18.getin_enteredvehicletrack;
            var_21 = [];
            var_21[0] = ::entered_vehicle_notify;
            var_1 link_to_sittag( var_0, var_18.sittag, var_18.sittag_offset, var_18.linktoblend );
        }

        var_1 animontag( var_0, var_18.sittag, var_18.getin, var_20, var_21 );
    }
...
{
    var_2 = maps\_vehicle_code::_id_B80B( var_0.classname );
    return level.vehicle_aianims[var_2][var_1];
}
...
{
    var_5 = maps\_vehicle_code::_id_B80B( self.classname );
...
getout_rigspawn( var_0, var_1, var_2 )
{
    ...
    var_3 = maps\_vehicle_code::_id_B80B( self.classname );
    var_4 = anim_pos( self, var_1 );
...
guy_unload( var_0, var_1 )
{
    ...
    if ( !var_9 )
    {
        ...
        if ( isdefined( var_2.fastroperig ) )
            var_0 maps\_utility::_id_D003( self, var_2.fastroperig );
        ...
        if ( isdefined( var_2._id_BAE9 ) )
        {
            var_0._id_BAE9 = 1;

            if ( isdefined( var_2._id_B419 ) )
                var_0._id_B419 = var_2._id_B419;
        }
        ...
        else
        {
            ...
            if ( isdefined( var_0._id_BA60 ) )
            {
                thread animontag( var_0, var_10, var_11, undefined, undefined );
                var_0 thread _id_CD93();
                var_0.a.nodeath = 1;
                var_18 = var_0 _id_CC6A();

                if ( isdefined( var_18 ) && var_18 == "interrupt" )
                {
                    while ( !isdefined( var_0._id_CAA7 ) )
                        waitframe();
                ...
                var_0 _meth_8584( 0 );
                self._id_CAA7 = undefined;
                var_0._id_BA60 = undefined;
                var_0.a.nodeath = 0;
            }
            else
    ...
    if ( isalive( var_0 ) )
    {
        ...
        if ( isai( var_0 ) )
        {
            ...
            if ( ( !isdefined( var_0.keepgoalonunload ) || var_0.keepgoalonunload == 0 ) && guy_resets_goalpos( var_0 ) )
            {
...
animontag( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !isdefined( var_0.no_vehicle_ragdoll ) && getdvar( "ragdoll_enable" ) != "0" )
    {
        if ( isdefined( var_0._id_BAE9 ) )
            level thread _id_CCC8( var_0, self );
        else if ( isdefined( var_0.ragdoll_getout_death ) )
...
animontag_ragdoll_death( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        while ( isdefined( var_0._id_BA60 ) && !isdefined( var_0._id_CAA7 ) )
            waitframe();
...
animontag_ragdoll_death_fall( var_0, var_1, var_2 )
{
    ...
    {
        var_3 = getangledelta( var_0.ragdoll_fall_anim, 0, 1 );
...
_id_CCC8( var_0, var_1 )
{
    ...
    var_0.a.nodeath = 1;
    var_0 kill();
    var_5 = common_scripts\utility::ter_op( var_0 == var_1.riders[0], 1400, 800 );

    if ( gettime() - var_2 < var_5 )
    {
        var_0 animscripted( "snowmobile_unload_death", var_0.origin, var_0.angles, var_0._id_B419 );
...
guy_man_turret( var_0, var_1, var_2 )
{
    ...
    if ( var_4.ownervehicle.vehicletype == "technical" )
    ...
    {
        var_4 thread _id_AF12( var_0, var_5 );
...
convert_guy_to_drone( var_0, var_1, var_2 )
{
    ...
    for ( var_5 = 0; var_5 < var_4 && ( var_2 || var_5 < 1 ); var_5++ )
    {
        ...
        if ( var_5 == 0 )
            var_3.headmodel = var_0 getattachmodelname( var_5 );
    }
    ...
    var_3._id_A87F = var_0._id_A87F;

    if ( isdefined( var_3.team ) && var_3.team != "allies" )
        var_3 thread _id_C0C3::addspecialmonitors();
