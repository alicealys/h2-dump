...
_id_BE2B( var_0, var_1 )
{
    ...
    if ( isdefined( level._id_D13B ) )
        objective_onentity( 1, level._id_D13B, ( 0, 0, 70 ) );
...
_id_C394()
{
    ...
    objective_onentity( 1, self, ( 0, 0, 70 ) );
...
_id_C6D8( var_0 )
{
    ...
    var_0 thread common_scripts\utility::play_loop_sound_on_entity( var_1, ( -40, -75, 10 ) );
    wait 60;
