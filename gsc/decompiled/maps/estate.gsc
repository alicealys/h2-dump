...
_id_D371()
{
    level._id_B77F = spawn( "script_origin", ( 0.25, 0, 0 ) );
...
_id_C744( var_0, var_1, var_2 )
{
    ...
    playfx( common_scripts\utility::getfx( "gasoline_fire_on_player_ignite" ), level.player.origin + ( -6, 56, 54 ) );
    playfx( common_scripts\utility::getfx( "gasoline_fire_on_player" ), level.player.origin + ( -6, 56, 54 ) );
    wait 0.1;
    setblur( 2, 3 );
    wait 1.2;
