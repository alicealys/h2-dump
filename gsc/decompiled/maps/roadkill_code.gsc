...
_id_B28F()
{
    ...
    var_2.pivot linkto( var_1, "origin_animate_jnt", ( 0, 0, 0 ), ( 0, 0, 180 ) );
    var_2 hide();
...
_id_D0FF()
{
    self.target_ent.origin = level._id_B079.origin + ( 0, 0, 32 );
    self waittill( "turret_on_target" );
    wait 0.25;
    var_0 = randomint( 4 ) - 1;
...
_id_B6C1()
{
    ...
    waittillframeend;
    common_scripts\utility::flag_wait( "get_on_the_line" );
    objective_add( maps\_utility::obj( "bridge_layer" ), "current", &"ROADKILL_OBJECTIVE_BRIDGELAYER", ( 0, 0, 0 ) );
    ...
    objective_position( maps\_utility::obj( "bridge_layer" ), ( 0, 0, 0 ) );
    common_scripts\utility::flag_wait( "bridge_layer_attacked_by_bridge_baddies" );
    wait 4.5;
    objective_position( maps\_utility::obj( "bridge_layer" ), ( -2519, -2457, 288 ) );
    setsaveddvar( "compass", 1 );
    common_scripts\utility::flag_wait( "bridge_baddies_retreat" );
    objective_position( maps\_utility::obj( "bridge_layer" ), ( 0, 0, 0 ) );
    ...
    common_scripts\utility::flag_wait( "player_gets_in" );
    objective_position( maps\_utility::obj( "convoy" ), ( 0, 0, 0 ) );
    wait 3;
...
_id_B0F5()
{
    objective_add( maps\_utility::obj( "ride" ), "current", &"ROADKILL_OBJECTIVE_SCAN", ( 0, 0, 0 ) );
    common_scripts\utility::flag_wait( "shot_rings_out" );
    wait 4.5;
    objective_add( maps\_utility::obj( "ride" ), "current", &"ROADKILL_OBJECTIVE_TARGETS", ( 0, 0, 0 ) );
...
_id_C401( var_0, var_1 )
{
    ...
    var_4 linkto( level._id_CE62["player"], "tag_body", var_1, ( 0, 0, 0 ) );
...
_id_BC58( var_0 )
{
    _id_C401( var_0, ( 0, 2500, 0 ) );
}

_id_AD34( var_0 )
{
    _id_C401( var_0, ( 0, 4000, 0 ) );
}
