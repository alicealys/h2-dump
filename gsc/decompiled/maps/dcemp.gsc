...
_id_BDD1()
{
    ...
    wait 0.35;
    wait 1.85;
    thread common_scripts\utility::play_sound_in_space( "scn_dcemp_space_transition_out", ( 0, 0, 0 ) );
    level.white_overlay fadeovertime( 4 );
...
_id_C620()
{
    ...
    thread common_scripts\utility::play_sound_in_space( "scn_dcemp_emp_main", level.player.origin + ( 0, 0, 100 ) );
...
_id_C29B()
{
    ...
    objective_onentity( level._id_CD9B, level._id_ACC0, ( 0, 0, 70 ) );
...
_id_C6D7()
{
    ...
    thread common_scripts\utility::play_sound_in_space( "elm_thunder_distant", level.player.origin + ( 0, 0, 60 ) );
    ...
    thread common_scripts\utility::play_sound_in_space( "elm_thunder_strike", level.player.origin + ( 0, 0, 60 ) );
    ...
    var_1 = spawn( "script_origin", level._id_B624 geteye() + ( 0, 0, 16 ) );
...
_id_AD29()
{
    ...
    thread common_scripts\utility::play_sound_in_space( "RU_callout_custom", ( -43611, 14086, -2.468 ) );
...
_id_CA3C()
{
    ...
    level._id_BE51[3] = spawn( "script_origin", var_0.origin + ( 0, 0, 40 ) );
    level._id_BE51[4] = spawn( "script_origin", var_0.origin + ( 0, 0, 40000 ) );
