...
_id_C8E7()
{
    ...
    thread _id_B075( var_0 * 0.75, "smoke_1", level._effect["damaged_wheel_smoke"], "left_wheel_08_jnt", ( 105, -50, -25 ), ( 0, 180, 0 ) );
    thread _id_B075( var_0 * 0.45, "smoke_3", level._effect["badger_dmg_smk"], "tag_playerride", ( 30, -12, -5 ), ( -20, 260, 0 ) );
}
...
_id_B103()
{
    ...
    for (;;)
    {
        ...
        {
            var_1 = magicbullet( "rpg_straight", var_0.origin, level._id_C7A3.origin + ( 0, 0, 60 ) );
...
_id_B8FB()
{
    ...
    for (;;)
    {
        level._id_BA28 setturrettargetent( level.player, ( 0, 0, 20 ) );
        wait( randomfloatrange( 0.5, 1.5 ) );
