...
init2()
{
    ...
    var_5 = common_scripts\utility::getstructarray( "h2_generic_flickering", "targetname" );
    common_scripts\utility::array_thread( var_5, ::_id_BD28, 1 );
    _id_CE6C( "h2_pulsing_alarm", 0, 1, 0.3, 0.3, 0, 0, 0, 0, 0 );
    _id_B532( "h2_pulsing_alarm", common_scripts\utility::getstructarray( "h2_pulsing_alarm", "targetname" ) );
    _id_CE6C( "h2_pulsing_alarm_02", 0, 1, 0.6, 0.6, 0, 0, 0, 0, 0 );
    _id_B532( "h2_pulsing_alarm_02", common_scripts\utility::getstructarray( "h2_pulsing_alarm_02", "targetname" ) );
    _id_CE6C( "h2_flickering_01", 0.001, 1, 0, 0.3, 0, 1.5, 0, 0.5, 1 );
    _id_B532( "h2_flickering_01", common_scripts\utility::getstructarray( "h2_flickering_01", "targetname" ) );
    _id_CE6C( "h2_flickering_02", 0.75, 1, 0, 0, 0.2, 1.5, 0, 1.5, 1 );
    _id_B532( "h2_flickering_02", common_scripts\utility::getstructarray( "h2_flickering_02", "targetname" ) );
    _id_CE6C( "h2_flickering_03", 0, 1, 0.5, 0.5, 0.15, 1, 0, 0.25, 1 );
    _id_B532( "h2_flickering_03", common_scripts\utility::getstructarray( "h2_flickering_03", "targetname" ) );
    _id_CE6C( "h2_flickering_flare", 0.5, 1, 0, 0.25, 0, 0.025, 0, 0.025, 1 );
    _id_B532( "h2_flickering_flare", common_scripts\utility::getstructarray( "h2_flickering_flare", "targetname" ) );
    _id_CE6C( "h2_flickering_fire", 0.6, 1, 0.1, 0.5, 0.3, 1.5, 0.2, 1.5, 1 );
    _id_B532( "h2_flickering_fire", common_scripts\utility::getstructarray( "h2_flickering_fire", "targetname" ) );
    _id_CE6C( "h2_flickering_intense_fire", 0.5, 1, 0.1, 0.4, 0.2, 0.5, 0.2, 0.5, 1 );
    _id_B532( "h2_flickering_intense_fire", common_scripts\utility::getstructarray( "h2_flickering_intense_fire", "targetname" ) );
    _id_CE6C( "h2_flickering_intense_fire2", 0.5, 1, 0.1, 0.5, 0.2, 0.4, 0.2, 0.7, 1 );
    _id_B532( "h2_flickering_intense_fire2", common_scripts\utility::getstructarray( "h2_flickering_intense_fire2", "targetname" ) );
    _id_CE6C( "h2_flickering_intense_fire_dcb", 0.25, 1, 0.3, 0.6, 0.2, 0.5, 0.2, 0.5, 1 );
    _id_B532( "h2_flickering_intense_fire_dcb", common_scripts\utility::getstructarray( "h2_flickering_intense_fire_dcb", "targetname" ) );
    _id_CE6C( "h2_flickering_broken_light", 0, 1, 0.1, 0.5, 0.15, 0.5, 0.2, 1.5, 1 );
    _id_B532( "h2_flickering_broken_light", common_scripts\utility::getstructarray( "h2_flickering_broken_light", "targetname" ) );
    _id_CE6C( "h2_flickering_intense", 0.001, 1, 0, 0, 0, 1.5, 0, 0.3, 1 );
    _id_B532( "h2_flickering_intense", common_scripts\utility::getstructarray( "h2_flickering_intense", "targetname" ) );
...
_id_CE6C( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    if ( !isdefined( level._id_B4DC ) )
        level._id_B4DC = [];

    if ( !isdefined( var_0 ) )
        return;

    if ( isdefined( level._id_B4DC[var_0] ) )
        return;

    var_10 = spawnstruct();
    var_10._id_D018 = var_1;
    var_10._id_BD13 = var_2;
    var_10._id_CA00 = var_3;
    var_10._id_BD8F = var_4;
    var_10._id_B792 = var_5;
    var_10._id_D15A = var_6;
    var_10._id_C060 = var_7;
    var_10._id_CADE = var_8;
    var_10._id_D41F = var_9;
    level._id_B4DC[var_0] = var_10;
}

_id_CAF2( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        return;

    _id_B532( var_0, [ var_1 ] );
}
...
_id_B532( var_0, var_1 )
{
    ...
    foreach ( var_5 in var_1 )
    {
        ...
        var_5._id_CA00 = var_2._id_CA00;
        var_5._id_BD8F = var_2._id_BD8F;
        var_5._id_B792 = var_2._id_B792;
        var_5._id_D15A = var_2._id_D15A;
        var_5._id_C060 = var_2._id_C060;
        var_5._id_CADE = var_2._id_CADE;
        var_5._id_D41F = var_2._id_D41F;
        ...
        foreach ( var_8 in var_6 )
        {
            if ( isdefined( var_8.script_noteworthy ) )
            {
                ...
                {
                    var_8._id_D018 = var_2._id_D018 * var_8 getlightintensity();
                    var_8._id_BD13 = var_2._id_BD13 * var_8 getlightintensity();
                }
            }
        }
    ...
    common_scripts\utility::array_thread( var_3, ::_id_BD28 );
}
...
_id_BD28( var_0 )
{
    ...
    self._id_B95E = getentarray( self.target, "targetname" );
    self._id_AA96 = undefined;
    self._id_BAC4 = undefined;
    self._id_CE9A = [];
    ...
    if ( getdvar( "r_reflectionProbeGenerate" ) == "1" )
    {
        if ( self._id_CE9A.size > 0 )
        {
            foreach ( var_5 in self._id_CE9A )
    ...
    if ( isdefined( self._id_AA96 ) && isdefined( self._id_AA96.script_fxid ) )
    {
        var_7 = strtok( self._id_AA96.script_fxid, ", " );
        self._id_AA96.fx_tag = "tag_origin";
        self._id_AA96.fx_id = common_scripts\utility::getfx( var_7[0] );

        if ( var_7.size > 1 )
            self._id_AA96.fx_tag = var_7[1];

        self._id_AA96.fx_started = 1;
        playfxontag( self._id_AA96.fx_id, self._id_AA96, self._id_AA96.fx_tag );
    }

    if ( isdefined( self._id_AA96 ) && isdefined( self._id_AA96.script_parameters ) && self._id_AA96.script_parameters == "delay_flickering" )
        self._id_AA96 waittill( "start_flickering" );

    common_scripts\utility::array_thread( self._id_CE9A, ::generic_flicker_msg_watcher );
    thread _id_A918();
}

_id_CD53()
{
    if ( isdefined( self._id_BA27 ) )
        self._id_CA00 = self._id_BA27;

    if ( isdefined( self._id_C8CF ) )
        self._id_BD8F = self._id_C8CF;

    if ( isdefined( self._id_D334 ) )
        self._id_B792 = self._id_D334;

    if ( isdefined( self._id_AD8A ) )
        self._id_D15A = self._id_AD8A;

    if ( isdefined( self._id_AC94 ) )
        self._id_C060 = self._id_AC94;

    if ( isdefined( self._id_D5C6 ) )
        self._id_CADE = self._id_D5C6;

    if ( isdefined( self._id_B44B ) )
        self._id_D41F = self._id_B44B;

    foreach ( var_1 in self._id_CE9A )
    {
        if ( !isdefined( var_1 ) )
            continue;

        if ( isdefined( self._id_D089 ) )
            var_1._id_D018 = self._id_D089 * var_1 getlightintensity();

        if ( isdefined( self._id_AE51 ) )
            var_1._id_BD13 = self._id_AE51 * var_1 getlightintensity();
    }
}
...
_id_C7A9()
{
    if ( !isdefined( self._id_CE9A[0] ) )
        return;

    if ( !self._id_CE9A[0] maps\_utility::ent_flag( "flicker_on" ) )
    {
        if ( isdefined( self._id_AA96 ) )
        {
            self._id_AA96 hide();

            if ( isdefined( self._id_AA96.effect ) )
                self._id_AA96.effect common_scripts\utility::pauseeffect();
        }
        ...
        self._id_CE9A[0] maps\_utility::ent_flag_wait( "flicker_on" );

        foreach ( var_1 in self._id_CE9A )
            var_1 setlightintensity( var_1._id_B50F );
        ...
        if ( isdefined( self._id_AA96 ) )
        {
            ...
            if ( isdefined( self._id_AA96.effect ) )
                self._id_AA96.effect maps\_utility::restarteffect();
        }
...
_id_A918()
{
    ...
    switch ( self.targetname )
    {
        ...
        default:
            ...
            self.snd_ent playloopsound( var_0 );
            thread _id_D45C();
    }

    if ( !isdefined( self._id_CA00 ) )
        self._id_CA00 = 0;

    if ( !isdefined( self._id_BD8F ) )
        self._id_BD8F = 0;

    if ( self._id_CA00 > self._id_BD8F )
        return;

    if ( !isdefined( self._id_B792 ) )
        self._id_B792 = 0.2;

    if ( !isdefined( self._id_D15A ) )
        self._id_D15A = 1.5;

    if ( !isdefined( self._id_C060 ) )
        self._id_C060 = 0.2;

    if ( !isdefined( self._id_CADE ) )
        self._id_CADE = 1.5;

    if ( !isdefined( self._id_D41F ) )
        self._id_D41F = 1;

    var_1 = max( 0.05, self._id_CA00 );
    var_2 = max( 0.05, self._id_BD8F );
    var_3 = self._id_B792;
    var_4 = self._id_D15A;
    ...
    foreach ( var_9 in self._id_CE9A )
    {
        if ( !isdefined( var_9 ) )
            continue;

        if ( !isdefined( var_9._id_D018 ) )
            var_9._id_D018 = 0;

        if ( !isdefined( var_9._id_BD13 ) )
            var_9._id_BD13 = var_9 getlightintensity();

        var_9._id_B7E9 = var_9._id_D018;
        var_9._id_B50F = var_9._id_BD13;
        var_9.curr = var_9._id_B50F;
        var_9._id_D543 = ( var_9._id_B50F - var_9._id_B7E9 ) / ( var_2 / 0.05 );
        var_9._id_C58B = ( var_9._id_B50F - var_9._id_B7E9 ) / ( var_1 / 0.05 );

        if ( var_7 && var_9._id_D543 != var_9._id_C58B )
        {
            var_9._id_ADB8 = randomfloatrange( var_9._id_D543, var_9._id_C58B );
            continue;
        }

        var_9._id_ADB8 = var_9._id_C58B;
    }
    ...
    {
        _id_C7A9();
        var_13 = common_scripts\utility::ter_op( var_7, randomintrange( 1, 10 ), 1 );
        ...
        while ( var_13 )
        {
            ...
            if ( !var_11 )
            {
                foreach ( var_9 in self._id_CE9A )
                {
                    ...
                    var_9.curr -= var_9._id_ADB8;

                    if ( var_9.curr <= var_9._id_B7E9 )
                    {
                        var_11 = 1;

                        if ( var_9._id_D543 != var_9._id_C58B )
                        {
                            var_9._id_ADB8 = randomfloatrange( var_9._id_D543, var_9._id_C58B );
                            continue;
                        }

                        var_9._id_ADB8 = var_9._id_D543;
                    }
                }
            }
            else
            ...
            foreach ( var_9 in self._id_CE9A )
            {
                ...
                var_9.curr = min( var_9._id_B50F, max( var_9._id_B7E9, var_9.curr ) );
                var_9 setlightintensity( var_9.curr );
            }

            var_21 = self._id_CE9A[0];
            ...
            if ( var_21.curr < 0.3 * ( var_21._id_B50F - var_21._id_B7E9 ) )
            {
                if ( isdefined( self._id_AA96 ) )
                {
                    self._id_AA96 hide();
                ...
                if ( isdefined( self.snd_ent ) )
                    self.snd_ent setvolume( 0, 0 );

                if ( isdefined( self._id_AA96 ) && isdefined( self._id_AA96.fx_id ) && self._id_AA96.fx_started )
                {
                    self._id_AA96.fx_started = 0;
                    killfxontag( self._id_AA96.fx_id, self._id_AA96, self._id_AA96.fx_tag );
                }
            }
            else
            {
