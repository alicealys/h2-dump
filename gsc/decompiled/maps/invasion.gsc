...
main()
{
    ...
    common_scripts\utility::array_thread( getentarray( "nova_tv", "targetname" ), ::_id_C150, "h1_mwr_com_widescreen_monitor_des", "tv_explosion", ( 0, 0, -15 ), 0, 1 );
    common_scripts\utility::array_thread( getentarray( "monitor_destruct1", "targetname" ), ::_id_C150, "h1_mwr_com_widescreen_monitor_des", "tv_explosion", ( 0, 0, 25 ), 1, 1 );
    common_scripts\utility::array_thread( getentarray( "monitor_destruct_on1", "targetname" ), ::_id_C150, "com_widescreen_monitor_on_1_des", "tv_explosion", ( 0, 0, 25 ), 1, 1 );
    common_scripts\utility::array_thread( getentarray( "monitor_destruct_2_on", "targetname" ), ::_id_C150, "com_widescreen_monitor_on_2_des", "tv_explosion", ( 0, 0, 30 ), 1, 1 );
...
_id_A8C4()
{
    ...
    maps\_vehicle::build_radiusdamage( ( 0, 0, 53 ), 512, 90, 20, 0 );
    thread _id_B0B0();
    ...
    var_1 = spawn( "script_origin", level._id_C7B1 gettagorigin( "tag_guy1" ) + ( 0, 0, 1 ) );
    var_1.angles = level._id_C7B1 gettagangles( "tag_guy1" );
    var_1 linkto( level._id_C7B1, "tag_guy1" );
    var_2 = spawn( "script_origin", level._id_C7B1 gettagorigin( "tag_passenger" ) + ( 0, 0, 1 ) );
...
_id_D269()
{
    ...
    {
        playfx( level._effect["falling_debris_player"], var_0.origin + ( 0, 0, 500 ) );
        wait 0.2;
    }
}
...
_id_AC12( var_0 )
{
    var_1 = magicbullet( "remote_missile_not_player_invasion", level._id_C176.origin + ( 0, 0, -128 ), var_0 );
...
_id_CE8D()
{
    ...
    if ( _id_BA11() )
    {
        ...
        var_2 = magicbullet( "remote_missile_not_player_invasion", level._id_C176.origin + ( 0, 0, -128 ), var_1 );
...
_id_C7A1()
{
    ...
    self setturrettargetent( level._id_C7B1, ( 0, 0, 40 ) );
    wait 1.5;
    ...
    maps\_utility::delaythread( 0.25, common_scripts\utility::play_sound_in_space, "scn_invasion_plr_veh_bullet_impact", level._id_CA77.origin + ( 0, -90, 70 ) );
    self setturrettargetent( level._id_CA77, ( 0, 0, 50 ) );
    wait 1;
...
_id_C450( var_0 )
{
    ...
    {
        self setturrettargetent( var_0, common_scripts\utility::randomvector( 20 ) + ( 0, 0, 32 ) );
        self fireweapon();
        wait( var_2 );
    }
}
...
miss_player( var_0 )
{
    ...
    {
        var_7 = common_scripts\utility::randomvector( 15 ) + var_3 + ( 0, 0, 64 );
...
_id_A94C( var_0 )
{
    ...
    while ( var_1.state != "done" )
    {
        ...
        objective_position( var_1.id, level._id_C208 + ( 0, 0, 70 ) );
        wait 2.2;
    }
}
...
_id_D16B()
{
    ...
    thread _id_BDC5( "obj_crash", level._id_CE19, ( 0, 0, 70 ) );
    common_scripts\utility::flag_wait( "crash_objective" );
...
_id_B634()
{
    ...
    if ( !common_scripts\utility::flag( "bmp_north_left_dead" ) )
    {
        ...
        thread _id_BDC5( "obj_bmps", level._id_C477, ( 0, 0, 96 ) );
    ...
    else if ( !common_scripts\utility::flag( "bmp_north_mid_dead" ) )
    {
        ...
        _id_C7C7( "obj_bmps", "current" );
        thread _id_BDC5( "obj_bmps", level._id_D31A, ( 0, 0, 96 ) );
        _id_D364( "obj_bmps", &"INVASION_WAYPOINT_DESTROY" );
    }
    else
        return;
...
_id_B5F5()
{
    ...
    thread _id_BDC5( "obj_raptor_defend", level._id_CE19, ( 0, 0, 70 ) );
    ...
    _id_BD26( "obj_neutralize", &"INVASION_OBJ_BURGERTOWN_DEFEND", ( 0, 0, 0 ), 1 );
...
_id_B31F()
{
    ...
    thread _id_BDC5( "obj_convoy", level._id_B818, ( 35, -25, 64 ) );
