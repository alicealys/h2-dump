...
main()
{
    ...
    level._id_C7A3.missileattractor = spawn( "script_origin", level._id_C7A3.origin + ( 0, 0, 70 ) );
    ...
    common_scripts\utility::array_thread( getentarray( "monitor_destruct2", "targetname" ), ::_id_C150, "h1_mwr_com_widescreen_monitor_2_des", "tv_explosion", ( 0, 0, 25 ), 1, 1 );
    common_scripts\utility::array_thread( getentarray( "monitor_destruct_2_on", "targetname" ), ::_id_C150, "com_widescreen_monitor_on_2_des", "tv_explosion", ( 0, 0, 27 ), 1, 1 );
    common_scripts\utility::array_thread( getentarray( "monitor_destruct_on1", "targetname" ), ::_id_C150, "com_widescreen_monitor_on_1_des", "tv_explosion", ( 0, 0, 30 ), 1, 1 );
    common_scripts\utility::array_thread( getentarray( "monitor_destruct_on2", "targetname" ), ::_id_C150, "com_widescreen_monitor_on_2_des", "tv_explosion", ( 0, 0, 30 ), 1, 1 );
    common_scripts\utility::array_thread( getentarray( "monitor_destruct_on_1_var2", "targetname" ), ::_id_C150, "com_widescreen_monitor_on_1_des", "tv_explosion", ( 0, 0, 30 ), 1, 1 );
    common_scripts\utility::array_thread( getentarray( "monitor_destruct_on_2_var2", "targetname" ), ::_id_C150, "com_widescreen_monitor_on_2_des", "tv_explosion", ( 0, 0, 30 ), 1, 1 );
...
_id_D3F9()
{
    ...
    objective_state( 1, "current" );
    objective_position( 1, ( 14742, -6400, 2584 ) );
