...
_id_CF05()
{
    ...
    level.player setviewangleresistance( 50, 50, 20, 20 );
    level.player.rig setmodel( "h2_viewbody_sniper_uaz" );
    wait 0.5;
    maps\_utility::enableplayerweapons( 0 );
...
_id_B7CA()
{
    ...
    for (;;)
    {
        ...
        for ( var_3 = 0; var_3 < var_1; var_3++ )
        {
            ...
            magicbullet( self.weapon, level.price geteye() + ( 0, 0, 16 ), var_2 );
            wait 0.1;
        }
    ...
    for (;;)
    {
        ...
        switch ( var_1 )
        {
            ...
            case "frontal":
                ...
                var_2 = _id_CC8D( ( 0, 0, 50 ), var_0.angles );
            ...
            case "crash":
                ...
                var_0 vehphys_enablecrashing();
                var_2 = _id_CC8D( ( 64, -256, 0 ), var_0.angles );
                var_0 vehphys_launch( var_2, 0 );
...
_id_B8C6()
{
    ...
    var_0 linkto( self );
    common_scripts\utility::_id_C203( common_scripts\utility::getfx( "h2_c130_interior_light" ), var_0, "tag_origin", ( 575, 0, 165 ), ( 0, 0, 0 ) );
    common_scripts\utility::_id_C203( common_scripts\utility::getfx( "c138_takeoff_dust" ), var_0, "tag_origin", ( -340, 0, 6 ), ( 0, 180, 90 ) );
    wait 13.85;
    common_scripts\utility::_id_C203( common_scripts\utility::getfx( "scrape_sparks" ), var_0, "tag_origin", ( -340, 0, 6 ), ( 0, 180, 90 ) );
    self playloopsound( "veh_c130_ramp_scrape_loop" );
    wait 4.15;
    common_scripts\utility::_id_C203( common_scripts\utility::getfx( "scrape_sparks_right" ), var_0, "tag_origin", ( -411, -37.5, 2 ), ( 0, 180, 90 ) );
    wait 0.9;
    common_scripts\utility::_id_C203( common_scripts\utility::getfx( "scrape_sparks_left" ), var_0, "tag_origin", ( -411, 35, 2 ), ( 0, 180, 90 ) );
}
...
_id_C495( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_1 = level._id_AC64.origin + ( 0, 0, 128 );
...
{
    var_3 = transformmove( level._id_AC64.origin, level._id_AC64.angles, var_1, ( 0, 0, 0 ), self.origin, ( 0, 0, 0 ) );
