...
_id_BD4B()
{
    ...
    objective_onentity( 2, level._id_D242, ( 0, 0, 90 ) );
...
_id_B33A()
{
    ...
    {
        level._id_D2D2 rotateto( ( 0, 0, 0 ), 0.5, 0.25, 0.25 );
...
_id_CA99()
{
    ...
    var_4 = maps\af_chase_knife_fight_code::_id_B991();
    var_4 linkto( level._id_B416, "tag_eye", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    var_5 = [];
...
_id_A99A()
{
    ...
    maps\af_chase_knife_fight_code::_id_C587();
    var_5 = maps\af_chase_knife_fight_code::_id_B991();
    var_5 linkto( level._id_B416, "tag_eye", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    var_6 = [];
...
_id_BCC5()
{
    ...
    var_5 = maps\af_chase_knife_fight_code::_id_B991();
    var_5 linkto( level._id_B416, "tag_origin", ( 0, 0, 0 ), ( 0, 0, 0 ) );
...
_id_B5E6()
{
    ...
    var_3 common_scripts\utility::delaycall( 0.1, ::linkto, var_2, "J_Wrist_LE", ( 0, 0, 0 ), ( 0, 0, 0 ) );
}
...
_id_C2B2()
{
    ...
    var_10 linkto( level.price, "tag_eye", ( 0, 0, 0 ), ( 0, 0, 0 ) );
...
_id_CF7C()
{
    ...
    var_7 linkto( level.price, "tag_eye", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    var_8 = "fight_C";
...
_id_ABC0()
{
    ...
    var_8 = 1.2;
    level._id_C381 moveto( ( 52, 0, 0 ), var_8, var_8 * 0.5, var_8 * 0.5 );
...
endgame()
{
    ...
    level._id_C381 moveto( ( 65, 0, 0 ), var_13, var_13 * 0.5, var_13 * 0.5 );
    var_14 = gettime();
...
_id_BBAB()
{
    ...
    level._id_C381 moveto( ( 65, 0, 0 ), var_3, var_3 * 0.5, var_3 * 0.5 );
    var_4 = [];
    var_4["shepherd"] = level._id_B416;
    var_4["price"] = level.price;
