...
_id_B43E( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_14 = self.origin + var_9 + ( 0, 0, 2.5 );
...
endsliding( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_0 )
    {
        var_12 = playerphysicstrace( level.player.origin + ( 0, 0, 40 ), level.player.origin + ( 0, 0, -100 ) );
...
_id_BD3F( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_0 ) && var_0 )
    {
        var_4 = playerphysicstrace( level.player.origin + ( 0, 0, 40 ), level.player.origin + ( 0, 0, -100 ) );
...
_id_BD5A( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( level.player common_scripts\utility::is_player_gamepad_enabled() )
    {
        ...
        level.player._id_B1FD.color = ( 1, 1, 1 );
...
_id_BA76( var_0, var_1 )
{
    ...
    level.player._id_B9DB.color = ( 0, 1, 0 );
...
_id_CBD8( var_0, var_1 )
{
    ...
    level.player._id_ADFD.alpha = 0.15;
    level.player._id_B9DB.color = ( 1, 0, 0 );
