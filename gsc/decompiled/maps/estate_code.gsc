...
_id_C2B0()
{
    ...
    level._id_B8AB = "viewbody_tf141_forest";
        ...
        if ( var_3 )
        {
            ...
            if ( var_11 <= self.radius )
            {
                if ( level.player getstance() == "prone" )
                {
                    ...
                    var_12 = common_scripts\utility::within_fov( level.player.origin, level.player.angles + ( 0, -95, 0 ), self.origin, cos( 180 ) );
                    var_13 = common_scripts\utility::within_fov( level.player.origin, level.player.angles + ( 0, 95, 0 ), self.origin, cos( 180 ) );
...
_id_BCB2()
{
    ...
    {
        var_0 = level._id_B8D7 sightconetrace( level.player.origin + ( 0, 0, 64 ) );
...
_id_CCA9()
{
    ...
    if ( !common_scripts\utility::flag( "topfloor_breached" ) )
    {
        ...
        if ( !common_scripts\utility::flag( "house_interior_breaches_done" ) )
        {
            while ( !common_scripts\utility::flag( "topfloor_breached" ) )
            {
                var_1 = level._id_B4A3 sightconetrace( level.player.origin + ( 0, 0, 64 ) );
