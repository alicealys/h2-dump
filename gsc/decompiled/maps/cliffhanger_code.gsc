...
{
    wait 2;
    _id_BD26( "obj_satellite", &"CLIFFHANGER_OBJ_COMPUTER", ( 0, 0, 0 ) );
...
_id_CF61()
{
    ...
    _id_BD26( "obj_exfiltrate", &"CLIFFHANGER_OBJ_EVACUATE", ( 0, 0, 0 ) );
...
_id_AAD5()
{
    ...
    _id_BD26( "obj_snowmobile", &"CLIFFHANGER_OBJ_SNOWMOBILE", level._id_BE57.origin + ( 0, 0, 48 ) );
