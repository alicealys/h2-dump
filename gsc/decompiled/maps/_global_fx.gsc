...
main()
{
    ...
    maps\_global_fx_code::global_fx( "lensflare_floodlight_on_FX_origin", "vfx/lights/lensflare_floodlight_on" );
    maps\_global_fx_code::global_fx( "yellow_lensflare_floodlight_on_FX_origin", "vfx/lights/yellow_lensflare_floodlight_on" );
    maps\_global_fx_code::global_fx( "light_red_steady_FX_origin", "fx/misc/tower_light_red_steady", -2 );
    maps\_global_fx_code::global_fx( "light_red_steady_FX_origin_int", "fx/misc/tower_light_red_steady_int", -2 );
    maps\_global_fx_code::global_fx( "light_blue_steady_FX_origin_int", "fx/misc/tower_light_blue_steady_int", -2 );
    maps\_global_fx_code::global_fx( "light_blue_steady_FX_origin", "fx/misc/tower_light_blue_steady", -2 );
    maps\_global_fx_code::global_fx( "light_green_steady_FX_origin", "fx/misc/tower_light_green_steady", -2 );
    maps\_global_fx_code::global_fx( "light_white_steady_FX_origin", "fx/misc/tower_light_white_steady", -2 );
    maps\_global_fx_code::global_fx( "light_orange_steady_FX_origin", "fx/misc/tower_light_orange_steady", -2 );
    maps\_global_fx_code::global_fx( "light_orange_steady_FX_origin_int", "fx/misc/tower_light_orange_steady_int", -2 );
    ...
    maps\_global_fx_code::global_fx( "flare_ambient_FX_origin", "fx/misc/flare_ambient", var_0, "flare_ambient_FX", "emt_road_flare_burn" );
    maps\_global_fx_code::global_fx( "flare_ambient_FX_nosparks_origin", "fx/misc/flare_ambient_nosparks", var_0, "flare_ambient_FX_nosparks", "emt_road_flare_burn" );
    maps\_global_fx_code::global_fx( "me_dumpster_fire_FX_origin", "fx/fire/firelp_med_pm", var_0, "me_dumpster_fire_FX", "fire_dumpster_medium" );
    maps\_global_fx_code::global_fx( "barrel_fireFX_origin", "fx/fire/firelp_barrel_pm", var_0, "global_barrel_fire", "fire_barrel_small" );
...
_id_C1C4( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = [];
    ...
    level._id_CE6D[var_0] = var_5;
}

_id_D1D8( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = [];
    var_5["targetname"] = var_0;
    var_5["fxFile"] = var_1;
    ...
    var_5["fxName"] = var_3;
    var_5["soundalias"] = var_4;
    level._id_CB2C[var_0] = var_5;
}

_id_CB59()
{
    if ( !isdefined( level._id_CB2C ) )
        return;

    foreach ( var_1 in level._id_CB2C )
    {
