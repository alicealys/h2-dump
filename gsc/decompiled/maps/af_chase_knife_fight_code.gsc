...
_id_B876()
{
    ...
    var_0 = self.angles;
    var_0 = maps\_utility::set_y( ( 0, 0, 0 ), var_0[1] + 10 );
    ...
    var_0 = maps\_utility::set_y( ( 0, 0, 0 ), var_0[1] );
...
_id_BB29( var_0 )
{
    ...
    while ( var_0 )
    {
        ...
        var_4 = common_scripts\utility::drop_to_ground( var_4 ) + ( 0, 0, 5 );
...
_id_C6A4()
{
    ...
    {
        level._id_D327 = spawn( "script_origin", ( 0, 0, 0 ) );
...
_id_C6C5()
{
    ...
    if ( common_scripts\utility::flag( "bloody_player_rig" ) )
        level.player_rig setmodel( "viewbody_tf141_injured" );
...
{
    thread _id_D190();
    objective_onentity( 3, self, ( 0, 0, 90 ) );
    ...
    wait( var_6 );
    objective_position( 3, level._id_B416.origin + ( 0, 0, 90 ) );
...
_id_C120()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 >= 3.5 )
            playfx( level._effect["sand_storm_player_semi_opaque"], var_1 + ( 0, 0, 100 ) );
        else
            playfx( level._effect["sand_storm_player_opaque"], var_1 + ( 0, 0, 100 ) );
...
_id_ADA3()
{
    level._id_BD82 moveto( level._id_BD82.origin + ( 100, 0, 0 ), 4.7, 0, 0 );
}
...
_id_B6A6()
{
    ...
    var_3 thread maps\_utility::manual_linkto( self, ( 0, 0, 0 ) );
    var_4 = spawn( "sound_blend", ( 0, 0, 0 ) );
    var_4 thread maps\_utility::manual_linkto( self, ( 0, 0, 64 ) );
