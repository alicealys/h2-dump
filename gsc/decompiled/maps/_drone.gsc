...
drone_get_goal_loc_with_arrival( var_0, var_1 )
{
    ...
    var_3 = getangledelta( level.drone_anims[self.team][var_2]["arrival"], 0, 1 );
    var_3 = length( var_3 );
    var_0 -= var_3;
    return var_0;
}
...
drone_fight( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_3 == 1 )
            self.weaponsound = "h2_wpn_berretta_m9_npc_close";
        else if ( var_3 == 2 )
            self.weaponsound = "h2_wpn_usp_npc_close";
...
getpatharray( var_0, var_1 )
{
    ...
    var_5["vehicle_node"] = maps\_spawner::_id_D0ED;
