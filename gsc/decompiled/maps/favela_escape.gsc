...
_id_D45E()
{
    ...
    if ( var_0 )
    {
        ...
        _func_1E7( 3, 1 );
        objective_position( 3, ( -3154, -1875, 1096 ) );
...
_id_D290( var_0 )
{
    ...
    objective_position( var_0, ( -6370.5, -944, 1044 ) );
}
...
_id_B34C()
{
    ...
    level.player maps\favela_escape_code::_id_B205( ( 4892, 292, 1134 ), ( 0, 180, 0 ) );
...
_id_B032()
{
    ...
    level.player maps\favela_escape_code::_id_B205( ( -3552, -992, 1194 ), ( 0, 180, 0 ) );
