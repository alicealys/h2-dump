...
init_vehicles()
{
    ...
    maps\_utility::add_hint_string( "invulerable_bullets", &"SCRIPT_INVULERABLE_BULLETS", undefined, undefined, "medium_background" );
    common_scripts\utility::create_lock( "aircraft_wash_math" );
    _id_CC1B();
    _id_BDC1();
    _id_ACDB( undefined, "postcrushed", 0 );
}

_id_CC1B()
{
    if ( !isdefined( level._id_BEE4 ) )
        return;

    foreach ( var_1 in level._id_BEE4 )
    {
        foreach ( var_3 in var_1 )
        {
            foreach ( var_8, var_5 in var_3._id_B234 )
            {
                var_6 = loadfx( var_8 );
                var_7 = loadfx( var_5 );

                if ( !isdefined( var_3._id_B2DE ) )
                    var_3._id_B2DE = [];

                var_3._id_B2DE[var_6] = var_7;
            }
        }
    }
}
...
_id_BDC1()
{
    if ( isdefined( level._id_D0DA ) )
    {
        ...
        foreach ( var_2, var_1 in level._id_D0DA )
            level._id_D5AB[loadfx( var_2 )] = 1;
    }
}
...
_id_AFB5()
{
    ...
    level.helicopter_list["mi17_bulletdamage"] = 1;
...
_id_BA0B( var_0 )
{
    ...
    while ( !isdefined( self._id_B120[var_0] ) )
    {
...
_id_B807( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( level.vehicle_death_earthquake ) )
        level.vehicle_death_earthquake = [];
...
_id_B8F2( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( level.vehicle_death_fx ) )
        return;
...
{
    _id_ABA7( level.vtclassname, var_1, var_0 );
}

_id_ABA7( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_2 ) )
    {
        level._id_BFBE[var_3] = undefined;
        return;
    }

    level._id_BFBE[var_3] = _id_CFD4( var_0, var_2 );
}
...
_id_AD9C( var_0 )
{
    if ( !isdefined( var_0 ) )
    {
        self._id_BFBE = undefined;
        return;
    }

    self._id_BFBE = _id_CFD4( self.classname, var_0 );
}

_id_CFD4( var_0, var_1 )
{
    if ( !isdefined( var_1._id_C581 ) )
        var_1._id_C581 = 0;
    ...
    if ( !isdefined( var_1._id_BFE8 ) )
        var_1._id_BFE8 = 0;

    if ( !isdefined( var_1._id_B814 ) )
        var_1._id_B814 = 0;

    if ( !isdefined( var_1._id_A8FA ) )
        var_1._id_A8FA = 0;

    if ( !isdefined( var_1._id_C629 ) )
        var_1._id_C629 = 40;

    if ( !isdefined( var_1._id_C9D1 ) )
        var_1._id_C9D1 = 20;

    if ( !isdefined( var_1._id_D138 ) )
        var_1._id_D138 = 0;

    if ( !isdefined( var_1._id_C77C ) )
        var_1._id_C77C = -1;

    if ( !isdefined( var_1._id_C334 ) )
        var_1._id_C334 = 0;

    if ( !isdefined( var_1._id_D50A ) )
        var_1._id_D50A = 1;

    if ( !isdefined( var_1._id_B291 ) )
        var_1._id_B291 = 0;

    if ( !isdefined( var_1._id_C93C ) )
        var_1._id_C93C = -1;
...
build_turret( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    if ( !isdefined( level.vehicle_mgturret ) )
        level.vehicle_mgturret = [];

    var_10 = level.vtclassname;

    if ( !isdefined( level.vehicle_mgturret[var_10] ) )
        level.vehicle_mgturret[var_10] = [];
    ...
    var_11.tag = var_1;
    var_11.model = var_2;
    var_11.maxrange = var_3;
    var_11.defaultonmode = var_4;
    var_11.deletedelay = var_5;
    var_11.defaultdroppitch = var_6;
    var_11.defaultdropyaw = var_7;

    if ( isdefined( var_8 ) )
        var_11.offset_tag = var_8;

    if ( isdefined( var_9 ) )
        var_11._id_AC60 = var_9;

    level.vehicle_mgturret[var_10][level.vehicle_mgturret[var_10].size] = var_11;
}
...
_id_AEE5( var_0 )
{
    var_1 = _id_C3B9( var_0 );
    return var_1[0];
}

_id_A886( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
        return 0;
...
set_vehicle_effect( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( !isdefined( level._id_BA10 ) )
        level._id_BA10 = [];

    if ( !isdefined( level._id_BFF6 ) )
        level._id_BFF6 = [];
    ...
    if ( isdefined( var_2 ) )
        _id_B23D( var_0, var_1, var_2, var_4 );
    else if ( isdefined( level._vehicle_effect[var_0] ) && isdefined( level._vehicle_effect[var_0][var_1] ) )
    {
        ...
        level._id_BFF6[var_0][var_1] = var_4;
    }
}
...
_id_B23D( var_0, var_1, var_2, var_3 )
{
    level._vehicle_effect[var_0][var_1] = loadfx( var_2 );
    level._id_BA10[var_0][var_1] = var_2;
    level._id_BFF6[var_0][var_1] = var_3;
    var_4 = maps\_treadfx::_id_B702( var_1 );

    for ( var_5 = 0; var_5 < var_4.size; var_5++ )
    {
        level._vehicle_effect[var_0][var_4[var_5]] = loadfx( var_2 );
        level._id_BA10[var_0][var_4[var_5]] = var_2;
        level._id_BFF6[var_0][var_4[var_5]] = var_3;
    }
}
...
_id_C75C( var_0 )
{
    ...
    {
        level._id_A904[var_0][var_4] = loadfx( var_0 );
        var_2 = maps\_treadfx::_id_B702( var_4 );

        foreach ( var_6 in var_2 )
            level._id_A904[var_0][var_6] = loadfx( var_0 );
    }
}
...
_id_BAEA( var_0, var_1 )
{
    ...
    if ( !isdefined( level._id_A904[var_1] ) )
        return;
    ...
    foreach ( var_8 in var_2 )
    {
        ...
        var_5 = level._id_BA10[var_0][var_8];
        var_3 = level._id_A904[var_1][var_8];
        _id_A826( var_0, var_8, var_5, var_4, var_3, var_1 );
        var_6 = maps\_treadfx::_id_B702( var_8 );

        foreach ( var_10 in var_6 )
            _id_A826( var_0, var_10, var_5, var_4, var_3, var_1 );
    }
}

_id_A826( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    level._vehicle_effect[var_0][var_1] = var_4;
    level._id_BA10[var_0][var_1] = var_5;
    level._id_A904[var_2][var_1] = var_3;
}

_id_BECF( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( level._id_BEE4 ) )
        level._id_BEE4 = [];

    if ( !isdefined( level._id_BEE4[var_0] ) )
        level._id_BEE4[var_0] = [];

    if ( !isdefined( level._id_BEE4[var_0][var_1] ) )
        level._id_BEE4[var_0][var_1] = spawnstruct();

    var_4 = level._id_BEE4[var_0][var_1];

    if ( !isdefined( var_4._id_B234 ) )
        var_4._id_B234 = [];

    var_4._id_B234[var_2] = var_3;
}

_id_D176( var_0, var_1 )
{
    if ( isdefined( level._id_BEE4 ) && isdefined( level._id_BEE4[var_0] ) && isdefined( level._id_BEE4[var_0][var_1] ) )
        return level._id_BEE4[var_0][var_1];

    return undefined;
}

_id_A868( var_0, var_1, var_2 )
{
    var_3 = _id_D176( var_0, var_1 );

    if ( isdefined( var_3 ) && isdefined( var_3._id_B2DE ) && var_3._id_B2DE[var_2] )
        return var_3._id_B2DE[var_2];
...
_id_BCB7( var_0, var_1 )
{
    level.vehicle_unloadgroups[var_0] = [[ var_1 ]]();
}
...
_id_ACAC( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = 0;

    level._id_CB19[level.vttype] = var_1;
    level._id_B7A9[level.vttype] = var_0;
}
...
vehicle_to_dummy( var_0, var_1 )
{
    ...
    if ( isdefined( self._id_C4D9 ) )
        self thread [[ self._id_C4D9 ]]( self.modeldummy, var_0 );
...
_id_CA43( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_32.origin += maps\_utility::_id_C32D( var_25, var_29 );
    var_32.origin += maps\_utility::_id_C32D( var_26, var_30 );
    var_32.origin += maps\_utility::_id_C32D( var_27, var_31 );
    var_28 = anglestoforward( var_16 );
    var_29 = vectordot( var_28, var_22 );
    var_30 = vectordot( var_28, var_23 );
    var_31 = vectordot( var_28, var_24 );
    var_33 = maps\_utility::_id_C32D( var_25, var_29 );
    var_33 += maps\_utility::_id_C32D( var_26, var_30 );
    var_33 += maps\_utility::_id_C32D( var_27, var_31 );
    ...
    var_34 = _id_AE7A( level._vehicle_effect["tankcrush"]["window_med_left"], level._vehicle_effect["tankcrush"]["window_med"] );
    var_35 = _id_AE7A( level._vehicle_effect["tankcrush"]["window_med_right"], level._vehicle_effect["tankcrush"]["window_med"] );
    var_36 = _id_AE7A( level._vehicle_effect["tankcrush"]["window_large_back"], level._vehicle_effect["tankcrush"]["window_large"] );
    var_37 = _id_AE7A( level._vehicle_effect["tankcrush"]["window_large_front"], level._vehicle_effect["tankcrush"]["window_large"] );

    if ( _id_CD76( var_3 ) )
    {
        var_0 thread _id_D46F( "tag_window_left_glass_fx", var_34, "veh_glass_break_small", "left_glass_fx", var_3 );
        var_0 thread _id_D46F( "tag_window_right_glass_fx", var_35, "veh_glass_break_small", "right_glass_fx", var_3 );
        var_0 thread _id_D46F( "tag_windshield_back_glass_fx", var_36, "veh_glass_break_large", "back_glass_fx", var_3 );
        var_0 thread _id_D46F( "tag_windshield_front_glass_fx", var_37, "veh_glass_break_large", "front_glass_fx", var_3 );
    }
    else
    {
        var_0 thread _id_BD14( "tag_window_left_glass_fx", var_34, "veh_glass_break_small", 0.2 );
        var_0 thread _id_BD14( "tag_window_right_glass_fx", var_35, "veh_glass_break_small", 0.4 );
        var_0 thread _id_BD14( "tag_windshield_back_glass_fx", var_36, "veh_glass_break_large", 0.7 );
        var_0 thread _id_BD14( "tag_windshield_front_glass_fx", var_37, "veh_glass_break_large", 1.5 );
    }
    ...
    var_12 -= var_13;
    var_12 -= var_14;
    _id_ACDB( var_0, "precrushed", 0 );
    _id_ACDB( var_0, "postcrushed", 1 );
    wait( var_12 );
    ...
    var_32._id_B0A2 = var_44[0];
    var_32._id_B0A2 += maps\_utility::_id_C32D( var_25, var_29 );
    var_32._id_B0A2 += maps\_utility::_id_C32D( var_26, var_30 );
    var_32._id_B0A2 += maps\_utility::_id_C32D( var_27, var_31 );
    var_28 = anglestoforward( var_16 );
    var_29 = vectordot( var_28, var_41 );
    var_30 = vectordot( var_28, var_42 );
    var_31 = vectordot( var_28, var_43 );
    ...
    var_33 += maps\_utility::_id_C32D( var_26, var_30 );
    var_33 += maps\_utility::_id_C32D( var_27, var_31 );
    var_32._id_BFD9 = vectortoangles( var_33 );
    ...
    var_32 moveto( var_32._id_B0A2, var_14, var_14 / 2, var_14 / 2 );
    var_32 rotateto( var_32._id_BFD9, var_14, var_14 / 2, var_14 / 2 );
    wait( var_14 );
...
_id_D46F( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_CB41( var_0, var_1, var_2, var_3 )
{
    thread _id_D4B6( var_0, var_1, var_2, var_3 );
}
...
_id_D4B6( var_0, var_1, var_2, var_3 )
{
    ...
    _id_C36F( var_5, var_1, var_2, var_3 );
}

_id_B128( var_0, var_1, var_2, var_3 )
{
    thread _id_C36F( var_0, var_1, var_2, var_3 );
}

_id_C36F( var_0, var_1, var_2, var_3 )
{
...
_id_B3C5( var_0 )
{
    ...
    var_1 = common_scripts\utility::get_array_of_closest( var_0, level._id_B12B );
    var_2 = [];

    for ( var_3 = 0; var_3 < 3; var_3++ )
        var_2[var_3] = var_1[var_3];

    for ( var_3 = 0; var_3 < level._id_B12B.size; var_3++ )
    {
        foreach ( var_5 in var_2 )
        {
            if ( var_5 == level._id_B12B[var_3] )
                return var_5;
        }
    }
}
...
_id_B400()
{
    ...
    foreach ( var_4 in var_6 )
    {
        ...
        var_4 thread maps\_vehicle_code::manual_tag_linkto( self, "tag_origin" );

        if ( !isdefined( self._id_CC28[var_4.code_classname] ) )
            self._id_CC28[var_4.code_classname] = [];

        self._id_CC28[var_4.code_classname][self._id_CC28[var_4.code_classname].size] = var_4;
    }
}
...
{
    return maps\_vehicle_code::_vehicle_set_random_unload_delays( var_0, var_1 );
}
