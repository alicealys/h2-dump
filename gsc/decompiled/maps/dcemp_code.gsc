...
_id_D38F()
{
    ...
    common_scripts\utility::_id_C203( level._effect["helicopter_crash"], var_1, "tag_deathfx", ( 0, 0, 500 ), ( 90, 0, 0 ) );
...
_id_B109()
{
    ...
    wait 9.65;
    var_0 notify( "stop_heli_spark_effects" );
    playfx( level._effect["helicopter_explosion"], var_0.origin + ( 0, 0, -100 ) );
...
_id_B717()
{
    ...
    objective_onentity( level._id_CD9B, level.foley, ( 0, 0, 70 ) );
...
_id_B77C()
{
    ...
    if ( level.start_point != "corner" && level.start_point != "meetup" )
    {
        ...
        playfx( level._effect["helicopter_explosion"], var_4 + ( 0, 0, -128 ) );
...
_id_BD58()
{
    ...
    if ( level.start_point != "corner" && level.start_point != "meetup" )
    {
        ...
        {
            case "street_crash_left":
                common_scripts\utility::_id_C203( level._effect["helicopter_crash"], var_11, "tag_deathfx", ( 0, 0, 0 ), ( 90, 0, 0 ) );
                break;
            case "street_crash_left2":
            case "street_crash_cop":
                common_scripts\utility::_id_C203( level._effect["helicopter_crash"], var_11, "tag_deathfx", ( 0, 0, 0 ), ( 90, 0, 0 ) );
