...
_id_B32C( var_0 )
{
    ...
    self._id_B7CE linkto( self, "tag_origin", ( 30, 0, 0 ), ( -90, 180, 0 ) );
...
_id_B20D()
{
    ...
    while ( !common_scripts\utility::flag( "exit_caves" ) )
    {
        ...
        if ( level.price _id_CAF0( var_0, var_1 ) )
        {
            ...
            var_2 = level.price.enemy getshootatpos() + ( 0, 0, 150 );
...
_id_CB3A()
{
    ...
    for (;;)
    {
        ...
        {
            playfxontag( level._effect["fx/muzzleflashes/m203_flshview"], level.price, "tag_flash" );
            var_2 = level.price.enemy getshootatpos() + ( 0, 0, 190 );
...
{
    objective_onentity( var_0, var_1, ( 0, 0, 80 ) );
...
_id_C5E2()
{
    ...
    for (;;)
    {
        common_scripts\utility::draw_arrow( self.origin, self.origin + anglestoforward( self.angles ) * 200, ( 0, 0, 1 ) );
        wait 0.05;
    }
}
