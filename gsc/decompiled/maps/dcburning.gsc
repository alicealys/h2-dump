...
_id_C7AB( var_0 )
{
    ...
    while ( !common_scripts\utility::flag( "only_1_javelin_enemies_remaining" ) )
    {
        ...
        if ( common_scripts\utility::within_fov( level.player.origin, level.player.angles, var_0.origin + ( 0, 0, 32 ), level.cosine["90"] ) )
            continue;

        if ( common_scripts\utility::within_fov( level.player.origin, level.player.angles, self.origin + ( 0, 0, 32 ), level.cosine["90"] ) )
            continue;
...
_id_BDE1( var_0 )
{
    ...
    while ( isdefined( self ) )
    {
        ...
        if ( common_scripts\utility::within_fov( var_2, level.player.angles, self.origin + ( 0, 0, 32 ), level.cosine["90"] ) )
            continue;
        else
            break;
    }
...
_id_BF58()
{
    ...
    while ( isalive( self ) && !maps\_utility::ent_flag( "stop_firing" ) )
    {
        ...
        if ( !common_scripts\utility::within_fov( self.origin, self.angles, level.player.origin + ( 0, 0, 32 ), level.cosine["35"] ) )
        {
            self notify( "stop_firing_turret" );
            continue;
        }
...
_id_C768()
{
    ...
    common_scripts\utility::_id_C203( level._effect["heli_hit"], level._id_CED1, "side_door_r_jnt", ( -20, -10, 0 ) );
    level.player playrumblelooponentity( "damage_heavy" );
    ...
    common_scripts\utility::_id_C203( level._effect["heli_hit_2"], level._id_CED1, "side_door_r_jnt", ( -20, -10, 0 ) );
...
{
    var_0 = common_scripts\utility::spawn_tag_origin();
    var_0 linkto( level._id_CED1, "tag_guy5", ( 0, 0, 0 ), ( 0, 0, 0 ) );
...
_id_D1F6()
{
    ...
    objective_onentity( var_0, level._id_AC03, ( 0, 0, 70 ) );
    _func_1E7( var_0, 1 );
...
_id_C995()
{
    ...
    var_1 linkto( level._id_CED1, "tag_player", ( 0, 0, 25 ), ( 0, 0, 0 ) );
...
_id_B640()
{
    _id_C150( "h1_mwr_com_widescreen_monitor_des", "tv_explosion", ( 0, 0, 25 ), 1, 1 );
}

_id_D513()
{
    _id_C150( "h1_mwr_com_widescreen_monitor_2_des", "tv_explosion", ( 0, 0, 30 ), 1 );
}

_id_BE79()
{
    _id_C150( "com_widescreen_monitor_on_1_des", "tv_explosion", ( 0, 0, 25 ), 1, 1 );
}

_id_A9AD()
{
    _id_C150( "com_widescreen_monitor_on_2_des", "tv_explosion", ( 0, 0, 30 ), 1, 1 );
}

_id_C677()
{
    _id_C150( "com_widescreen_monitor_on_3_des", "tv_explosion", ( 0, 0, 28 ), 1, 1 );
}
    ...
    while ( isdefined( self ) )
    {
        ...
        if ( isdefined( var_0 ) && isalive( var_0 ) )
        {
            ...
            if ( isdefined( var_0 ) && isplayer( var_0 ) )
            {
                ...
                var_5 = common_scripts\utility::within_fov( var_4, level._id_CED1.angles + ( 0, -90, 0 ), self.origin, level.cosine["45"] );
...
_id_BAA7()
{
    ...
    switch ( var_0.model )
    {
        case "com_folding_table":
            if ( isdefined( self.script_parameters ) )
                self.eaniment.origin += ( 0, -40, 0 );

            self.eaniment.angles = var_0.angles + ( 0, 0, 0 );
        ...
        case "mil_bunker_bed2":
            maps\_utility::gun_remove();
            self.eaniment.angles = var_0.angles + ( 0, 90, 0 );
            var_4 = spawnstruct();
