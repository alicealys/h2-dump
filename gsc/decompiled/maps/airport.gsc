...
_id_A7F6()
{
    ...
    var_8 common_scripts\utility::delaycall( 2.5, ::rotateto, var_8.angles + ( 0, 90, 0 ), 2, 0.5, 0 );
...
_id_CA05( var_0 )
{
    ...
    common_scripts\utility::_id_C203( level._effect["light_ambulance_airport_blue"], var_1, "tag_body", ( -101.9, 0.4, 63.6 ), ( 0, 0, 0 ) );
...
_id_D3E8()
{
    ...
    objective_onentity( 1, level._id_D41B, ( 0, 0, 80 ) );
}
