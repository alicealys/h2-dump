...
_id_B123()
{
    ...
    var_1 = maps\_utility::get_player_view_controller( level._id_CB62, "tag_guy2", ( 0, 0, -8 ) );
    var_2 = common_scripts\utility::spawn_tag_origin();
    var_2 linkto( level._id_CB62, "tag_origin", ( 0, 0, 0 ), ( 0, 0, 0 ) );
...
_id_CAE1()
{
    ...
    var_0 linkto( level._id_CB62, "tag_guy2", ( 0, 0, -16 ), ( 0, 90, 0 ) );
...
_id_C665()
{
    ...
    var_0 rotateto( var_2.angles, 1, 0.4, 0.4 );
    var_0.angles += ( 0.0001, 0, 0 );
    wait 1;
    var_0 rotateto( level._id_CB62.angles, 1, 0.4, 0.4 );
    wait 1;
    var_0 linkto( level._id_CB62, "tag_origin", ( 0, 0, 0 ), ( 0, 0, 0 ) );
}
...
_id_B3F8()
{
    ...
    if ( maps\_utility::is_default_start() )
    {
        ...
        wait 0.05;
        var_0 = common_scripts\utility::spawn_tag_origin();
        var_0 linkto( level._id_BE03, "tag_origin", ( 0, 0, 250 ), ( 0, 0, 0 ) );
...
_id_CE25()
{
    return common_scripts\utility::getstruct( "false_objective", "script_noteworthy" ).origin + ( 0, 0, 100 );
}
...
_id_BE66()
{
    ...
    var_7 = maps\_utility::get_player_view_controller( var_4, "tag_origin", ( 0, 0, -16 ) );
...
_id_C606( var_0 )
{
    ...
    self.ent.origin = self.origin + var_1 * 500 + ( 0, 0, -500 );
    var_2 = 200;
...
_id_C6E4()
{
    ...
    var_5 common_scripts\utility::delaycall( 0.0, ::moveto, ( 45, 0, 0 ), 0.8, 0.4, 0.4 );
...
_id_BAAE()
{
    ...
    thread maps\_utility::beginsliding( ( 0, 0, -240 ), undefined, undefined, 1, 0, var_4, var_0.script_rumble );
    wait( var_7 );
...
_id_AE04()
{
    ...
    var_0 = common_scripts\utility::_id_B6EF( "tag_origin", ( 2000, 1500, 0 ), ( 0, 0, 0 ) );
...
_id_C206( var_0, var_1 )
{
    ...
    self waittill( "damage" );
    playfx( common_scripts\utility::getfx( "rat_bleed" ), self.origin, ( 0, 0, 1 ) );
