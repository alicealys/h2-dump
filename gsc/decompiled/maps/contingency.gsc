...
{
    wait 15;
    _id_BD26( "obj_sub_base", &"CONTINGENCY_OBJ_SUB_BASE", ( 0, 0, 0 ) );
...
_id_C210()
{
    ...
    thread _id_BDC5( "obj_price", level.price, ( 0, 0, 70 ) );
...
_id_A8B4()
{
    ...
    _id_BD26( "obj_sub", &"CONTINGENCY_OBJ_DEFEND_SUB", var_0 + ( 0, 0, 48 ) );
