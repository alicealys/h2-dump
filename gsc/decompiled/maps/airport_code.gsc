...
_id_BD2D()
{
    ...
    var_2 = 1;
    var_3 = 0.5;
    playfx( common_scripts\utility::getfx( "sign_fx" ), var_0.origin + ( 0, 120, 5 ) );
...
_id_C282()
{
    ...
    thread common_scripts\utility::play_sound_in_space( "scn_airport_elevator_opening_long", level.player.origin + ( 0, 0, 70 ) );
    wait 5.5;
    wait 4.5;
...
_id_CA65()
{
    ...
    while ( !common_scripts\utility::flag( "player_set_speed_stairs" ) )
    {
        ...
        if ( maps\_utility::player_looking_at( self.origin + ( 0, 0, 48 ) ) )
            continue;
...
_id_B794()
{
    ...
    var_0 = ( 0, 0, -1 );
    var_1 = 1;
    level._id_D41B magicgrenademanual( ( 5902, 2208, 96 ), var_0, var_1 );
}
...
_id_C050( var_0 )
{
    ...
    if ( self == level._id_D41B )
    {
        ...
        maps\_utility::add_func( common_scripts\utility::noself_delaycall, 1, ::destroyglass, var_2, ( 0, 0, -1 ) );
        thread maps\_utility::do_wait();
    }
...
_id_A8FE()
{
    ...
    var_0.e["housing"]["mainframe"][0] movegravity( ( 0, 0, 0 ), 1 );
    wait 1;
...
_id_A919()
{
    ...
    var_3 maps\_riotshield::group_lock_angles( anglestoforward( ( 0, 360, 0 ) ) );
...
_id_BF4A()
{
    ...
    var_1 hide();
    common_scripts\utility::_id_C203( common_scripts\utility::getfx( "deathfx_bloodpool_airport_escape" ), var_1, "tag_origin", ( 0, 20, 0 ) );
}
...
_id_BE38()
{
    ...
    switch ( self.state )
    {
        ...
        case "death":
            _id_ADB1();
            var_0 = 300;
            radiusdamage( self.fx.origin + ( 0, 0, -40 ), var_0, 300, 20, self._id_A803 );
...
_id_BD7F()
{
    ...
    self._id_CBDF.angles = self.fx.angles + ( 0, 180, 0 );
...
_id_AEA7( var_0 )
{
    ...
    var_6 = squared( var_2 );
    var_7 = squared( var_3 );
    var_8 = var_0._id_CBDF.origin - ( 0, 0, 76 );
...
_id_BB33()
{
    ...
    level._id_C795 = ( 0, 0, 200 );
    level._id_BB69 = ( 0, 0, -200 );
    level._id_CA48 = 94;
    var_3 = 0;
