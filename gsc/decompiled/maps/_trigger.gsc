...
get_load_trigger_classes()
{
    ...
    var_0["trigger_multiple_visionset_touch"] = ::_id_B92C;
    ...
    var_0["trigger_multiple_shadowmap"] = ::_id_AA42;
    var_0["trigger_multiple_interval"] = ::trigger_multiple_interval;
    var_0["trigger_multiple_fire_react"] = ::_id_CD04;
    return var_0;
}
...
trigger_multiple_fx_watersheeting( var_0 )
{
    ...
    {
        level.aud_fx_watersheeting = spawn( "script_origin", level.player.origin );
        level.aud_fx_watersheeting linkto( level.player );
...
get_load_trigger_funcs()
{
    ...
    var_0["friendly_respawn_clear"] = ::_id_C5E5;
...
init_script_triggers()
{
    ...
    for ( var_11 = 0; var_11 < 7; var_11++ )
    {
        ...
        for ( var_10 = 0; var_10 < var_4.size; var_10++ )
        {
            ...
            if ( isdefined( var_4[var_10]._id_C015 ) )
                var_4[var_10] thread soundscripts\_audio::_id_C74F();
            ...
            if ( isdefined( var_4[var_10].script_parameters ) )
                level thread maps\_colors::_id_AB30( var_4[var_10] );
...
_id_CD04( var_0 )
{
    ...
    level.player._id_B81C = -1 * getdvarint( "fire_react_cooldown" );
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_1 ) && !maps\_utility::player_looking_at( var_1.origin, var_2, var_3 ) )
        {
            while ( !maps\_utility::player_looking_at( var_1.origin, var_2, var_3 ) && var_5 istouching( var_0 ) )
                waitframe();
        ...
        var_6 = getdvarint( "fire_react_cooldown" ) + level.player._id_B81C - gettime();

        if ( var_6 < 0 )
        {
            level.player._id_B81C = gettime();
            var_5 _meth_85A0();

            while ( var_5 istouching( var_0 ) && ( !isdefined( var_1 ) || maps\_utility::player_looking_at( var_1.origin, var_2, var_3 ) ) && level.player _meth_85BE() )
                waitframe();
...
trigger_flag_set( var_0 )
{
    ...
    for (;;)
    {
        var_0 waittill( "trigger", var_2 );
        var_0 maps\_utility::script_delay();
        common_scripts\utility::_id_C746( var_1, var_2, var_0 );
    }
}
...
trigger_friendly_respawn( var_0 )
{
    ...
    {
        var_0 waittill( "trigger" );
        maps\_colors::colornode_set_respawn_point( var_2, "allies" );
...
trigger_vehicle_getin_spawn( var_0 )
{
    ...
    var_0 waittill( "trigger" );
    var_1 = getentarray( var_0.target, "targetname" );
    common_scripts\utility::array_thread( var_1, maps\_utility::add_spawn_function, maps\_vehicle_code::_id_CAE5 );
...
trigger_vehicle_spline_spawn( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        var_3 thread maps\_vehicle_code::_id_D0C3( 70 );
        wait 0.05;
    }
}
...
trigger_multiple_visionset( var_0, var_1 )
{
    ...
    if ( !isdefined( level._id_BF83 ) )
        level._id_BF83 = level.script;

    if ( !isdefined( level._id_C8E0 ) )
        level._id_C8E0 = level.script;

    if ( !isdefined( level._id_AEDA ) )
        level._id_AEDA = level.script;
            ...
            if ( var_7 istouching( var_0 ) )
            {
                if ( !var_2 )
                {
                    ...
                    if ( var_3 )
                    {
                        ...
                        {
                            var_9 = maps\_utility::get_progress( var_5, var_6, var_7.origin, var_4 );
                            var_9 = clamp( var_9, 0, 1 );

                            if ( var_9 != var_8 )
                            {
                                var_8 = var_9;
                                var_7 vision_set_fog_progress( var_0, var_9 );
                            }
                        ...
                        var_7 maps\_utility::vision_set_fog_changes( var_0.script_visionset, var_0.script_delay );

                    if ( isdefined( var_0.script_lightset ) )
                        var_7 maps\_utility::_id_BF21( var_0.script_lightset );

                    if ( isdefined( var_0.script_clut ) )
                        var_7 _meth_849F( var_0.script_clut, var_0.script_delay );

                    if ( isdefined( var_0._id_D23D ) )
                        maps\_utility::_id_C0C2( var_0._id_D23D, 1 );
                    else
                        maps\_utility::_id_C0C2( undefined, 1 );
                }
            }
            else
            {
                if ( var_2 )
                {
                    ...
                    {
                        if ( var_3 && _id_C721( var_7, var_0, "visionset" ) )
                        {
                            if ( var_8 < 0.5 )
                                var_7 maps\_utility::vision_set_fog_changes( var_0.script_visionset_start, var_0.script_delay );
                            else
                                var_7 maps\_utility::vision_set_fog_changes( var_0.script_visionset_end, var_0.script_delay );
                        }
                        else if ( isdefined( var_0.script_visionset ) && _id_C721( var_7, var_0, "visionset" ) )
                            var_7 maps\_utility::vision_set_fog_changes( level._id_BF83, var_0.script_delay );

                        if ( isdefined( var_0.script_lightset ) && _id_C721( var_7, var_0, "lightset" ) )
                            var_7 maps\_utility::_id_BF21( level._id_C8E0 );

                        if ( isdefined( var_0.script_clut ) && _id_C721( var_0, "clut" ) )
                            var_7 _meth_849F( level._id_AEDA, var_0.script_delay );
...
_id_C885()
{
    if ( !isdefined( level._id_B1BC ) )
        level._id_B1BC = 0;

    level._id_B1BC++;
    return level._id_B1BC;
}
...
_id_D44E( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        if ( isdefined( var_3._id_C64D ) && var_3._id_C64D == var_0 )
            return var_3;
    }
...
_id_C721( var_0, var_1, var_2 )
{
    var_3 = _id_D44E( var_0._id_D53C );
    ...
    if ( var_2 == "visionset" )
        return !isdefined( var_3.script_visionset );
    else if ( var_2 == "lightset" )
        return !isdefined( var_3.script_lightset );
    else if ( var_2 == "clut" )
        return !isdefined( var_3.script_clut );
...
init_visionset_progress_trigger()
{
    ...
    if ( isdefined( var_0.atmosfogenabled ) && isdefined( var_1.atmosfogenabled ) )
    {
        ...
        var_2._id_BE60 = var_1._id_BE60 - var_0._id_BE60;
        var_2._id_CFD8 = var_1._id_CFD8 - var_0._id_CFD8;
        var_2._id_C92F = var_1._id_C92F - var_0._id_C92F;
        var_2._id_BB60 = var_1._id_BB60 - var_0._id_BB60;
...
vision_set_fog_progress( var_0, var_1 )
{
    ...
    if ( isdefined( level.vision_cheat_enabled ) && !level.vision_cheat_enabled )
    ...
    if ( isdefined( var_4.atmosfogenabled ) )
    {
        ...
        var_5._id_BE60 = var_2._id_BE60 + var_4._id_BE60 * var_1;
        var_5._id_CFD8 = var_2._id_CFD8 + var_4._id_CFD8 * var_1;
        var_5._id_C92F = var_2._id_C92F + var_4._id_C92F * var_1;
        var_5._id_BB60 = var_2._id_BB60 + var_4._id_BB60 * var_1;
...
trigger_fog( var_0 )
{
    ...
    if ( isdefined( var_1.target ) )
    {
        ...
        var_3 = var_2 + common_scripts\utility::_id_B1AF( var_0.origin - var_2, 2 );
    ...
    for (;;)
    {
        ...
        while ( var_6 istouching( var_0 ) )
        {
            var_7 = maps\_utility::get_progress( var_2, var_3, var_6.origin, var_5 );
...
_id_C254( var_0 )
{
    ...
    if ( isdefined( var_1 ) && isdefined( var_2 ) )
    {
        ...
        if ( !isdefined( var_4.skyfogintensity ) )
        {
            var_4.skyfogintensity = 0;
            var_4.skyfogminangle = 0;
            var_4.skyfogmaxangle = 0;
        }

        common_scripts\utility::convertlegacyfog( var_4 );
...
slidetriggerplayerthink( var_0 )
{
    ...
    if ( isdefined( var_0.script_noteworthy ) )
    {
        var_3 = getent( var_0.script_noteworthy, "targetname" );
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            {
                foreach ( var_6 in strtok( var_3.script_noteworthy, "," ) )
                {
                    var_7 = strtok( var_6, "=" );
                    ...
                    if ( var_7.size > 1 )
                    {
                        if ( var_7[0] == "maxangle" )
                        {
                            var_4._id_BBFF = int( var_7[1] );
                            continue;
                        }

                        if ( var_7[0] == "maxdist" )
                        {
                            var_4.maxdist = int( var_7[1] );
                            continue;
                        }
                        ...
                        if ( var_7[0] == "avoid_ally_name" )
                        {
                            ...
                            {
                                if ( isdefined( var_11.script_friendname ) && var_8 == var_11.script_friendname )
                                {
                                    level._id_CF11 = var_11;
                                    break;
                                }
                            }
                        }
            ...
            var_14 = level.player.angles[1];

            if ( var_3.angles[1] - var_14 > 180 )
                var_14 += 360;

            var_2 = abs( var_3.angles[1] - var_14 ) > var_4._id_BBFF || distance( var_3.origin, level.player.origin ) > var_4.maxdist;
        }
    }
    ...
    if ( isdefined( var_0.script_accel ) )
        var_15 = var_0.script_accel;

    self endon( "cancel_sliding" );
    maps\_utility::beginsliding( undefined, var_15, undefined, var_1, var_2, undefined, var_0.script_rumble );
    ...
    for (;;)
    {
        ...
        if ( !self.slidemodel istouching( var_0 ) )
            break;
    }
    ...
    maps\_utility::endsliding( var_1, var_2, undefined, undefined, var_0.script_rumble );
}
...
_id_AA42( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        {
            var_3.lights = getentarray( var_3.target, "targetname" );

            foreach ( var_5 in var_3.lights )
                var_5.intensity = var_5 getlightintensity();
        }
    }
    ...
    for (;;)
    {
        if ( isdefined( var_0.spawnflags ) && var_0.spawnflags == 1 )
        {
            ...
            var_0 _id_D3B0( var_1 );
            continue;
        }

        var_0 waittill( "trigger", var_8 );
        var_8 _id_ABF1( var_0, var_1 );
    }
}
...
_id_AD1C( var_0 )
{
    ...
    {
        if ( isdefined( var_2._id_AAA1 ) )
            common_scripts\utility::array_call( var_2.lights, ::setlightintensity, var_2._id_AAA1 );

        if ( isdefined( var_2._id_B49B ) )
            common_scripts\utility::array_call( var_2.lights, ::_meth_84A7, var_2._id_B49B );
    }
}
...
_id_D4E9( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        if ( isdefined( var_2._id_D345 ) )
            common_scripts\utility::array_call( var_2.lights, ::_meth_84A7, var_2._id_D345 );

        foreach ( var_4 in var_2.lights )
            var_4 setlightintensity( var_4.intensity );
    }
}
