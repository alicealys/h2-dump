...
_id_B0C4()
{
    ...
    level._id_CE77 = spawn( "script_model", ( 0, 0, 0 ) );
...
_id_BC94( var_0 )
{
    ...
    if ( level.script == "dcburning" )
        maps\_utility::delaythread( 2.3, common_scripts\utility::play_sound_in_space, "scn_dcemp_space_transition_in", level.player.origin + ( 0, 0, 100 ), 1 );
    else
        thread common_scripts\utility::play_sound_in_space( "scn_dcemp_space_transition_in", level.player.origin + ( 0, 0, 100 ), 1 );
}
...
_id_ABAD()
{
    ...
    level.scr_model["player_rig"] = "viewbody_us_army_injured";
...
{
    var_0 = [];
    var_1 = common_scripts\utility::_id_B6EF( "tag_light_fx_01", ( -25, 0, 0 ), ( -90, 0, -90 ) );
    var_2 = common_scripts\utility::_id_B6EF( "tag_light_fx_02", ( -25, 0, 0 ), ( -90, 0, -90 ) );
    var_3 = common_scripts\utility::_id_B6EF( "tag_light_fx_03", ( -25, 0, 0 ), ( 0, -90, 0 ) );
