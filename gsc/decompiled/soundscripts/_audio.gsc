...
audx_play_line_emitter_internal()
{
    ...
    for (;;)
    {
        ...
        if ( !self.is_playing )
        {
            ...
            self setvolume( 0 );
            wait 0.05;
            self setvolume( 1.0, self.fade_in );
            self.is_playing = 1;
        }
        else
...
aud_fade_out_and_delete( var_0, var_1 )
{
    ...
    var_0 common_scripts\utility::delaycall( var_1 + 0.05, ::playrumbleonentity );
...
deprecated_aud_fade_sound_in( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_0 setvolume( 0.0 );
    var_0 common_scripts\utility::delaycall( 0.05, ::setvolume, var_2, var_3 );
}
