...
snd_load_filter_presets()
{
    ...
    level._snd.filters.presets = soundscripts\_snd::snd_parse_soundtables( "Filter", var_0, 7, "filter_names", "zone_names;reverb_names;filter_names;occlusion_names;timescale_names;dynamic_ambience_names;components;loop_defs;whizby_preset_names;mix_names;healthfx_params" );
}
...
snd_set_filter_threaded( var_0, var_1 )
{
    ...
    {
        level.player seteq( var_13.dsp_bus, var_13.index, var_13.type, var_13.gain, var_13.vol, var_13.freq, var_13.q );
...
snd_load_occlusion_presets()
{
    ...
    var_0[var_0.size] = "soundtables/sp_defaults.csv";
    var_0[var_0.size] = "soundtables/" + level.script + ".csv";
    level._snd.occlusion.presets = soundscripts\_snd::snd_parse_soundtables( "Filter", var_0, 7, "occlusion_names", "zone_names;reverb_names;filter_names;occlusion_names;timescale_names;dynamic_ambience_names;components;loop_defs;whizby_preset_names;mix_names;healthfx_params" );
}
