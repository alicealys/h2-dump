...
azm_start_zone( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_4["mix"] != "none" )
            soundscripts\_audio_mix_manager::mm_start_zone_preset( var_4["mix"], var_4["context"] );
        else
            soundscripts\_audio_mix_manager::mm_clear_zone_mix( undefined, var_4["context"], 1.0 );
    }
...
azm_stop_zone( var_0, var_1, var_2 )
{
    if ( isdefined( level._audio.zone_mgr.zones[var_0] ) && isdefined( level._audio.zone_mgr.zones[var_0]["state"] ) && level._audio.zone_mgr.zones[var_0]["state"] != "stopping" )
    {
        ...
        if ( isdefined( var_4["mix"] ) && !azm_get_mix_bypass() )
            soundscripts\_audio_mix_manager::mm_clear_zone_mix( var_4["mix"], var_4["context"], var_3 );
...
azmx_restart_damb( var_0, var_1 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        soundscripts\_audio_dynamic_ambi::dambx_stop_preset( "zone", undefined, var_2 );
        soundscripts\_audio_dynamic_ambi::damb_zone_start_preset( var_3 );
    }
    else
...
azmx_restart_mix( var_0, var_1 )
{
    ...
    var_3 = level._audio.zone_mgr.zones[var_0]["context"];

    if ( !azm_get_mix_bypass() )
    {
        if ( isdefined( var_2 ) )
            soundscripts\_audio_mix_manager::mm_start_zone_preset( var_2, var_3 );
        else
            soundscripts\_audio_mix_manager::mm_clear_zone_mix( undefined, var_3, var_1 );
    }
}
...
azmx_get_blend_args( var_0, var_1 )
{
    ...
    var_2._id_D14D = undefined;
    var_2._id_B26E = undefined;
    ...
    var_2._id_D14D = var_4["context"];
    var_2._id_B26E = var_5["context"];
...
azmx_blend_zones( var_0, var_1, var_2 )
{
    ...
    if ( azmx_is_valid_mix_blend_request( var_2.mix1, var_2.mix2 ) && !azm_get_mix_bypass() )
        soundscripts\_audio_mix_manager::mm_blend_zone_mix( var_2.mix1, var_0, var_2.mix2, var_1, var_2._id_D14D, var_2._id_B26E );
    ...
    if ( var_0 >= 0.75 )
    {
        ...
        if ( isdefined( var_2._id_B26E ) )
            soundscripts\_snd_common::snd_disable_soundcontextoverride( var_2._id_B26E );

        if ( isdefined( var_2._id_D14D ) )
            soundscripts\_snd_common::snd_enable_soundcontextoverride( var_2._id_D14D );
    }
    else if ( var_1 >= 0.75 )
    {
        ...
        if ( isdefined( var_2._id_D14D ) )
            soundscripts\_snd_common::snd_disable_soundcontextoverride( var_2._id_D14D );

        if ( isdefined( var_2._id_B26E ) )
            soundscripts\_snd_common::snd_enable_soundcontextoverride( var_2._id_B26E );
    }
}
