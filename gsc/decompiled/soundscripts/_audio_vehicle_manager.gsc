...
avm_init()
{
    ...
    avm_register_callback( "steering", ::_id_AF36 );
}
...
avmx_map_io( var_0, var_1 )
{
    ...
    foreach ( var_12 in var_4.param_maps )
    {
        ...
        foreach ( var_23, var_20 in var_12.envs )
        {
            ...
            var_22 = _func_255( var_18, var_21.env_array );
...
{
    var_0 = avmx_get_vehicle_entity();
    var_1 = var_0.turret _meth_8487();
    var_1 = abs( var_1 );
    var_2 = var_0.turret _meth_8488();
    var_2 = abs( var_2 );
...
avmx_are_all_defined( var_0 )
{
    ...
    foreach ( var_3 in var_0 )
    {
        if ( isdefined( var_3 ) && !isdefined( var_3.is_stopping ) )
        {
            var_1 = 1;
            break;
        }
...
avmx_map_input( var_0, var_1 )
{
    ...
    if ( isdefined( var_3.env_function ) )
        ...
        var_4 = _func_255( var_0, var_3.env_array );
