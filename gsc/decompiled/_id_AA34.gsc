...
_id_D035()
{
    soundscripts\_snd::snd_message( "snd_register_vehicle", "mi28", ::_id_B4E4 );
}
...
_id_B4E4()
{
    ...
    soundscripts\_audio_vehicle_manager::avm_begin_behavior_def( "to_state_hover", ::_id_BB20, [ "speed", "distance2d" ] );
    soundscripts\_audio_vehicle_manager::avm_add_loops( "ALL" );
    soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
    soundscripts\_audio_vehicle_manager::avm_begin_behavior_def( "to_state_fly", ::_id_C3AB, [ "speed", "distance2d" ] );
    soundscripts\_audio_vehicle_manager::avm_add_loops( "ALL" );
    soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
    soundscripts\_audio_vehicle_manager::avm_begin_behavior_def( "to_state_fly_from_hover", ::_id_C3AB, [ "speed", "distance2d" ] );
    soundscripts\_audio_vehicle_manager::avm_add_loops( "ALL" );
    soundscripts\_audio_vehicle_manager::avm_add_oneshots( "h1r_havoc_start_rev" );
    soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
    soundscripts\_audio_vehicle_manager::avm_begin_behavior_def( "to_state_distant", ::_id_A862, [ "distance2d" ] );
    soundscripts\_audio_vehicle_manager::avm_add_loops( "havoc_engine_dist_loop" );
    soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
    soundscripts\_audio_vehicle_manager::avm_begin_behavior_def( "to_state_flyby", ::_id_C64B, [ "speed", "distance2d" ] );
    soundscripts\_audio_vehicle_manager::avm_add_loops( "ALL" );
...
_id_C64B( var_0, var_1 )
{
    ...
    else
    {
        ...
        {
            var_7 = soundscripts\_audio_vehicle_manager::avmx_get_vehicle_entity();

            if ( playerisinfront( var_7 ) )
                var_2 = 1;
        }
