...
_ID44786()
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            var_0.origin = _ID42237::_ID12140( var_0.origin ) + ( 0, 0, 1 );
        }
...
_ID43250()
{
    ...
    for (;;)
    {
        var_0 = distance( level._ID28543.origin, level.player.origin ) < 256;
...
_ID47362()
{
    ...
    for (;;)
    {
        ...
        var_0 = distance( level.player._ID40065.origin, self.origin );
...
_ID45667()
{
    ...
    for ( var_2 = 0; var_2 < var_1; var_2++ )
    {
        ...
        var_3 = anglestoforward( level.player._ID40065.angles );
        var_4 = level.player._ID40065.origin + var_3 * 55;
        var_4 = ( var_4[0], var_4[1], level.player._ID40065.origin[2] );
...
_ID53661()
{
    for (;;)
    {
        ...
        {
            var_1 = _ID42237::_ID15566( level._ID51355.origin, level._ID50466 );
...
_ID43489()
{
    ...
    for (;;)
    {
        var_3 = _ID50343::_ID15937( self.origin, var_1.origin, var_2.origin );
        var_4 = var_3["progress"];
        self._ID28675 = var_4;
        var_5 = var_4 - level._ID49036;
        self._ID28677 = var_5;
...
_ID43876()
{
    ...
    var_5 = var_0 * var_4;
    level._ID49524.origin = level.player.origin + var_5;
    var_1.origin = level._ID49524.origin;
    var_1 linkto( level.player );
    var_6 = 5;

    for (;;)
    {
        level._ID49524.origin = _ID49120( var_1.origin, 0 );

        if ( _ID42407::_ID41803( self.origin, self.angles, level._ID49524.origin, 0.9 ) )
            break;
    ...
    for ( var_10 = 0; var_10 < var_9; var_10++ )
    {
        ...
        level._ID49524.origin = _ID49120( var_12, 0 );
...
_ID52212()
{
    ...
    level._ID49524 = spawn( "script_origin", level.player.origin );
...
{
    var_0 = _ID42411::_ID46021( self.origin );
    var_1 = _ID50343::_ID15937( self.origin, var_0._ID23570, var_0._ID24768._ID23570 );
...
_ID43227( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_2 = _ID42407::_ID32530( self.origin, 0 );
...
_ID54567()
{
    ...
    for (;;)
    {
        var_0 = _ID49996( self.origin, level.player.origin );
...
_ID53849()
{
    ...
    for (;;)
    {
        ...
        var_2 = _ID42407::_ID32530( var_2, level._ID48727.origin[2] );
...
_ID45235( var_0, var_1 )
{
    ...
    var_3 = distance( var_2.origin, level._ID48727.origin );
    ...
    var_6 = vectortoangles( var_5.origin - level._ID48727.origin );
    var_7 = anglestoforward( var_6 );
    var_8 = level._ID48727.origin + var_7 * var_3;
...
_ID43916()
{
    for (;;)
    {
        ...
        level.player._ID811 = self.script_noteworthy;
...
_ID49185()
{
    ...
    for (;;)
    {
        ...
        if ( var_0.size )
        {
            var_1 = _ID42237::_ID16182( self.origin, var_0, 8000 );
...
_ID44110()
{
    ...
    if ( _ID42407::_ID27540( self.origin ) )
        return;
...
_ID45161()
{
    for (;;)
    {
        ...
        {
            level.player._ID40065 vehicle_setspeed( 0, 5, 35 );

            if ( level.player._ID40065 vehicle_getspeed() < 5 )
                break;
        }
    ...
    level.player _ID42407::_ID27348();
    level.player._ID40065 vehicle_setspeed( 0, 5, 25 );
}
...
_ID49356()
{
    ...
    level._ID53655 setvehgoalpos( var_1.origin, 1 );
}
...
_ID44520()
{
    for (;;)
    {
        ...
        if ( var_0 == level.player._ID40065 )
            continue;
...
_ID47537()
{
    for (;;)
    {
        ...
        {
            var_1 = vectornormalize( _ID42407::_ID32530( level._ID49803.origin - level.player._ID40065.origin, 0 ) );
            var_2 = anglestoforward( level.player._ID40065.angles );
            ...
            level.player._ID40065 _meth_85c0( 1 );
            waittillframeend;
        }

        level.player._ID40065 _meth_85c0( 0 );
    ...
    var_4 delete();
    var_5 = level.player._ID40065;
    var_6 = level._ID28543._ID40065;
    var_7 = level._ID30895["snowmobile_player"]["cliffhanger_ending"];
    var_8 = getstartorigin( level._ID49803.origin, level._ID49803.angles, var_7 );
    var_9 = getstartangles( level._ID49803.origin, level._ID49803.angles, var_7 );
    ...
    level.player _ID42407::_ID13024( "finish_line" );
    level.player _ID42407::_ID13025( "finish_line" );
...
_ID47000( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            level.player _ID42407::_ID32411( 0 );
            var_3 = var_9;
            wait 0.5;
        }
        else
        {
            ...
            if ( var_10 && var_11 )
                level.player _ID42407::_ID32411( 0.1 );
            else
                level.player _ID42298::_ID29791();
        }
...
_ID46844()
{
    ...
    wait 0.25;
    playfx( level._ID1426["tree_trunk_explosion"], var_0.origin );
    thread _ID42237::_ID27077( "tree_collapse_explosion", var_0.origin );
...
_ID54066()
{
    ...
    level.player thread _ID42407::_ID27079( "mus_cliffhanger_snowmobile_landed" );
}
