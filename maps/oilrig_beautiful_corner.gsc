...
_ID50786()
{
    ...
    var_0 _meth_805A();
    var_1 = _func_0C9( "playerStartDeck1", "targetname" );
    level._ID794 _meth_8343( var_1[0]._ID740 );
    level._ID794 _meth_8345( var_1[0]._ID65 );
