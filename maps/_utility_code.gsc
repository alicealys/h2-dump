...
hintprint( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    var_10 = gettime();
    ...
    maps\_hud_util::add_hint_background( var_8, var_7, 0.5, var_9 );
    var_16 = maps\_hud_util::createclientfontstring( "timer", var_15 );
    level.current_hint = var_16;
    level.hint_breakfunc = var_1;
    thread destroy_hint_on_friendlyfire( var_16 );
    level endon( "friendlyfire_mission_fail" );
    var_16.color = ( 1.0, 1.0, 1.0 );
    var_16.alpha = 0;
    var_16 maps\_hud_util::setpoint( "TOP", undefined, 0, 127 + var_11 );
    var_16.foreground = 0;
    ...
    if ( isdefined( var_5 ) )
        var_18 thread hint_timeout( var_5 );

    if ( isdefined( level.hint_breakfunc ) )
    {
        for (;;)
        {
            hintprintwait( var_13, level.hint_breakfunc );
    ...
    maps\_utility::wait_for_buffer_time_to_pass( var_10, var_6 );
    var_16 notify( "destroying" );
    self.current_global_hint = undefined;
    var_16 fadeovertime( var_12 );
    var_16.alpha = 0;
    var_16 maps\_hud_util::_id_A889( var_12 );
    wait(var_12);
    var_16 maps\_hud_util::_id_C22D();
    var_16 maps\_hud_util::destroyelem();
...
_id_D18D( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_10 = var_0 maps\_utility::_id_AF14( var_8, var_9, var_2, var_3, var_4, var_5, var_6, var_7 );
...
function_stack_proc( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( var_0 ) && isdefined( var_0.function_stack ) )
    {
        ...
        if ( isdefined( var_0 ) && isdefined( var_0.function_stack ) )
        {
            var_0.function_stack = common_scripts\utility::_id_AC53( var_0.function_stack, self );
...
unflash_flag( var_0 )
{
    ...
    wait(var_0);
    thread soundscripts\_audio::_id_B146();
...
get_color_info_from_trigger()
{
    ...
    if ( var_0 == "allies" )
    {
        var_2 = maps\_colors::_id_AC4A( self.script_color_allies, "allies" );
        var_1 = var_2["colorCodes"];
    }
    else
    {
        var_2 = maps\_colors::_id_AC4A( self.script_color_axis, "axis" );
        var_1 = var_2["colorCodes"];
    }
...
doslide( var_0, var_1, var_2, var_3, var_4 )
{
    self endon( "death" );
    ...
    for (;;)
    {
        ...
        {
            var_9 = var_0.origin;
            var_17 = common_scripts\utility::ter_op( var_14[1] < 0, var_14[1] * -1, 0 );
            var_18 = common_scripts\utility::ter_op( var_14[1] > 0, var_14[1], 0 );

            if ( var_0 getanimweight( level.scr_anim["worldbody"]["slide_loop"][0] ) != 0 )
            {
                var_0 setanimlimited( level.scr_anim["worldbody"]["slide_al"], var_17 );
                var_0 setanimlimited( level.scr_anim["worldbody"]["slide_ar"], var_18 );
            }
        }

        if ( isdefined( level._id_CF11 ) )
        {
            var_19 = level._id_CF11.origin - var_5.origin;
            ...
            if ( var_13 > 0 )
            {
                ...
                var_14 = common_scripts\utility::ter_op( var_22 > 0, ( var_14[0], 1, 0 ), ( var_14[0], -1, 0 ) );
                var_13--;
            }
        }

        var_14 = ( var_14[1] * var_16[0], var_14[1] * var_16[1], 0 );
        var_0.slidevelocity += var_14 * var_1;
        wait 0.05;
        ...
        if ( var_3 )
        {
            ...
            else
            {
                ...
                var_23 = var_29 * var_29 * var_7 * common_scripts\utility::sign( var_27 );
            }

            var_30 = 1;
            var_31 = var_23 - var_10;
            var_32 = min( abs( var_31 ), var_30 ) * common_scripts\utility::sign( var_31 );
            var_10 += var_32;
            var_0.angles += ( 0, var_10, 0 );
        }
    }
}
...
_id_ACF0( var_0 )
{
    self endon( "stop_sliding" );
    self waittill( "death" );
    var_0.slidevelocity = ( 0.0, 0.0, 0.0 );
    var_0 stopmoveslide();
    var_0 hide();
