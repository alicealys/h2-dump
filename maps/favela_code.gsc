...
_ID49949()
{
    ...
    var_2 = _ID42237::_ID16182( self.origin, var_0, 100 );
    var_2._ID3189 = "window";
    var_2 _ID42407::_ID3428( "window" );
    var_3 = _ID42237::_ID16182( self.origin, var_1, 100 );
...
_ID49904()
{
    ...
    var_1 = _ID42407::_ID15611( self.origin, var_0 );
    return var_0[var_1];
}
...
_ID53504()
{
    ...
    var_1 = _ID42407::_ID15611( self.origin + ( 0, 0, 48 ), var_0 );
    var_2 = var_0[var_1];
...
_ID25890( var_0, var_1, var_2 )
{
    ...
    thread _ID42237::_ID27077( "scn_favela_npc_open_shutters", var_0.origin );
...
_ID44571()
{
    ...
    thread _ID42237::_ID27077( self.script_noteworthy, var_0.origin );
}
...
_ID39052()
{
    ...
    if ( !isdefined( self.prevnode._ID31067 ) )
        return 0;
...
_ID53195()
{
    var_0 = distance( self.origin, self._ID21851.origin );
    var_1 = distance( level.player.origin, self._ID21851.origin );
    var_2 = var_0 - var_1;
    var_3 = 1.0;
    var_4 = 1.5;
    var_5 = -450;
...
_ID51022()
{
    ...
    var_1 *= 2000;
    var_0 physicslaunchclient( var_0.origin + ( 0, 0, 0 ), var_1 );
}
...
_ID5237( var_0 )
{
    ...
    var_4.origin = var_4.origin + ( -12, 0, -30 );
...
_ID46377()
{
    ...
    for (;;)
    {
        ...
        var_3 = _ID42237::_ID41802( self.origin, self.angles, level.player.origin, var_1 );
...
_ID49528( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_3 = level.player _ID42237::_ID41075( "weapon_fired", "grenade_fire" );
        ...
        foreach ( var_8 in var_0 )
        {
            if ( isalive( var_8 ) )
            {
                ...
                var_9 = _ID42237::_ID41802( level.player.origin, level.player.angles, var_8.origin, cos( 12 ) );
...
_ID50245()
{
    ...
    if ( isdefined( self.script_noteworthy ) )
    {
        ...
        if ( isalive( var_1 ) )
        {
            ...
            var_0 thread _ID47200( var_1, var_2.script_noteworthy );
            var_0 thread _ID42259::_ID3111( var_1, var_2.script_noteworthy );
            _ID47388( var_1 );
        }
    }
}
...
_ID46768( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_1._ID24762.owner ) )
        {
            var_1.owner = self;
            return var_1;
        }
...
_ID43962()
{
    ...
    thread _ID42237::_ID27077( var_4, self.origin );
    return 1;
}
...
_ID49910( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        wait 0.05;
        self._ID11119 = distance( self.origin, level.player.origin );
        _ID43242( var_0, var_1 );
    }
}
...
_ID51259( var_0 )
{
    ...
    _ID48105( level.player._ID15303, var_0 );
...
_ID43730()
{
    ...
    if ( !_ID42237::_ID14385( "player_is_ducking" ) )
    {
        ...
        var_2 = !level.player _ID42237::_ID20583();
        _ID42407::_ID48474( &"FAVELA_DUCK_HINT", &"FAVELA_DUCK_HINT_KEYBOARD", var_0, var_2, var_1 );

        if ( level.player _ID42237::_ID20583() )
            level.player._ID45565 thread _ID42237::_ID47857( level.player, &"FAVELA_DUCK_HINT", &"FAVELA_DUCK_HINT_KEYBOARD", "player_is_ducking" );
        else
            level.player._ID45565 thread _ID42237::_ID47857( level.player, &"FAVELA_DUCK_HINT_KEYBOARD", &"FAVELA_DUCK_HINT", "player_is_ducking" );

        if ( !level.player _ID42237::_ID20583() || _ID42407::_ID50524( var_1 ) )
        {
            level thread _ID42407::_ID48494( "player_is_ducking" );
            level.player thread _ID42407::_ID48494( "shot_next_frame", "death" );
            _ID42407::_ID43686();
        }
        else
        {
            level thread _ID42407::_ID47734( "player_is_ducking" );
            level.player thread _ID42407::_ID52184( "shot_next_frame", "death" );
            _ID42407::_ID46429();
        }
    }
}
...
window_guy_watcher( var_0, var_1, var_2 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( !_ID42237::_ID14385( "shutter_closed" ) )
            var_5 _ID42259::_ID3018( var_5, "h2_civilian_close_shutter_" + getsubstr( var_5.model, 23, 24 ) );
    }
}
