...
setpointbar( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( self.bar._id_C891 ) )
        var_4 = self.bar._id_C891;

    if ( isdefined( self.bar._id_C3D6 ) )
        var_5 = self.bar._id_C3D6;

    self.bar.horzalign = self.horzalign;
    self.bar.vertalign = self.vertalign;
    self.bar.alignx = "left";
    self.bar.aligny = self.aligny;
    self.bar.y = var_5 + self.y;

    if ( self.alignx == "left" )
        self.bar.x = var_4 + self.x + self.xpadding;
    else if ( self.alignx == "right" )
        self.bar.x = var_4 + self.x - ( self.width - self.xpadding );
    else
        self.bar.x = var_4 + self.x - int( ( self.width - self.xpadding * 2 ) / 2 );

    if ( isdefined( self._id_BBA3 ) )
    {
        self._id_BBA3.x = self.x;
        self._id_BBA3.y = self.y;
        self._id_BBA3.horzalign = self.horzalign;
        self._id_BBA3.vertalign = self.vertalign;
        self._id_BBA3.alignx = self.alignx;
        self._id_BBA3.aligny = self.aligny;
    }
...
_id_ABED( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = newhudelem();
    var_7.alignx = "center";
    var_7.aligny = "bottom";
...
add_hint_background( var_0, var_1, var_2, var_3 )
{
    _id_C22D();
    ...
    if ( isdefined( var_0 ) )
    {
        var_6 = 121;
        var_7 = 38;
        level.hintbackground = createicon( "h1_hud_tutorial_blur", var_4, 39 );
        level._id_B160 = createicon( "h1_hud_tutorial_border", var_4, 1 );
        level._id_CE5E = createicon( "h1_hud_tutorial_border", var_4, 1 );
    }
    else
    {
        var_6 = 121;
        var_7 = 24;
        level.hintbackground = createicon( "h1_hud_tutorial_blur", var_4, 25 );
        level._id_B160 = createicon( "h1_hud_tutorial_border", var_4, 1 );
        level._id_CE5E = createicon( "h1_hud_tutorial_border", var_4, 1 );
    }

    level.hintbackground setpoint( "TOP", undefined, 0, var_6 + var_1 );
    level.hintbackground.sort = 1;
    level.hintbackground.hidewheninmenu = 1;
    level.hintbackground.hidewhendead = 1;
    level._id_B160 setpoint( "TOP", undefined, 0, var_6 + var_1 );
    level._id_B160.sort = 1;
    level._id_B160.hidewheninmenu = 1;
    level._id_B160.hidewhendead = 1;
    level._id_CE5E setpoint( "TOP", undefined, 0, var_6 + var_1 + var_7 );
    level._id_CE5E.sort = 1;
    level._id_CE5E.hidewheninmenu = 1;
    level._id_CE5E.hidewhendead = 1;

    if ( var_2 == 0 )
    {
        level.hintbackground.alpha = 0.9;
        level._id_B160.alpha = 0.05;
        level._id_CE5E.alpha = 0.05;
    }
    else
    {
        ...
        level.hintbackground.alpha = 0.9;
        level._id_B160.alpha = 0;
        level._id_B160 fadeovertime( var_2 );
        level._id_B160.alpha = 0.05;
        level._id_CE5E.alpha = 0;
        level._id_CE5E fadeovertime( var_2 );
        level._id_CE5E.alpha = 0.05;
    }
}
...
_id_A889( var_0 )
{
    ...
    if ( isdefined( level._id_B160 ) )
    {
        if ( var_0 > 0 )
            level._id_B160 fadeovertime( var_0 );

        level._id_B160.alpha = 0;
    }

    if ( isdefined( level._id_CE5E ) )
    {
        if ( var_0 > 0 )
            level._id_CE5E fadeovertime( var_0 );
...
_id_C22D()
{
    ...
    if ( isdefined( level._id_B160 ) )
        level._id_B160 destroyelem();

    if ( isdefined( level._id_CE5E ) )
        level._id_CE5E destroyelem();
}
...
_id_C465( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    if ( !isdefined( var_3 ) )
        var_3 = 0;
    ...
    var_9 = common_scripts\utility::ter_op( !isdefined( var_0 ) || var_3, -225, var_0 );
    var_10 = common_scripts\utility::ter_op( !isdefined( var_1 ), 10.5, var_1 );
...
_id_B464( var_0, var_1, var_2, var_3 )
{
...
_id_C0FB( var_0, var_1, var_2, var_3 )
{
    level endon( "kill_timer_flourish" );
    var_4 = 57;
    var_5 = ( 1.0, 1.0, 1.0 );
    ...
    _id_B464( var_3, var_11, var_5, var_14 );
    var_17 destroy();
}

get_countdown_hud( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_3 ) )
        var_3 = 0;
    ...
    var_6 = common_scripts\utility::ter_op( !isdefined( var_0 ) || var_3, 0, var_0 );
    ...
    if ( var_5 )
    {
        var_9 = common_scripts\utility::_id_D5D2();
    ...
    var_8.font = "timer";
    var_8.glowcolor = ( 0.0, 0.0, 0.0 );
    var_8.glowalpha = 0;
    var_8.foreground = 1;
    var_8.hidewheninmenu = 1;
    var_8.hidewhendead = 1;
    var_8.text = newhudelem();
    var_8.text.alignx = "center";
    var_8.text.aligny = "top";
    var_8.text.horzalign = "center_adjustable";
    var_8.text.vertalign = "top_adjustable";
    var_8.text.x = var_6;
    var_8.text.y = var_7 + 8;
    var_8.text.fontscale = 0.45;
    var_8.text.color = ( 1.0, 1.0, 1.0 );
    var_8.text.font = "timer";
    var_8.text.glowcolor = ( 0.0, 0.0, 0.0 );
    var_8.text.glowalpha = 0;
    var_8.text.foreground = 1;
    var_8.text.hidewheninmenu = 1;
    var_8.text.hidewhendead = 1;
    var_8._id_A997 = newhudelem();
    var_8._id_A997.x = var_6;
    var_8._id_A997.y = var_7;
    var_8._id_A997 setshader( "h1_hud_timer_blur", var_10, 57 );
    var_8._id_A997.alignx = "center";
    var_8._id_A997.aligny = "top";
    var_8._id_A997.sort = 1;
    var_8._id_A997.foreground = 0;
    var_8._id_A997.horzalign = "center_adjustable";
    var_8._id_A997.vertalign = "top_adjustable";
    var_8._id_A997.alpha = 0.9;
    var_8._id_A997.hidewheninmenu = 1;
    var_8._id_A997.hidewhendead = 1;
    var_8._id_B242 = newhudelem();
    var_8._id_B242.x = var_6;
    var_8._id_B242.y = var_7;
    var_8._id_B242 setshader( "h1_hud_timer_border", var_10, 57 );
    var_8._id_B242.alignx = "center";
    var_8._id_B242.aligny = "top";
    var_8._id_B242.sort = 1;
    var_8._id_B242.foreground = 0;
    var_8._id_B242.horzalign = "center_adjustable";
    var_8._id_B242.vertalign = "top_adjustable";
    var_8._id_B242.alpha = 0.1;
    var_8._id_B242.hidewheninmenu = 1;
    var_8._id_B242.hidewhendead = 1;

    if ( isdefined( var_4 ) )
        thread _id_C0FB( var_6, var_7, var_4, var_8 );
...
_id_CA49( var_0 )
{
    ...
    if ( isdefined( var_0._id_A997 ) )
        var_0._id_A997 destroy();

    if ( isdefined( var_0._id_B242 ) )
        var_0._id_B242 destroy();
...
_id_B8DF( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_2 ) )
        var_2 = 0;
    ...
    level.timer = get_countdown_hud( undefined, undefined, undefined, undefined, var_0, var_3 );
    level.timer setpulsefx( 30, 900000, 700 );
    level.timer.text.label = var_1;
    level.start_time = gettime();
    level.timer settenthstimerstatic( var_0 );
    wait 0.5;
    level.timer settenthstimer( var_0 );

    if ( var_2 == 1 )
        thread _id_B2C0( var_0 );

    wait(var_0);
    level notify( "timer_expired" );

    if ( isdefined( level.timer ) )
        _id_CA49( level.timer );
}
...
_id_C6FB( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5.children = [];
    var_5 addchild( var_6 );
    var_5 addchild( var_7 );
    var_5 addchild( var_8 );
    var_5 addchild( var_9 );

    foreach ( var_11 in var_5.children )
    {
        var_11.alignx = "left";
        var_11.aligny = "top";
        var_11.x = 0;
...
_id_CC64( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        if ( !isdefined( self ) || isai( self ) && !isalive( self ) || maps\_utility::ent_flag( "kill_custom_nameplate" ) )
        {
            if ( isdefined( var_5 ) )
                var_5 destroy();
...
_id_C30B()
{
    ...
    var_3 = self.origin + ( 0.0, 0.0, 15.0 );

    if ( isdefined( self.model ) && maps\_utility::hastag( self.model, "tag_eye" ) )
        var_3 = self gettagorigin( "tag_eye" ) + ( 0.0, 0.0, -8.0 );

    if ( !common_scripts\utility::within_fov( var_1, var_2, var_3, cos( 65 ) ) )
        return 0;
...
_id_AB01( var_0, var_1 )
{
    ...
    var_5.label = var_0;
    var_6 = _id_D573( "hostileNameFontColor" );
    var_7 = _id_D573( "hostileNameFontGlowColor" );
    var_8 = _id_D573( "friendlyNameFontColor" );
    var_9 = _id_D573( "friendlyNameFontGlowColor" );
