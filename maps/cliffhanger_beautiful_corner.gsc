...
_ID44925()
{
    ...
    for (;;)
    {
        if ( level._ID794 buttonpressed( "dpad_right" ) || level._ID794 buttonpressed( "pgup" ) )
            var_1 = _ID42237::_ID37527( var_0 == var_2.size - 1, 0, var_0 + 1 );
        else if ( level._ID794 buttonpressed( "dpad_left" ) || level._ID794 buttonpressed( "pgdn" ) )
        ...
        if ( level._ID794 buttonpressed( "dpad_up" ) || level._ID794 buttonpressed( "end" ) )
        {
