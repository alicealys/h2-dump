...
_ID50786()
{
    ...
    _ID45778::_ID616();
    var_1 = _func_1A2( "wind_blown_object", "targetname" );
...
_ID45560()
{
    var_0 = _func_06A( "script_origin", ( 928.75, -28720.9, -1013.28 ) );
    var_0._ID65 = ( 4.158, -58.3887, 0 );
    var_0._ID1193 = "beautiful_corner1";
    var_0 = _func_06A( "script_origin", ( 928.75, -28720.9, -1013.28 ) );
    var_0._ID65 = ( 4.158, -58.3887, 0 );
    var_0._ID1193 = "beautiful_corner1_static";
    var_0 = _func_06A( "script_origin", ( 928.75, -28720.9, -1013.28 ) );
    var_0._ID65 = ( 12.8312, 45.6184, 0 );
    var_0._ID1193 = "beautiful_corner1_end";
    var_0 = _func_06A( "script_origin", ( 928.75, -28720.9, -1013.28 ) );
    var_0._ID65 = ( 12.8312, 45.6184, 0 );
    var_0._ID1193 = "beautiful_corner1_static_end";
    var_0 = _func_06A( "script_origin", ( 580.136, -29414.5, 461.006 ) );
    var_0._ID65 = ( -35.06, 167.679, 0 );
    var_0._ID1193 = "beautiful_corner2";
    var_0 = _func_06A( "script_origin", ( 580.136, -29414.5, 461.006 ) );
    var_0._ID65 = ( -35.06, 167.679, 0 );
    var_0._ID1193 = "beautiful_corner2_static";
    var_0 = _func_06A( "script_origin", ( 592.704, -29418.9, 732.303 ) );
    var_0._ID65 = ( -35.06, 167.679, 0 );
    var_0._ID1193 = "beautiful_corner2_end";
    var_0 = _func_06A( "script_origin", ( 592.704, -29418.9, 732.303 ) );
    var_0._ID65 = ( -35.06, 167.679, 0 );
    var_0._ID1193 = "beautiful_corner2_static_end";
    var_0 = _func_06A( "script_origin", ( 367.194, -29045.3, 156.164 ) );
    var_0._ID65 = ( -9.93466, -116.028, 0 );
    var_0._ID1193 = "beautiful_corner3";
    var_0 = _func_06A( "script_origin", ( 367.194, -29045.3, 156.164 ) );
    var_0._ID65 = ( -9.93466, -116.028, 0 );
    var_0._ID1193 = "beautiful_corner3_static";
    var_0 = _func_06A( "script_origin", ( 525.912, -29037.5, 129.326 ) );
    var_0._ID65 = ( -57.2538, -133.716, 0 );
    var_0._ID1193 = "beautiful_corner3_end";
    var_0 = _func_06A( "script_origin", ( 525.912, -29037.5, 129.326 ) );
    var_0._ID65 = ( -57.2538, -133.716, 0 );
    var_0._ID1193 = "beautiful_corner3_static_end";
    var_0 = _func_06A( "script_origin", ( -10985.6, -34977.7, 513.836 ) );
    var_0._ID65 = ( -16.4393, -31.6988, 0 );
    var_0._ID1193 = "beautiful_corner4";
    var_0 = _func_06A( "script_origin", ( -10985.6, -34977.7, 513.836 ) );
    var_0._ID65 = ( -16.4393, -31.6988, 0 );
    var_0._ID1193 = "beautiful_corner4_static";
    var_0 = _func_06A( "script_origin", ( -10985.6, -34977.7, 480.694 ) );
    var_0._ID65 = ( 6.31334, -144.455, 0 );
    var_0._ID1193 = "beautiful_corner4_end";
    var_0 = _func_06A( "script_origin", ( -10985.6, -34977.7, 480.694 ) );
    var_0._ID65 = ( 6.31334, -144.455, 0 );
    var_0._ID1193 = "beautiful_corner4_static_end";
    var_0 = _func_06A( "script_origin", ( -5374.4, -26359.2, 940.04 ) );
    var_0._ID65 = ( -19.0456, 132.779, 0 );
    var_0._ID1193 = "beautiful_corner5";
    var_0 = _func_06A( "script_origin", ( -5374.4, -26359.2, 940.04 ) );
    var_0._ID65 = ( -19.0456, 132.779, 0 );
    var_0._ID1193 = "beautiful_corner5_static";
    var_0 = _func_06A( "script_origin", ( -5374.4, -26359.2, 940.04 ) );
    var_0._ID65 = ( -8.99759, 64.0326, 0 );
    var_0._ID1193 = "beautiful_corner5_end";
    var_0 = _func_06A( "script_origin", ( -5374.4, -26359.2, 940.04 ) );
    var_0._ID65 = ( -8.99759, 64.0326, 0 );
    var_0._ID1193 = "beautiful_corner5_static_end";
    var_0 = _func_06A( "script_origin", ( -9099.75, -25552.8, 879.066 ) );
    var_0._ID65 = ( -12.3737, -67.1057, 0 );
    var_0._ID1193 = "beautiful_corner6";
    var_0 = _func_06A( "script_origin", ( -9099.75, -25552.8, 879.066 ) );
    var_0._ID65 = ( -12.3737, -67.1057, 0 );
    var_0._ID1193 = "beautiful_corner6_static";
    var_0 = _func_06A( "script_origin", ( -9370.4, -25895.6, 879.066 ) );
    var_0._ID65 = ( -13.7437, 3.91227, 0 );
    ...
    level._ID44344["beautiful_corner1"] = ::_unknown_0BA9;
    level._ID44344["beautiful_corner2"] = ::_unknown_0BB6;
    level._ID44344["beautiful_corner3"] = ::_unknown_0BC1;
    level._ID44344["beautiful_corner4"] = ::_unknown_0BD2;
    level._ID44344["beautiful_corner5"] = ::_unknown_0BD9;
    level._ID44344["beautiful_corner6"] = ::_unknown_0BEA;
}
...
_ID44925()
{
    ...
    for (;;)
    {
        if ( level._ID794 _meth_8256( "dpad_right" ) || level._ID794 _meth_8256( "pgup" ) )
            var_1 = _ID42237::_ID37527( var_0 == var_2.size - 1, 0, var_0 + 1 );
        else if ( level._ID794 _meth_8256( "dpad_left" ) || level._ID794 _meth_8256( "pgdn" ) )
        ...
        if ( level._ID794 _meth_8256( "dpad_up" ) || level._ID794 _meth_8256( "end" ) )
        {
            if ( _func_02F( level._ID51628 ) )
                [[ _ID42237::_ID37527( level._ID51628, _ID49359::_ID48243, _ID49359::_ID47801 ) ]]( level._ID794, 0.05 );
