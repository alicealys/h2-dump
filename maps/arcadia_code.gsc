...
_ID53657()
{
    ...
    if ( var_0.health < var_0._ID18313 )
        return;
...
_ID45433( var_0, var_1, var_2 )
{
    ...
    if ( var_0 )
    {
        ...
        level.player thread _ID42407::_ID27079( "wpn_plr_laser_target_acquired" );
        wait 0.4;
...
_ID21706()
{
    ...
    else if ( !_ID42237::_ID14385( "disable_stryker_laser" ) && !_ID42407::_ID13019( "disable_stryker_laser" ) )
    {
        if ( isalive( level._ID51107 ) )
        {
            var_4 = distance( level._ID51107.origin, var_1 );
...
_ID50043()
{
    return _ID42237::_ID14385( "used_laser_attack" ) || !level.player._ID21752;
}
...
_ID46833()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in var_0 )
        {
            var_8 = _ID42237::_ID16638( var_2.target, "targetname" );
            var_2 thread _ID51637( var_4, var_8.origin );
            var_5++;
...
_ID44946()
{
    ...
    var_8 = _ID42407::_ID35028( "zpu_turret", self.origin );
...
_ID50081( var_0, var_1, var_2 )
{
    ...
    thread _ID42237::_ID27077( "exp_armor_vehicle", var_0.origin );
...
_ID45975()
{
    ...
    for (;;)
    {
        self setturrettargetvec( self._ID37340[randomint( self._ID37340.size )].origin );
        wait(randomfloatrange( 0.5, 1.5 ));
...
_ID46323()
{
    ...
    {
        var_3 notsolid();
        var_3.origin = var_3.origin - ( 0, 0, 1024 );
...
_ID51431()
{
    var_0 = self.health - self._ID18313;
...
_ID45173( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        self waittill( "damage" );
        var_6 = self.health - self._ID18313;
...
_ID45315()
{
    ...
    for (;;)
    {
        ...
        {
            var_1 = magicbullet( "rpg_straight", var_0.origin, level._ID51107.origin + ( 0, 0, 60 ) );
...
_ID45978()
{
    ...
    for (;;)
    {
        ...
        var_2 = distancesquared( self.origin, level._ID51107.origin ) <= var_1;
        var_3 = _ID42237::_ID41802( self.origin, self.angles, level._ID51107.origin, var_0 );
...
_ID54226()
{
    ...
    while ( isalive( level._ID51107 ) )
    {
        ...
        var_3 = distance( level.player.origin, level._ID51107.origin );

        if ( var_3 > 450 )
            continue;

        var_4 = _ID42237::_ID41802( level._ID51107.origin, level._ID51107.angles, level.player.origin, var_0 );
...
_ID49954( var_0 )
{
    self endon( "trigger" );
    _ID42237::_ID14413( var_0 );
    thread _ID42407::_ID1802( level.player );
}
...
_ID47355()
{
    ...
    for (;;)
    {
        level._ID47656 setturrettargetent( level.player, ( 0, 0, 20 ) );
        wait(randomfloatrange( 0.5, 1.5 ));
