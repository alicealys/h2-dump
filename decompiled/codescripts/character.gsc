...
setheadmodel( var_0 )
{
    ...
    if ( isdefined( self.cheat ) && isdefined( self.cheat._id_C86E ) && self.cheat._id_C86E )
    {
        var_1 = 0;
        self.cheat.pineapple_previoushead = var_0;
    }

    if ( isdefined( self.cheat ) && isdefined( self.cheat._id_C447 ) && self.cheat._id_C447 )
    {
        var_1 = 0;
        self.cheat._id_D184 = var_0;
    }

    if ( isdefined( self._id_A87F ) && isdefined( self._id_A87F.polterghostmode ) && self._id_A87F.polterghostmode )
    {
        var_1 = 0;
        self._id_A87F.polterghostmode_previousmodel = var_0;
    }
