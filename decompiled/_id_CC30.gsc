...
_id_AA62()
{
    ...
    for (;;)
    {
        ...
        wait(var_1);
        playfx( level._effect["sand_storm_player"], var_0.origin + ( 0.0, 0.0, 100.0 ) );
    }
}
...
_id_B8C2()
{
    ...
    playfx( common_scripts\utility::getfx( "splash_underwater_afchase" ), ( 25590.3, 26824.0, -10008.9 ) );
}
