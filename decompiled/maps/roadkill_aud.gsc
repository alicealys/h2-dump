...
_id_BA67( var_0 )
{
    common_scripts\utility::play_sound_in_space( "scn_shellshock_intro_plr_getup", ( 0.0, 0.0, 0.0 ) );
}
...
_id_C34B()
{
    ...
    wait 6;
    thread common_scripts\utility::play_sound_in_space( "AB_1_callout_contactclock_11_Custom", ( -8202.69, 7598.86, 528.0 ) );
}
