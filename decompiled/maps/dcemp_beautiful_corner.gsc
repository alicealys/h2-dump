...
_id_B1F8()
{
    var_0 = spawn( "script_origin", ( -45711.0, 12085.1, -383.042 ) );
    var_0.angles = ( -11.4381, 34.3818, 0.0 );
    ...
    var_0.angles = ( -19.5305, 44.1777, 0.0 );
    ...
    var_0.angles = ( 7.35865, 17.9528, 0.0 );
    var_0.targetname = "beautiful_corner3";
    var_0 = spawn( "script_origin", ( -41189.1, 21555.3, -644.844 ) );
    var_0.angles = ( 7.35865, 17.9528, 0.0 );
    var_0.targetname = "beautiful_corner3_static";
    var_0 = spawn( "script_origin", ( -40831.7, 21628.0, -644.844 ) );
    var_0.angles = ( 5.02659, 28.0979, 0.0 );
