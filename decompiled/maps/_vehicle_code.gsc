...
sort_by_startingpos( var_0 )
{
    ...
    return common_scripts\utility::_id_D53D( var_1, var_2 );
}
...
setup_groundnode_detour( var_0 )
{
    ...
    if ( common_scripts\utility::flag_exist( "remaster_blockout" ) && !common_scripts\utility::flag( "remaster_blockout" ) )
    {
...
_id_C669( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.unique_id ) )
        var_3 = "node_wait_triggered" + self.unique_id;
    else
        var_3 = "node_wait_triggered";

    if ( !isdefined( var_0.triggered_time ) || var_0.triggered_time != gettime() )
    {
        var_4 = spawnstruct();
        wait_til_node_wait_triggered( var_4, var_3, var_0, var_2 );
        var_4 waittill( var_3 );
    }

    var_0.triggered_time = undefined;
}
...
vehicle_paths_non_heli( var_0 )
{
    ...
    while ( isdefined( var_4 ) )
    {
        ...
        if ( isdefined( var_4._id_A95C ) )
            soundscripts\_snd::snd_message( var_4._id_A95C, self );

        if ( isdefined( var_4.gateopen ) && !var_4.gateopen )
            thread path_gate_wait_till_open( var_4 );

        if ( isdefined( var_4._id_B555 ) )
            thread maps\_vehicle::_id_B40D( var_4._id_B555 );

        if ( isdefined( var_4._id_D4C3 ) )
            thread maps\_vehicle::_id_B2E2( var_4._id_D4C3 );
        ...
        {
            if ( isdefined( self._id_B120 ) )
                self._id_B120[var_4.script_flag_set] = 1;
        ...
        if ( isdefined( var_4.script_flag_wait ) )
        {
            ...
            self._id_B120[var_4.script_flag_wait] = 1;
...
vehicle_paths_helicopter( var_0, var_1, var_2 )
{
    ...
    while ( isdefined( var_7 ) )
    {
        ...
        if ( isdefined( var_7._id_A95C ) )
            soundscripts\_snd::snd_message( var_7._id_A95C, self );

        if ( isdefined( var_7._id_B555 ) )
            thread maps\_vehicle::_id_B40D( var_7._id_B555 );

        if ( isdefined( var_7._id_D4C3 ) )
            thread maps\_vehicle::_id_B2E2( var_7._id_D4C3 );

        if ( isdefined( var_7.script_helimove ) )
            maps\_vehicle::_id_B2F5( var_7.script_helimove );
        ...
        {
            if ( isdefined( self._id_B120 ) )
                self._id_B120[var_7.script_flag_set] = 1;
        ...
        {
            if ( isdefined( self._id_B120 ) )
                self._id_B120[var_7.script_flag_clear] = 0;
        ...
        if ( isdefined( var_7.script_flag_wait ) )
        {
            ...
            self._id_B120[var_7.script_flag_wait] = 1;
...
heli_wait_node( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        if ( isdefined( var_1.script_airresistance ) )
            self setairresitance( var_1.script_airresistance );
    ...
    if ( isdefined( var_0.script_firelink ) )
        thread maps\_helicopter_globals::heli_firelink( var_0 );
...
vehicle_init( var_0 )
{
    var_1 = var_0 _id_B80B( var_0.classname );
...
vehicle_kill_common( var_0, var_1 )
{
    ...
    var_6 = _id_B6D6( var_3 );

    if ( isdefined( var_6 ) && isdefined( var_6._id_B7EC ) && var_6._id_B7EC )
    {
...
vehicle_kill()
{
    ...
    for (;;)
    {
        ...
        if ( !isdefined( self ) && isdefined( self._id_AB3E ) )
        {
            foreach ( var_2 in self._id_AB3E )
                var_2 delete();
        }
...
extra_vehicle_cleanup()
{
    ...
    self._id_B8AF = undefined;
    self._id_BD12 = undefined;
}
...
_id_ABC6( var_0, var_1, var_2 )
{
    if ( isdefined( var_0 ) && isplayer( var_0 ) )
    {
        self.achievement_attacker = var_0;
        thread maps\_utility::_id_D4F3( self.origin, "explosive", 1000 );
    }
    ...
    if ( isdefined( var_0 ) && var_0 == level.player && isdefined( self.rocket_destroyed_for_achievement ) && level.player _id_AFE2( "rpg" ) )
...
vehicle_becomes_crashable()
{
    ...
    if ( !isdefined( self.has_riders ) )
        self.has_riders = self.riders.size > 0;
...
_mount_snowmobile( var_0, var_1 )
{
    ...
    maps\_utility::delaythread( 0.05, maps\_anim::_id_B0F7, "stop_attach_tag", var_17, var_0, var_5, 0.5 );
...
_id_D153( var_0 )
{
    if ( var_0.update_time != gettime() )
    {
        ...
        if ( var_0.steering_enable )
        {
            ...
            var_2 = var_1 - var_0.steering;

            if ( var_2 != 0 )
            {
                var_3 = var_0.steering_maxdelta / abs( var_2 );

                if ( var_3 < 1 )
                    var_2 *= var_3;

                var_0.steering += var_2;
            }
        }
        else
            var_0.steering = 0;
...
update_steering( var_0 )
{
    ...
    if ( var_0.steering_enable )
    {
        ...
        var_5 = var_1 - var_0.steering;

        if ( var_5 != 0 )
        {
            var_6 = var_0.steering_maxdelta / abs( var_5 );

            if ( var_6 < 1 )
                var_5 *= var_6;

            var_0.steering += var_5;
        }
    }
    else
        var_0.steering = 0;
        ...
        switch ( var_4 )
        {
            ...
            case "bullet":
                if ( !level.armordamagehints )
                {
                    ...
                    var_1 maps\_utility::display_hint( "invulerable_bullets", undefined, undefined, undefined, undefined, getdvarfloat( "cg_invalidCmdHintDuration", 30000 ) / 1000 );
                    wait 4;
                    level.armordamagehints = 0;
            ...
            case "bullet":
                if ( !level.armordamagehints )
                {
                    ...
                    if ( var_4 == "mod_grenade" || var_4 == "mod_grenade_splash" )
                        var_1 maps\_utility::display_hint( "invulerable_frags", undefined, undefined, undefined, undefined, getdvarfloat( "cg_invalidCmdHintDuration", 30000 ) / 1000 );
                    else
                        var_1 maps\_utility::display_hint( "invulerable_bullets", undefined, undefined, undefined, undefined, getdvarfloat( "cg_invalidCmdHintDuration", 30000 ) / 1000 );
...
{
    var_2 = _id_B80B( self.classname );

    if ( !isdefined( var_1 ) )
    {
        self notify( "stop_kicking_up_dust" );

        if ( isdefined( level._vehicle_effect_custom_param ) && isdefined( level._vehicle_effect_custom_param[var_2] ) && isdefined( level._vehicle_effect_custom_param[var_2].tags ) )
        {
            foreach ( var_4 in level._vehicle_effect_custom_param[var_2].tags )
                thread aircraft_wash_thread( var_0, var_4 );
    ...
    var_8 = spawnstruct();
    var_8._id_B428 = common_scripts\utility::spawn_tag_origin();
    thread _id_B700( var_8._id_B428, var_6 );
    var_8._id_CECB = undefined;
    var_8._id_CF92 = undefined;
    var_9 = 0;
    var_10 = _id_AC37();
    ...
    self._id_D1CF = 0;
    self._id_BD12 = undefined;
    var_27 = maps\_vehicle::_id_D176( var_2, "aircraft_landing" );
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            var_29 = combineangles( var_29, ( -90.0, 0.0, 0.0 ) );
        }
        else
        {
        ...
        var_34 = _id_B5A5( var_2, var_24, var_30, var_1 );
        var_35 = get_wash_fx( var_34, var_1 );
        ...
        var_36 = _id_BE5C( var_34, var_1 );

        if ( _id_D069( var_36, self._id_BD12 ) )
            _id_B088();

        if ( var_24["fraction"] < var_14 )
        {
            if ( isdefined( var_27 ) && isdefined( var_27._id_B2DE ) && isdefined( var_27._id_B2DE[var_35] ) )
                var_35 = var_27._id_B2DE[var_35];
        }
        ...
        if ( length( var_40 ) < 1 )
            var_40 = anglestoforward( var_29 + ( 0.0, 180.0, 0.0 ) );

        if ( abs( vectordot( vectornormalize( var_40 ), var_38 ) ) > 0.999 )
            continue;

        var_9 = 1;
        var_43 = maps\_treadfx::_id_B7B1( var_35 );
        var_8._id_CF92 = common_scripts\utility::ter_op( var_43, var_35, undefined );
        var_8 _id_CC08();
        var_8._id_B428 dontinterpolate();
        var_8._id_B428.origin = var_37;

        if ( maps\_treadfx::_id_B7B1( var_35 ) )
        {
            var_8._id_B428.angles = axistoangles( var_38, vectorcross( var_38, var_40 ), var_40 );
            var_8 _id_BACC();
        }
        else
            playfx( var_35, var_37, var_38, var_40 );

        if ( isdefined( var_36 ) && !self._id_D1CF && var_32 < var_20 )
        {
            thread maps\_utility::play_loop_sound_on_tag( var_36, var_1, 1, 1 );
            self._id_D1CF = 1;
            self._id_BD12 = var_36;
        }
    }
}
...
_id_B5A5( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
    var_4.surface = var_1["surfacetype"];
    var_4._id_C463 = undefined;
    var_5 = vectordot( ( 0.0, 0.0, -1.0 ), var_2 );

    if ( var_5 >= 0.97 )
        var_4._id_C463 = undefined;
    else if ( var_5 >= 0.92 )
        var_4._id_C463 = "_bank";
    else
        var_4._id_C463 = "_bank_lg";

    var_4._id_AB0F = var_0;

    if ( isdefined( level._vehicle_effect_custom_param ) && isdefined( level._vehicle_effect_custom_param[var_4._id_AB0F] ) && isdefined( level._vehicle_effect_custom_param[var_4._id_AB0F].get_surface_override_function ) )
        var_4.surface = self [[ level._vehicle_effect_custom_param[var_4._id_AB0F].get_surface_override_function ]]( var_4.surface, var_3 );
...
{
    return get_wash_effect( var_0._id_AB0F, var_0.surface, var_0._id_C463 );
}

_id_BE5C( var_0, var_1 )
{
    return _id_C695( var_0._id_AB0F, var_0.surface, var_0._id_C463 );
}
...
get_wash_effect( var_0, var_1, var_2 )
{
    if ( isdefined( var_2 ) )
    {
        ...
        if ( isdefined( level._vehicle_effect ) && isdefined( level._vehicle_effect[var_0] ) && isdefined( level._vehicle_effect[var_0][var_3] ) )
...
_id_C695( var_0, var_1, var_2 )
{
    if ( isdefined( var_2 ) )
    {
        var_3 = var_1 + var_2;

        if ( isdefined( level._id_BFF6[var_0][var_3] ) )
            return level._id_BFF6[var_0][var_3];
    }

    return _id_CCB6( var_0, var_1 );
}
...
_id_CCB6( var_0, var_1 )
{
    if ( !isdefined( level._id_BFF6[var_0] ) )
        return undefined;

    if ( !isdefined( level._id_BFF6[var_0][var_1] ) && var_1 != "default" && var_1 != "default_script_model" )
        return _id_CCB6( var_0, "default" );

    return level._id_BFF6[var_0][var_1];
}
...
vehicle_treads()
{
    ...
    {
        var_1 = isdefined( level.vehicle_single_tread_list ) && isdefined( level.vehicle_single_tread_list[self.vehicletype] );
        var_2 = isdefined( level._id_BBDF ) && isdefined( level._id_BBDF[self.vehicletype] );
...
tread_wait()
{
    ...
    if ( isdefined( self._id_C09F ) && var_0 < self._id_C09F )
        return -1;
...
get_treadfx( var_0, var_1 )
{
    ...
    var_4 = var_0 _id_B80B( var_0.classname );
    return get_vehicle_effect( var_4, var_2 );
}

_id_CFF4( var_0, var_1 )
{
    var_2 = self getwheelsurface( var_1 );
...
mginit()
{
    ...
    foreach ( var_7, var_5 in var_2 )
    {
        ...
        if ( isdefined( var_5._id_AC60 ) )
        {
            var_6 _meth_857F( 1 );
            var_6 thread [[ var_5._id_AC60 ]]();
        }
...
vehicle_rumble()
{
    ...
    for (;;)
    {
        ...
        if ( ( self vehicle_getspeed() == 0 || !self.rumbleon ) && !self._id_C8B5 )
        {
            wait 0.1;
            continue;
        }

        self _meth_80B5( var_1.rumble );

        while ( ( self._id_C8B5 || self.rumbleon && self vehicle_getspeed() > 0 ) && level.player istouching( var_4 ) )
        {
...
_id_BBD2()
{
    ...
    if ( level.vehicle_mainturrets[self.model].size )
        var_2 = getarraykeys( level.vehicle_mainturrets[self.model] );
...
unload_node( var_0 )
{
    ...
    if ( isdefined( self.ent_flag ) && isdefined( self.ent_flag["prep_unload"] ) && maps\_utility::ent_flag( "prep_unload" ) )
        return;
...
_gopath( var_0 )
{
    ...
    if ( isdefined( var_0.script_vehiclestartmove ) && level.vehicle_startmovegroup.size > 0 )
...
{
    var_2 = var_1 _id_B80B( var_1.classname );

    if ( isdefined( level.vehicleinitthread[var_1.vehicletype][var_2] ) )
        return;
    ...
    foreach ( var_5 in level.needsprecaching )
    {
        if ( var_5 == var_0 )
            var_3 = 1;
    }
...
setup_levelvars()
{
    ...
    level._id_C47A = level.playervehicle;
    level.vehicles = [];
    ...
    if ( !isdefined( level._id_BFBE ) )
        level._id_BFBE = [];

    if ( !isdefined( level._id_BBDF ) )
        level._id_BBDF = [];
...
_id_C117( var_0, var_1 )
{
    if ( isdefined( self.skipanimbaseddeath ) && self.skipanimbaseddeath )
        return;

    var_2 = _id_B6D6( var_0 );

    if ( !isdefined( var_2 ) )
        return;

    var_3 = _id_CB15( var_2, var_1 );
    _id_B87E( var_3, var_2 );
}

_id_B6D6( var_0 )
{
    if ( isdefined( self._id_BFBE ) )
        return self._id_BFBE;

    if ( isdefined( self._id_AA10 ) )
    {
        var_1 = var_0 + "_" + self._id_AA10;

        if ( isdefined( level._id_BFBE[var_1] ) )
            return level._id_BFBE[var_1];
    }

    if ( isdefined( level._id_BFBE[var_0] ) )
        return level._id_BFBE[var_0];

    return undefined;
}

_id_CB15( var_0, var_1 )
{
    if ( isdefined( self._id_D5BE ) )
        return self._id_D5BE;

    if ( var_0._id_C581 )
        return _id_B493( var_0, var_1 );

    return common_scripts\utility::random( var_0.anims );
}

_id_B493( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        return common_scripts\utility::random( var_0.anims );

    var_2 = _id_C805( var_1 );
...
_id_B87E( var_0, var_1 )
{
    ...
    if ( isdefined( var_1._id_C334 ) && var_1._id_C334 )
        maps\_utility::ent_flag_set( "kill_deathanim_force_crash_end" );

    self setcandamage( var_1._id_B291 );
    thread _id_BE15( var_1._id_C93C, var_0 );

    if ( isdefined( var_1._id_BDCD ) )
    {
        foreach ( var_3 in var_1._id_BDCD )
            _id_AB87( var_0, var_3 );
    }
    ...
    if ( var_1._id_B814 )
        self vehicle_setspeed( var_1._id_A8FA, var_1._id_C629, var_1._id_C9D1 );

    self useanimtree( #animtree );

    if ( var_1.clear_anims )
        self clearanim( %root, var_1._id_BFE8 );

    var_5 = _get_dummy();
    var_5 setanim( var_0, 1, 0, 1 );
    _id_C849( var_0, var_1 );
...
_id_C849( var_0, var_1 )
{
    ...
    else if ( var_1._id_C77C > 0 )
        var_2 = var_1._id_C77C;
    else
        var_2 = getanimlength( var_0 );
...
_id_B088()
{
    if ( isdefined( self._id_BD12 ) && isdefined( self._id_D1CF ) && self._id_D1CF == 1 )
    {
        self notify( "stop sound" + self._id_BD12 );
        self._id_D1CF = 0;
        self._id_BD12 = undefined;
    }
}
...
_id_C983( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        self._id_B6EC = spawn( "script_model", self.origin );
        self._id_B6EC setmodel( self.model );
        thread _id_AC97();
        ...
        self._id_B6EC linkto( self.modeldummy, var_0, var_1, var_2 );
        self._id_B6EC _meth_8461();
        self._id_B6EC hide();
        self._id_B6EC dontinterpolate();
        self.modeldummy notsolid();
    }
    else
        self.modeldummy _meth_8461();
}
...
_id_B80B( var_0 )
{
    ...
    if ( isdefined( self._id_D569 ) )
        var_1 = self._id_D569;
    else if ( ( var_0 == "script_vehicle" || var_0 == "script_model" ) && isdefined( self.vehicletype ) )
    {
        var_1 = "script_vehicle_" + self.vehicletype;
        self._id_D569 = var_1;
    }
...
_id_D0C3( var_0 )
{
    ...
    var_1 maps\_vehicle::gopath( var_1 );
    var_1 _id_C01C();
}
...
_id_CAE5()
{
    ...
    foreach ( var_7, var_6 in var_1 )
        var_6 thread maps\_utility::add_spawn_function( maps\_vehicle_free_drive::guy_spawns_and_gets_in_vehicle, self, var_7 );
...
{
    var_0 = spawnstruct();
    var_0.tag_name = [ "tag_wheel_back_left", "tag_wheel_back_right" ];
    var_1 = [];
...
_id_BF8D()
{
    ...
    foreach ( var_3, var_2 in var_0 )
        var_2.tag_name = "tag_wheel_" + var_3;
...
_id_D1EC( var_0 )
{
    ...
    {
        var_7._id_B428 = common_scripts\utility::spawn_tag_origin();
        thread _id_B700( var_7._id_B428, var_1 );
        var_7._id_CECB = undefined;
    }
    ...
    for (;;)
    {
        ...
        foreach ( var_8, var_7 in var_0 )
            var_7._id_CF92 = get_treadfx( var_9, var_8 );

        if ( isdefined( var_5 ) || isdefined( var_9 ) )
        {
            var_11 = _id_BB42( var_5, var_9 );

            if ( var_11 )
                var_5 = undefined;

            var_12 = _id_BB42( var_9, var_5 );

            if ( var_12 )
                var_5 = var_9;

            var_13 = self vehicle_getspeed();
            var_14 = !( var_13 <= 0 || isdefined( self._id_C09F ) && var_13 < self._id_C09F );

            foreach ( var_7 in var_0 )
            {
                var_7 _id_CC08( !var_14 || var_11 );

                if ( var_11 )
                    var_7 _id_A932();

                if ( var_12 )
                    var_7 _id_A94A( var_9 );

                if ( var_14 )
                    var_7 _id_BACC( var_12 );
            }
        }
...
_id_A94A( var_0 )
{
    ...
    if ( isarray( self.tag_name ) )
    {
        var_1 = self.tag_name[0];
        var_3 = ( 0.0, 0.0, 0.0 );

        foreach ( var_5 in self.tag_name )
            var_3 += var_0 gettagorigin( var_5 );

        var_3 /= self.tag_name.size;
        var_3 = var_0 maps\_utility::worldtolocalcoords( var_3 );
        var_2 = var_0 gettagorigin( var_1 );
        var_2 = var_0 maps\_utility::worldtolocalcoords( var_2 );
        var_2 = var_3 - var_2;
    }
    else
        var_1 = self.tag_name;

    self._id_B428 linkto( var_0, var_1, var_2, ( -90.0, 180.0, 0.0 ) );
}

_id_CC08( var_0 )
{
    var_0 = isdefined( var_0 ) && var_0;
    var_1 = isdefined( self._id_CECB ) && ( var_0 || _id_BB42( self._id_CECB, self._id_CF92 ) );
...
_id_D02B()
{
    stopfxontag( self._id_CECB, self._id_B428, "tag_origin" );
    self._id_CECB = undefined;
}

_id_BACC( var_0 )
{
    var_0 = isdefined( var_0 ) && var_0;
    var_1 = isdefined( self._id_CF92 ) && ( var_0 || _id_BB42( self._id_CF92, self._id_CECB ) );
...
_id_CA7E()
{
    playfxontag( self._id_CF92, self._id_B428, "tag_origin" );
    self._id_CECB = self._id_CF92;
}
...
_id_B700( var_0, var_1 )
{
    ...
    var_2 = common_scripts\utility::waittill_any_in_array_return( var_1 );
    var_0 delete();
}
...
_id_B087( var_0 )
{
    ...
    switch ( var_0 )
    {
        ...
        case "treadfx_defaultRepeatRate":
            var_1 = common_scripts\utility::ter_op( _isairplane(), 0.15, 1.0 );
            break;
...
_id_ADA1( var_0 )
{
    ...
    switch ( var_0 )
    {
        ...
        case "treadfx_maxHeight":
            ...
            break;
        case "treadfx_landingHeight":
            if ( isdefined( self._id_BBF3 ) )
                var_1 = self._id_BBF3;

            break;
        case "treadfx_minRepeatRate":
            if ( isdefined( self._id_CDE7 ) )
                var_1 = self._id_CDE7;

            break;
        case "treadfx_maxRepeatRate":
            if ( isdefined( self._id_B140 ) )
                var_1 = self._id_B140;

            break;
        case "treadfx_defaultRepeatRate":
            if ( isdefined( self._id_BE78 ) )
                var_1 = self._id_BE78;

            break;
        case "treadfx_clampAngleLimit":
            if ( isdefined( self._id_C69F ) )
                var_1 = self._id_C69F;

            break;
        case "treadfx_cutoffAngleLimit":
            if ( isdefined( self._id_BE97 ) )
                var_1 = self._id_BE97;

            break;
        case "treadsfx_maxDistance":
            if ( isdefined( self._id_D244 ) )
                var_1 = self._id_D244;
...
_id_B827( var_0 )
{
    return level _id_ADA1( var_0 );
}

_id_B0C9( var_0 )
{
    return _id_ADA1( var_0 );
}

_id_C0B2( var_0 )
{
    var_1 = _id_B80B( self.classname );
    return maps\_treadfx::_id_BB9F( var_1, var_0 );
}

_id_AC37()
{
    var_0 = _id_C1BF();
    var_1 = [ ::_id_B0C9, ::_id_C0B2, ::_id_B827, ::_id_B087 ];
    var_2 = [];
...
_id_B10A( var_0 )
{
    ...
    {
        self attach( var_0.model, var_0.tag );
        return;
    }

    if ( !isdefined( self._id_AB3E ) )
        self._id_AB3E = [];

    if ( !isdefined( var_0._id_BA89 ) )
        var_0._id_BA89 = var_0.tag;

    self._id_AB3E[var_0.model] = spawn( "script_model", self gettagorigin( var_0._id_BA89 ) );
    self._id_AB3E[var_0.model].angles = self.angles;
    self._id_AB3E[var_0.model] setmodel( var_0.model );
    self._id_AB3E[var_0.model] linkto( self, var_0.tag );

    if ( isdefined( var_0.idleanim ) )
    {
        self._id_AB3E[var_0.model].animname = "generic_human";
        self._id_AB3E[var_0.model] useanimtree( #animtree );
        thread _id_CE15( self._id_AB3E[var_0.model], var_0.tag, var_0.idleanim );
    }
}

_id_CE15( var_0, var_1, var_2 )
{
    self endon( "death" );
...
_vehicle_set_random_unload_delays( var_0, var_1 )
{
    ...
    {
        self.riders[0].vehicle_unload_delay = var_0;
        return;
    }

    var_2 = common_scripts\utility::array_randomize( self.riders );
