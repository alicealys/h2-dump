...
_id_CBC3( var_0 )
{
    if ( common_scripts\utility::flag( "obj_commerce_defend_snipe_given" ) && !common_scripts\utility::flag( "player_roof_stairs_01" ) )
        common_scripts\utility::play_sound_in_space( "exp_artillery_underground_shake_crowsnest", ( -22208.0, 6986.0, 700.0 ) );
}
...
{
    wait 0.1;
    thread common_scripts\utility::play_sound_in_space( "slamraam_fire_npc", self.origin + ( 0.0, 0.0, 75.0 ) );
    wait 0.1;
