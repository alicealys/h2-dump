...
init()
{
    ...
    level._id_BFAE = _id_BC86();
    level._id_D119 = _id_D2DD();
    level._id_B45D = _id_BDE8();
    ...
    level.createrpgrepulsors = _id_CB4F();
    level._id_B48D = _id_C195();
    level._id_C33B = _id_C054();
    var_2 = _id_B3FC();
...
_id_CB4F()
{
    var_0 = maps\_utility::getdvarintdefault( "ai_use_rpg_repulsors", 1 );
    return var_0 > 0;
}
...
{
    var_3 = get_anim_position( var_2, var_1 );
    var_4 = var_3["origin"];
    var_5 = var_3["angles"];
...
_id_C9B9( var_0, var_1 )
{
    _id_B476( var_0.origin, var_1 );
}

_id_B476( var_0, var_1 )
{
    self endon( "death" );
...
anim_generic_loop( var_0, var_1, var_2, var_3 )
{
    ...
    var_5["tag"] = var_3;
    var_6[0] = var_5;
    anim_loop_packet( var_6, var_1, var_2, "generic" );
}

anim_custom_animmode( var_0, var_1, var_2, var_3 )
{
    var_4 = get_anim_position( var_3, var_2 );
    var_5 = var_4["origin"];
    var_6 = var_4["angles"];
    var_7 = undefined;
...
{
    var_6 = get_anim_position( var_3, var_2 );
    var_7 = var_6["origin"];
    var_8 = var_6["angles"];
...
{
    var_4 = get_anim_position( var_2, var_1 );
    var_5 = var_4["origin"];
    var_6 = var_4["angles"];
...
anim_loop_packet( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_34, var_5 in var_0 )
        {
            var_17 = var_5["entity"];
            var_6 = var_5["guy"];
            var_18 = var_17 get_anim_position( var_5["tag"], var_1 );
            ...
            if ( var_27 )
            {
                ...
                if ( _id_AF09( level.scr_anim[var_31][var_1][var_11] ) )
                    var_6 _meth_83D4( level.scr_anim[var_31][var_1][var_11], 1.0 );
...
anim_single( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    if ( !isdefined( var_3 ) )
        var_3 = 0;

    anim_single_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 );
}
...
anim_single_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_11 = get_anim_position( var_2, var_1 );
    ...
    var_7 = common_scripts\utility::ter_op( isdefined( var_7 ), var_7, 1 );
    ...
    foreach ( var_32, var_9 in var_0 )
    {
        ...
        if ( isdefined( var_4 ) )
            ...
            var_27 = var_9.animname;

        if ( isdefined( level.scr_face[var_27] ) && isdefined( level.scr_face[var_27][var_1] ) )
        {
            var_21 = 1;
            var_26 = level.scr_face[var_27][var_1];
            var_18 = var_26;
        }

        if ( isdefined( level.scr_sound[var_27] ) && isdefined( level.scr_sound[var_27][var_1] ) )
        {
            var_22 = 1;
            var_25 = level.scr_sound[var_27][var_1];
        }

        if ( isdefined( level.scr_anim[var_27] ) && isdefined( level.scr_anim[var_27][var_1] ) && ( !isai( var_9 ) || !var_9 maps\_utility::doinglongdeath() ) )
            var_23 = 1;

        if ( isdefined( level.scr_animsound[var_27] ) && isdefined( level.scr_animsound[var_27][var_1] ) )
            var_9 playsound( level.scr_animsound[var_27][var_1] );

        if ( var_23 )
        {
            if ( isdefined( level.scr_goaltime[var_27] ) && isdefined( level.scr_goaltime[var_27][var_1] ) )
                var_28 = level.scr_goaltime[var_27][var_1];
            else
                var_28 = 0.2;

            var_9 last_anim_time_check( var_1, var_27 );

            if ( isplayer( var_9 ) )
            {
                var_29 = level.scr_anim[var_27]["root"];
                var_9 setanim( var_29, 0, var_28 );
                var_30 = level.scr_anim[var_27][var_1];
            ...
            else
            {
                ...
                if ( !var_21 && animscripts\face::animhasfacialoverride( var_30 ) )
                    var_9 animscripts\face::_id_C8D7();
            ...
            var_31 = getanimlength( level.scr_anim[var_27][var_1] );
            ...
            if ( isdefined( var_19 ) )
            {
                thread start_notetrack_wait( var_9, var_19, var_1, var_27, level.scr_anim[var_27][var_1] );
                thread animscriptdonotetracksthread( var_9, var_19, var_1 );
            }
        }
        ...
        if ( var_21 || var_22 )
        {
            ...
            {
                if ( var_22 )
                    var_9 thread delayeddialogue( var_1, var_21, var_25, level.scr_face[var_27][var_1] );

                thread anim_facialanim( var_9, var_1, level.scr_face[var_27][var_1] );
                var_17 = var_32;
            }
            else if ( isai( var_9 ) )
            {
                if ( var_23 )
                    var_9 animscripts\face::sayspecificdialogue( var_26, var_25, 1.0 );
                else
                {
                    if ( !isdefined( var_9.disablefacialfilleranims ) || !var_9.disablefacialfilleranims )
                        var_9 thread anim_facialfiller( "single dialogue" );

                    var_9 animscripts\face::sayspecificdialogue( var_26, var_25, 1.0, "single dialogue" );
                }
            }
            else
                var_9 thread maps\_utility::play_sound_on_entity( var_25, "single dialogue" );
    ...
    {
        var_33 = spawnstruct();
        var_33 thread anim_deathnotify( var_0[var_14], var_1 );
        var_33 thread anim_animationendnotify( var_0[var_14], var_1, var_15, var_3 );
        var_33 waittill( var_1 );
    }
    else if ( isdefined( var_17 ) )
    {
        var_33 = spawnstruct();
        var_33 thread anim_deathnotify( var_0[var_17], var_1 );
        var_33 thread anim_facialendnotify( var_0[var_17], var_1, var_18 );
        var_33 waittill( var_1 );
    }
    else if ( isdefined( var_16 ) )
    {
        var_33 = spawnstruct();
        var_33 thread anim_deathnotify( var_0[var_16], var_1 );
        var_33 thread anim_dialogueendnotify( var_0[var_16], var_1 );
        var_33 waittill( var_1 );
    }
    ...
    foreach ( var_9 in var_0 )
    {
        ...
        if ( isplayer( var_9 ) )
        {
            ...
            if ( isdefined( level.scr_anim[var_27][var_1] ) )
            {
                var_29 = level.scr_anim[var_27]["root"];
...
notetrack_wait( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        if ( isdefined( var_3 ) && isdefined( level.scr_notetrack[var_7][var_3] ) )
        ...
        foreach ( var_13 in level.scr_notetrack[var_7][var_18] )
        {
            foreach ( var_15 in var_13 )
            {
                ...
                if ( isdefined( var_15["dialog_radio"] ) )
                    var_8.dialog[var_15["dialog_radio"]] = 1;
            }
        }
    }
...
_id_C611( var_0, var_1 )
{
    ...
    if ( var_2.size == 2 )
    {
        if ( var_2[0] == "exploder" )
        {
            common_scripts\_exploder::exploder( var_2[1] );
            return 1;
        }
        else if ( var_2[0] == "stop_exploder" )
        {
            maps\_utility::stop_exploder( var_2[1] );
            return 1;
        }
        else
        {
            playfxontag( common_scripts\utility::getfx( var_2[0] ), var_1, var_2[1] );
            return 1;
        }
    }
    else if ( var_2.size == 3 )
    {
        ...
        {
            playfxontag( common_scripts\utility::getfx( var_2[1] ), var_1, var_2[2] );
            return 1;
        }
        else if ( var_2[0] == "stopfxontag" )
        {
            stopfxontag( common_scripts\utility::getfx( var_2[1] ), var_1, var_2[2] );
            return 1;
        }
        else if ( var_2[0] == "killfxontag" )
        {
            killfxontag( common_scripts\utility::getfx( var_2[1] ), var_1, var_2[2] );
            return 1;
        }
        ...
        {
            common_scripts\utility::_id_AC02( common_scripts\utility::getfx( var_2[1] ), var_1, var_2[2] );
            return 1;
        }
        else if ( var_2[0] == "killfxontagwithoffset" )
        {
            common_scripts\utility::_id_C0D0( common_scripts\utility::getfx( var_2[1] ), var_1, var_2[2] );
            return 1;
        }
    }
    else if ( var_2[0] == "playfx" && ( var_2.size == 5 || var_2.size == 8 || var_2.size == 11 ) )
    {
        var_3 = common_scripts\utility::getfx( var_2[1] );
    ...
    else if ( var_2[0] == "playfxontagwithoffset" && ( var_2.size == 6 || var_2.size == 9 ) )
    {
        ...
        common_scripts\utility::_id_C203( var_3, var_1, var_7, var_9, var_8 );
        return 1;
    }
...
anim_handle_notetrack( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !var_2.dialoguenotetrack )
    {
        if ( isdefined( var_0["dialog"] ) && isdefined( var_2.dialog[var_0["dialog"]] ) )
        {
            ...
            var_1 animscripts\face::sayspecificdialogue( undefined, var_0["dialog"], 1.0, var_6 );
            var_2.dialog[var_0["dialog"]] = undefined;
            var_2.dialoguenotetrack = 1;
        }
        else if ( isdefined( var_0["dialog_radio"] ) && isdefined( var_2.dialog[var_0["dialog_radio"]] ) )
        {
            thread maps\_utility::radio_dialogue( var_0["dialog_radio"] );
            var_2.dialog[var_0["dialog_radio"]] = undefined;
            var_2.dialoguenotetrack = 1;
        }
    }
    ...
    if ( isdefined( var_0["selftag"] ) )
    {
        ...
        {
            var_8 = undefined;
            var_9 = common_scripts\utility::getfx( var_0["trace_part_for_efx"] );

            if ( isdefined( var_0["trace_part_for_efx_water"] ) )
                var_8 = common_scripts\utility::getfx( var_0["trace_part_for_efx_water"] );
            ...
            var_1 thread trace_part_for_efx( var_0["selftag"], var_9, var_8, var_10 );
        }
...
get_anim_position( var_0, var_1 )
{
    ...
    else if ( isdefined( level._id_D115[var_1] ) )
    {
        if ( isarray( level._id_D115[var_1] ) )
        {
            var_3 = level._id_D115[var_1]["angles"];
            var_2 = level._id_D115[var_1]["origin"];
        }
        else
        {
            var_3 = level._id_D115[var_1].angles;
...
_id_B4AF( var_0 )
{
    ...
    if ( !maps\_utility::hastag( var_1, var_0 ) )
        return 0;
...
{
    var_8 = maps\_utility::_id_C3AC();
    var_9 = get_anim_position( var_2, var_1 );
    var_10 = var_9["origin"];
    var_11 = var_9["angles"];
...
{
    var_6 = get_anim_position( var_2, var_1 );
    var_7 = var_6["origin"];
    var_8 = var_6["angles"];
...
begin_anim_reach( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( self.a._id_C55F ) )
        self.goalradius = self.a._id_C55F;
...
anim_single_solo( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    self endon( "death" );
    var_7[0] = var_0;
    ...
    anim_single( var_7, var_1, var_2, var_3, var_4, undefined, var_5, var_6 );
}
...
_id_B9B2( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = get_anim_position( undefined, var_1 );
    var_6 = var_5["origin"];
    var_7 = var_5["angles"];
    ...
    var_0 _id_BC74( var_11, var_10, var_6, var_10, var_2 );
    var_12 = var_10 - var_0 animscripts\utility::lookuptransitionanim( "cover_trans_angles", var_2, var_11._id_D54E );

    if ( !isdefined( var_3 ) )
        var_3 = 0;

    var_0 _id_BE5F( var_2, var_11, var_12, var_3 );
    var_0 reach_with_standard_adjustments_end();
    var_0 maps\_utility::ai_unignore_everything( undefined, var_9 );
}

_id_BE5F( var_0, var_1, var_2, var_3 )
{
    var_4 = animscripts\utility::lookupanim( "cover_trans", var_0 )[var_1._id_D54E];
    var_5 = getanimlength( var_4 );
    self.approachnumber = var_1._id_D54E;
    self.approachtype = var_0;
    self startcoverarrival( var_1.start_point, var_2, 0 );
    wait(var_5 - var_3);
}

_id_BC74( var_0, var_1, var_2, var_1, var_3, var_4 )
{
    if ( !isdefined( var_1 ) )
        return;
    ...
    var_1._id_D54E = _id_AA01( self, var_1, var_2, var_3 );
    var_1.start_point = animscripts\cover_arrival::getarrivalstartpos( var_1, var_2, var_3, var_1._id_D54E );
    var_6 = lengthsquared( animscripts\utility::lookuptransitionanim( "cover_trans_dist", var_3, var_1._id_D54E ) );

    while ( distancesquared( self.origin, var_1 ) > var_6 )
        wait 0.05;
}

_id_AA01( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_3 ) )
        var_3 = "exposed";
...
anim_loop_solo( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8[0] = var_7;
    anim_loop_packet( var_8, var_1, var_2, var_4 );
}
...
addnotetrack_dialogue( var_0, var_1, var_2, var_3, var_4 )
{
    var_1 = tolower( var_1 );
    var_2 = get_generic_anime( var_2 );
    var_5 = add_notetrack_and_get_index( var_0, var_1, var_2 );
    level.scr_notetrack[var_0][var_2][var_1][var_5] = [];
    level.scr_notetrack[var_0][var_2][var_1][var_5]["dialog"] = var_3;
    level.scr_notetrack[var_0][var_2][var_1][var_5]["dialog_do_notify_on_end"] = var_4;
}

_id_C4AE( var_0, var_1, var_2, var_3 )
{
    var_1 = tolower( var_1 );
    var_2 = get_generic_anime( var_2 );
    var_4 = add_notetrack_and_get_index( var_0, var_1, var_2 );
    level.scr_notetrack[var_0][var_2][var_1][var_4] = [];
    level.scr_notetrack[var_0][var_2][var_1][var_4]["dialog_radio"] = var_3;
}
...
anim_facialanim( var_0, var_1, var_2 )
{
    ...
    var_0 setanim( %scripted_talking, level._id_A9CE, 0.2 );
...
force_face_anim_to_play( var_0, var_1, var_2 )
{
    ...
    {
        disabledefaultfacialanims();
        var_0 setanim( %scripted_talking, level._id_A9CE, 0.4 );
...
anim_facialfiller( var_0, var_1 )
{
    ...
    self setanim( %scripted_talking, level._id_A9CE, 0.4 );
    disabledefaultfacialanims();
    set_talker_until_msg( var_0, var_3 );
    var_2 = 0.3;
    self clearanim( %scripted_talking, level._id_D44D );
...
clearfaceanimonanimdone( var_0, var_1, var_2 )
{
    ...
    var_3 = 0.3;
    var_0 clearanim( %scripted_talking, level._id_D44D );
    disabledefaultfacialanims( 0 );
}
...
_id_B6DB( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( var_0 ) )
        self endon( var_0 );
    ...
    for ( var_6 = 0; var_6 <= var_5; var_6++ )
    {
        ...
        var_8 = maps\_utility::euler_lerp( var_1.angles, var_2.angles, var_6 / var_5 );
        self _meth_8598( var_7, var_8 );
        wait(var_4);
    }
}

_id_B0F7( var_0, var_1, var_2, var_3, var_4 )
{
    self endon( var_0 );
    var_5 = 0.05;
    ...
    for ( var_7 = 0; var_7 <= var_6; var_7++ )
    {
        ...
        var_11 = maps\_utility::euler_lerp( var_1.angles, var_9, var_7 / var_6 );
...
_id_B695( var_0, var_1, var_2, var_3 )
{
    self endon( var_0 );
    var_4 = _func_315( var_3.origin, var_3.angles, var_1 );
    var_5 = playerphysicstrace( var_4 + ( 0.0, 0.0, 40.0 ), var_4 + ( 0.0, 0.0, -40.0 ) );
    ...
    _id_B6DB( var_0, var_3, var_7, var_8 - var_2 );
}
...
_id_D101( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0.05;
    var_6 = var_0 gettagangles( "tag_player" );
    var_7 = length( self.origin - var_0.origin );
    var_8 = self getplayerangles() - var_6;
    var_8 = ( animscripts\utility::absangleclamp180( var_8[0] ), animscripts\utility::absangleclamp180( var_8[1] ), animscripts\utility::absangleclamp180( var_8[2] ) );
    var_9 = var_4 - var_3;
    var_10 = length( var_8 );
    var_11 = var_9 * clamp( var_7 / var_1, 0, 1 );
    var_12 = var_9 * clamp( var_10 / var_2, 0, 1 );
    var_13 = common_scripts\utility::ter_op( var_11 > var_12, var_11, var_12 );
