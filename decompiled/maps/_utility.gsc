...
_id_D0CA( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( self._id_C427 ) )
        self._id_C427 = 0;
    ...
    for ( var_7 = 0; var_7 < var_6.size; var_7++ )
        _id_B527( var_5, 4 - var_7, var_6[var_7] );
}
...
settimeformat( var_0, var_1 )
{
    ...
    var_3 = rounddecimalplaces( var_0 - var_2, 2 ) * 100;
...
_id_B213( var_0 )
{
    return !isdefined( level._id_B5D6 ) || [[ level._id_B5D6 ]]( var_0 );
}

set_vision_set( var_0, var_1, var_2 )
{
    if ( isdefined( level._id_C5B3 ) )
        [[ level._id_C5B3 ]]( var_0 );

    if ( !isdefined( var_2 ) )
        var_2 = 0;

    if ( !var_2 && !_id_B213( var_0 ) )
        return;
...
_id_CEE3( var_0 )
{
    return !isdefined( level._id_C34A ) || [[ level._id_C34A ]]( var_0 );
}

_id_BF21( var_0, var_1 )
{
    if ( isdefined( level._id_CC6F ) )
        [[ level._id_CC6F ]]( var_0 );

    if ( !isdefined( var_1 ) )
        var_1 = 0;

    if ( !var_1 && !_id_CEE3( var_0 ) )
        return;

    level.player._id_B636 = var_0;
    self lightset( level.player._id_B636 );
}
...
_id_D403()
{
    var_0 = level.player getplayerdata( common_scripts\utility::_id_AC0E(), "career", "duration_total_seconds" );

    if ( isdefined( var_0 ) )
    {
        var_0 += int( ( gettime() - level._id_CC1F ) / 1000 );
        level.player setplayerdata( common_scripts\utility::_id_AC0E(), "career", "duration_total_seconds", var_0 );
    }
}
...
level_end_save()
{
    ...
    var_2 = level.player getplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "level_complete" );

    if ( isdefined( var_2 ) )
    {
        if ( !var_2 )
        {
            level.player setplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "level_complete", 1 );
            level.player setplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "level_completion_timestamp", gettimeutc() );
        }

        var_3 = level.player getplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "current_playtrough_kills" );
        var_4 = level.player getplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "current_playtrough_deaths" );
        var_5 = level.player getplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "average_kills" );
        var_6 = level.player getplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "average_deaths" );
        var_7 = level.player getplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "completed_playtrough" );
        ...
        if ( isdefined( var_3 ) && isdefined( var_5 ) && isdefined( var_6 ) && isdefined( var_4 ) && isdefined( var_7 ) )
        {
            ...
            level.player setplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "completed_playtrough", var_7 );
            level.player setplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "average_kills", int( var_5 ) );
            level.player setplayerdata( common_scripts\utility::_id_AC0E(), "career", "campaign", level.gameskill, "levels", level.script, "average_deaths", var_6 );
        }
    }

    var_8 = "levelshots / autosave / autosave_" + level.script + "end";
...
autosave_stealth()
{
    thread autosave_by_name_thread( "autosave_stealth", 8, 0 );
}

autosave_stealth_silent()
{
    thread autosave_by_name_thread( "autosave_stealth", 8, 0, 1 );
}
...
_id_B3E2()
{
    return common_scripts\_exploder::_id_B788();
}
...
_id_D1A5( var_0 )
{
    if ( !isdefined( level.player._id_B5A4 ) )
    {
        level.player thread _id_AB2F();
        level.player._id_B5A4 = [];
    }

    level.player._id_B5A4[level.player._id_B5A4.size] = var_0;
}

_id_C907( var_0 )
{
    if ( isdefined( level.player._id_B5A4 ) && is_in_array( level.player._id_B5A4, var_0 ) )
        level.player._id_B5A4 = common_scripts\utility::array_remove( level.player._id_B5A4, var_0 );
}
...
_id_AB2F()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.player._id_B5A4 ) )
        {
            if ( common_scripts\utility::array_contains( level.player._id_B5A4, var_0 ) )
...
{
    animscripts\battlechatter_ai::custom_battlechatter_internal( var_0 );
}
...
missionfailedwrapper( var_0 )
{
    ...
    maps\_hud_util::hud_stats_display_kill();
}
...
script_delay( var_0 )
{
    ...
    else if ( isdefined( var_0 ) && isdefined( self.script_delay_min ) && isdefined( var_0.always_use_delay_min ) && var_0.always_use_delay_min )
    {
...
disable_ai_color()
{
    ...
    level.arrays_of_colorforced_ai[_id_B897()][self.script_forcecolor] = common_scripts\utility::array_remove( level.arrays_of_colorforced_ai[_id_B897()][self.script_forcecolor], self );
...
_id_B897()
{
    if ( _id_C2E6( self ) && isdefined( self.script_team ) )
...
set_force_color( var_0 )
{
    ...
    level.arrays_of_colorforced_ai[_id_B897()][self.script_forcecolor] = common_scripts\utility::array_add( level.arrays_of_colorforced_ai[_id_B897()][self.script_forcecolor], self );
    thread maps\_utility_code::_id_BF0F( var_1 );
}
...
issue_color_orders( var_0, var_1 )
{
    ...
    for ( var_5 = 0; var_5 < var_2.size; var_5++ )
    {
        level._id_CC96[var_1][var_2[var_5]] = common_scripts\utility::array_removeundefined( level._id_CC96[var_1][var_2[var_5]] );

        for ( var_7 = 0; var_7 < level._id_CC96[var_1][var_2[var_5]].size; var_7++ )
            level._id_CC96[var_1][var_2[var_5]][var_7].currentcolorcode = var_2[var_5];
    }
...
ninebanghandler( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_12, var_8 in var_6 )
    {
        ...
        thread soundscripts\_audio::_id_C69A();
...
flashmonitor()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.player.nightvision_enabled ) && level.player.nightvision_enabled )
            level.player lightset2( level._id_AD67, 0.1 );
        else
            self lightset3( 0.1 );
...
_id_BC6C( var_0 )
{
    ...
    else
    {
        ...
        {
            if ( level.createfxent[var_2].v["fxid"] == var_0 )
                return level.createfxent[var_2];
        }
    }
...
dronespawn_bodyonly( var_0 )
{
    ...
    if ( isdefined( var_0.script_parameters ) && var_0.script_parameters == "exec_spawn_func" )
    {
        var_1 _id_C0C3::cheat_init();
        var_1 _id_B190::ts_init();
        var_1.spawn_funcs = var_0.spawn_functions;
        var_1 thread maps\_spawner::run_spawn_functions();
        var_1.spawner = var_0;
    }

    var_1 maps\_spawner::character_model_specialcases();
    return var_1;
}
...
add_hint_string( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) )
        level._id_AB81[var_0] = var_3;

    if ( isdefined( var_4 ) )
        level._id_D14E[var_0] = var_4;
}
...
activate_trigger_process( var_0 )
{
    ...
    {
        self._id_D500 = 1;
        maps\_colors::_id_CC4A( "allies" );
    }

    if ( isdefined( self.script_color_axis ) )
    {
        self._id_D500 = 1;
        maps\_colors::_id_CC4A( "axis" );
    }
...
_id_BA9E( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    maps\_utility_code::_id_D18D( level.player, var_0, var_1, var_2, var_3, var_4, var_5, var_6 );
}

_id_AC01( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
...
_id_AF14( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
...
display_hint( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( level.trigger_hint_func[var_0] ) )
    {
        ...
        var_6 thread maps\_utility_code::hintprint( level.trigger_hint_string[var_0], level.trigger_hint_func[var_0], var_1, var_2, var_3, var_7, undefined, var_4, level._id_AB81[var_0], level._id_D14E[var_0] );
    }
    else
        var_6 thread maps\_utility_code::hintprint( level.trigger_hint_string[var_0], undefined, undefined, undefined, undefined, var_7, undefined, var_4, level._id_AB81[var_0], level._id_D14E[var_0] );
}
...
hintdisplaymintimehandler( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    maps\_utility_code::hintdisplayhandlersetup( var_0 );
    var_6 thread maps\_utility_code::hintprint( level.trigger_hint_string[var_0], level.trigger_hint_func[var_0], var_3, var_4, var_5, var_1, var_2, undefined, level._id_AB81[var_0], level._id_D14E[var_0] );
}

add_control_based_hint_strings( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( level.trigger_hint_string ) )
    {
        level.trigger_hint_string = [];
...
display_hint_timeout( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_6 thread maps\_utility_code::hintprint( level.trigger_hint_string[var_0], level.trigger_hint_func[var_0], var_2, var_3, var_4, var_1, undefined, var_5, level._id_AB81[var_0], level._id_D14E[var_0] );
}
...
spawn_ai( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) && var_1 && isalive( var_2 ) )
        var_2 thread magic_bullet_shield();
...
objective_complete( var_0, var_1 )
{
...
set_console_status()
{
    ...
    if ( !isdefined( level._id_AF4C ) )
        level._id_AF4C = getdvar( "pcUWPGame" ) == "true";
    else
    {
...
_id_B43E( var_0 )
{
    ...
    if ( !isdefined( level._id_AC31 ) )
        level._id_AC31 = ::_id_BB2A;

    if ( !isdefined( level._id_B6F5 ) )
    {
        level._id_B6F5 = [];
        level._id_B6F5["snow"] = 1;
        level._id_B6F5["ice"] = 1;
        level._id_B6F5["slush"] = 1;
        level._id_B6F5["mud"] = 1;
    }
    ...
    for (;;)
    {
        ...
        var_6 = undefined;
        var_7 = 1;
        var_8 = common_scripts\utility::ter_op( var_4, 1.0, -1.0 );
        ...
        var_14 = self.origin + var_9 + ( 0.0, 0.0, 2.5 );
        var_15 = var_14 - ( 0.0, 0.0, 7.5 );
        var_16 = bullettrace( var_14, var_15, 0, undefined );

        if ( var_16["fraction"] < 1 && var_16["fraction"] > 0 && var_16["surfacetype"] != "none" )
        {
            var_17 = anglestoforward( combineangles( self.angles, var_10 ) ) * -1;
            var_18 = var_16["normal"];
            [[ level._id_AC31 ]]( var_5, var_6, var_16["surfacetype"], var_16["position"], var_18, var_17 );
        }
    }
}

_id_BB2A( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = var_0 + "_" + var_2;
    ...
    var_7 = common_scripts\utility::fxexists( var_6 ) && isdefined( level._id_B6F5[var_2] );

    if ( var_7 )
        playfx( common_scripts\utility::getfx( var_6 ), var_3, var_4, var_5 );
}
...
{
    return ( is_demo() || common_scripts\utility::flag( "has_cheated" ) || _id_C0C3::_id_AD40() ) && !( var_0 == "THE_ROAD_LESS_TRAVELED" || var_0 == "LEAVE_NO_STONE_UNTURNED" );
}
...
_id_B139( var_0, var_1, var_2, var_3 )
{
    slowmo_setspeed_slow( var_0 );
    slowmo_setlerptime_in( var_1 );
    slowmo_lerp_in();

    for ( var_4 = 0; var_4 < var_3; var_4++ )
        waitframe();

    slowmo_setlerptime_out( var_2 );
    slowmo_lerp_out();
}
...
_id_C55A( var_0, var_1 )
{

}

_id_D4F3( var_0, var_1, var_2 )
{
    if ( getdvar( "arcademode" ) != "1" )
        return;

    thread _id_D36F::_id_B189( var_0, 1, var_1, var_2 );
}

_id_D38E( var_0, var_1, var_2 )
{
...
player_is_near_live_grenade()
{
    ...
    for ( var_1 = 0; var_1 < var_0.size; var_1++ )
    {
        ...
        if ( issubstr( var_2.model, "claymore" ) || issubstr( var_2.model, "soccer_ball" ) )
            continue;
...
_id_C3A2( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    level.player endon( "stop_opening_fov" );
    wait(var_0);
    level.player playerlinktodelta( var_1, var_2, 1, var_3, var_4, var_5, var_6, 1 );
...
beginsliding( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = self;

    if ( !isdefined( var_3 ) || !isdefined( level.scr_anim["worldbody"] ) || !isdefined( level.scr_anim["worldbody"]["slide_in"] ) )
        var_3 = 0;

    if ( !isdefined( var_4 ) || !isdefined( level.scr_anim["worldbody"] ) || !isdefined( level.scr_anim["worldbody"]["slide_back_in"] ) )
        var_4 = 0;
    ...
    var_7 thread play_sound_on_entity( "foot_slide_plr_start" );

    if ( soundexists( "foot_slide_plr_loop" ) )
        var_7 thread play_loop_sound_on_tag( "foot_slide_plr_loop", undefined, 1, 1, 0.5, 0.5 );

    var_9 = isdefined( level.custom_linkto_slide );

    if ( !isdefined( var_0 ) )
        var_0 = var_7 getvelocity() + ( 0.0, 0.0, -10.0 );
    ...
    if ( var_3 )
    {
        var_7.slidemodel = spawn_anim_model( "worldbody", var_7.origin, var_7.angles );
        var_7.slidemodel hide();
    }
    else
    {
        var_7.slidemodel = spawn( "script_origin", var_7.origin );
        var_7.slidemodel.angles = var_7.angles;
    }

    var_10 = var_7.slidemodel;
    var_10 ent_flag_init( "sliding_out" );

    if ( !var_8 )
        var_10 moveslide( ( 0.0, 0.0, 15.0 ), 15, var_0 );
    ...
    {
        var_11 = common_scripts\utility::ter_op( var_4, 25, 20 );
    ...
    var_7 thread maps\_utility_code::_id_ACF0( var_10 );
    ...
    if ( var_3 )
    {
        ...
        var_12 = common_scripts\utility::ter_op( var_4, "slide_back_in", "slide_in" );
        var_13 = 0.05;
        var_14 = floor( getanimlength( level.scr_anim["worldbody"][var_12] ) / var_13 ) * var_13;

        if ( var_8 )
        {
            wait 0.25;
            var_10 show();
            var_10 animscripted( "slide_in_scripted", var_5.origin, var_5.angles, level.scr_anim["worldbody"][var_12] );
            var_5 thread maps\_anim::start_notetrack_wait( var_10, "slide_in_scripted", var_12, "worldbody" );
            var_5 thread maps\_anim::animscriptdonotetracksthread( var_10, "slide_in_scripted", var_12 );
            wait(var_14);
            var_7 allowprone( 0 );
            var_7 allowcrouch( 1 );
            var_7 allowstand( 0 );
            var_7 _meth_85A4( 0 );
            var_10 _id_B7FB( var_4, 1, var_7 );
            var_10 moveslide( ( 0.0, 0.0, 15.0 ), 15, var_0 );
        }
        else
        {
            var_10 setflaggedanim( "slide_in", level.scr_anim["worldbody"][var_12] );
            thread maps\_anim::start_notetrack_wait( var_10, "slide_in", var_12, "worldbody" );
            thread maps\_anim::animscriptdonotetracksthread( var_10, "slide_in", var_12 );
            var_10 delaythread( var_14, ::_id_B7FB, var_4, 0, var_7 );
            wait 0.25;
            var_10 show();
        }
    }
    ...
    var_7 thread maps\_utility_code::doslide( var_10, var_1, var_2, var_3, var_4 );
}

endsliding( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = self;
    var_5.slidemodel ent_flag_set( "sliding_out" );

    if ( !isdefined( var_0 ) || !isdefined( level.scr_anim["worldbody"] ) || !isdefined( level.scr_anim["worldbody"]["slide_in"] ) )
        var_0 = 0;

    if ( !isdefined( var_1 ) || !isdefined( level.scr_anim["worldbody"] ) || !isdefined( level.scr_anim["worldbody"]["slide_back_in"] ) )
        var_1 = 0;
    ...
    var_5 thread play_sound_on_entity( "foot_slide_plr_end" );

    if ( var_0 )
    {
        thread h2_sliding_cinematic( "completed" );
        var_6 = common_scripts\utility::ter_op( var_1, "slide_back_loop", "slide_loop" );
        var_7 = common_scripts\utility::ter_op( var_1, "slide_back_out", "slide_out" );
        var_8 = level.scr_anim["worldbody"][var_7];
        var_5.slidemodel clearanim( level.scr_anim["worldbody"][var_6][0], 0 );
        var_5.slidemodel setflaggedanim( "slide_out", var_8 );
        thread maps\_anim::start_notetrack_wait( var_5.slidemodel, "slide_out", var_7, "worldbody" );
        thread maps\_anim::animscriptdonotetracksthread( var_5.slidemodel, "slide_out", var_7 );
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            while ( var_9 > var_10 )
            {
                var_5.slidemodel.slidevelocity *= ( 1 - var_3 );
                var_10 += var_11;
                wait(var_11);
            }
        }
    ...
    if ( var_2 )
        var_5 setvelocity( var_5.slidemodel.slidevelocity );

    var_5 unlink();
    var_5.slidemodel delete();

    if ( var_0 )
    {
        var_12 = playerphysicstrace( level.player.origin + ( 0.0, 0.0, 40.0 ), level.player.origin + ( 0.0, 0.0, -100.0 ) );
...
h2_sliding_cinematic( var_0 )
{
    ...
    switch ( var_0 )
    {
        case "started":
            ...
            var_1 _id_D397::_id_BEA0( var_2 ) _id_D397::_id_C491( 12.0, 500, 16.0, 16.0 ) _id_D397::_id_AF9C();
            var_1 _id_D397::_id_BEA0( var_3 ) _id_D397::_id_BAE4( 2 );
            var_1 _id_D397::_id_BEA0( var_4 ) _id_D397::_id_AC9F( level.slideoldfov + 12, 0.5 );
            break;
        case "completed":
            switch ( level.script )
            {
            ...
            var_1 _id_D397::_id_BEA0( 0.0 ) _id_D397::_id_C491( 24.0, 500, 2.0, 2.0 ) _id_D397::_id_AF9C();
            var_1 _id_D397::_id_BEA0( 0.4 ) _id_D397::_id_BAE4( 0 );
            var_1 _id_D397::_id_BEA0( 0.5 ) _id_D397::_id_BF3F() _id_D397::_id_B687();
            var_1 _id_D397::_id_BEA0( var_4 ) _id_D397::_id_AC9F( level.slideoldfov, 0.55 );
            break;
    }
...
disable_heat_behavior()
{
    ...
    self.maxfaceenemydist = _func_2EE();
...
hint( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_2 ) )
        var_2 = 0;
    ...
    maps\_hud_util::add_hint_background( var_3, var_2, 0.5, var_4 );
    level.hintelement = maps\_hud_util::createfontstring( "timer", 0.5 );
    level.hintelement maps\_hud_util::setpoint( "TOP", undefined, 0, 127 + var_5 );
    ...
    level.hintelement fadeovertime( var_6 );
    level.hintelement.alpha = 0;
    maps\_hud_util::_id_A889( var_6 );
    wait(var_6);
...
precache_destructible( var_0 )
{
    ...
    var_2 = spawnstruct();
    var_2._id_C9DC = _id_C511::_id_B8EC( var_0 );
...
{
    var_2 = bullettrace( var_0 + ( 0.0, 0.0, 15.0 ), var_0 - ( 0.0, 0.0, 60.0 ), 0 );

    if ( var_2["fraction"] < 1 && var_2["fraction"] > 0 && var_2["surfacetype"] != "none" )
    {
        var_3 = screen_effect_sides( var_0 );

        foreach ( var_7, var_5 in var_3 )
        {
            var_6 = maps\_detonategrenades::getgrenadeexplosionfx( var_7, var_2["surfacetype"] );

            if ( isdefined( var_6 ) )
                playfx( var_6, level.player.origin );
        }
    }
}
...
_id_CE26()
{
    ...
    if ( var_0 == level.player )
    {
        ...
        if ( !isdefined( var_1._id_B874 ) || !isdefined( var_1._id_B874[var_2] ) )
            var_1._id_B874[var_2] = 0;

        var_1._id_B874[var_2]++;

        if ( var_1._id_B874[var_2] == 3 )
...
logbreadcrumbdatasp()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 != undefined )
        {
            var_1 = var_0[4];
            var_2 = gettime();
            _func_2E3( level.player, var_1, var_2 );
        }
...
_id_D414( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_4 ) && _id_D539( var_4 ) )
        return;

    if ( !isdefined( var_3 ) || !_id_D539( var_3 ) )
        common_scripts\utility::flag_wait( var_1 );

    animscripts\utility::_id_BA45( var_0, 1 );

    if ( isdefined( var_2 ) )
    {
        common_scripts\utility::flag_wait( var_2 );
        animscripts\utility::_id_BA45( var_0, 0 );
    }
}

_id_C3AC()
{
    if ( isdefined( level._id_AD57 ) )
        level._id_AD57++;
    else
        level._id_AD57 = 0;

    return level._id_AD57;
}

_id_D325( var_0, var_1, var_2, var_3 )
{
    for ( var_4 = 0; var_4 < level.players.size; var_4++ )
    {
        if ( !level.players[var_4] player_looking_at( var_0, var_1, var_2, var_3 ) )
...
_id_B75A( var_0, var_1, var_2 )
{
    var_3 = level create_blend( maps\_utility_code::_id_AE34, var_0, var_1 );
    var_3.time = var_2;
}

_id_B215( var_0, var_1 )
{
    foreach ( var_3 in var_0 )
    {
        var_4 = common_scripts\utility::array_remove( var_0, var_3 );
        var_3 thread _id_B7F7( var_4, var_1 );
    }
}
...
_id_B7F7( var_0, var_1 )
{
    ...
    if ( !isdefined( var_2._id_AE4F ) )
        var_2._id_AE4F = 0.8;

    if ( !isdefined( var_2._id_BA6F ) )
        var_2._id_BA6F = 0.5;

    if ( !isdefined( var_2._id_C359 ) )
        var_2._id_C359 = 1.0;

    if ( !isdefined( var_2._id_B062 ) )
        var_2._id_B062 = 60;

    self._id_B494 = self.moveplaybackrate;
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_3 ) && common_scripts\utility::within_fov( self.origin, self.angles, var_3.origin, cos( var_2._id_B062 ) ) )
        {
            if ( self.moveplaybackrate > var_3.moveplaybackrate )
                self.moveplaybackrate = clamp( var_3.moveplaybackrate * var_2._id_AE4F, var_2._id_BA6F, var_3.moveplaybackrate );
            else
                self.moveplaybackrate = clamp( self._id_B494 * var_2._id_AE4F, var_2._id_BA6F, self._id_B494 );

            wait(var_2._id_C359);
        }
        else
            self.moveplaybackrate = self._id_B494;

        wait 0.05;
    }

    self.moveplaybackrate = self._id_B494;
    self._id_B494 = undefined;
    ent_flag_clear( "stop_keep_distance" );
}

_id_C4A8( var_0, var_1 )
{
    for ( var_2 = 0; var_2 < var_0.size; var_2++ )
    {
        common_scripts\utility::delaycall( var_0[var_2].delay, ::playrumblelooponentity, var_0[var_2].rumble );
...
_id_C92C( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15 )
{
    self endon( "death" );
    var_16 = 0;
    ...
    var_18 = 1;
    self._id_B3CE = 0;
    self._id_AC49 = gettime();

    if ( !isdefined( self._id_BA26 ) )
        self._id_BA26 = [];

    var_19 = self._id_BA26.size;
    self._id_BA26[var_19] = 1;
    childthread _id_AE12();
    ...
    for (;;)
    {
        ...
        if ( _id_A92C( var_0, var_2, var_3, var_4, var_5 ) )
        {
            self allowmelee( 0 );
            var_18 = 0;
            self._id_BA26[var_19] = 0;

            if ( !var_16 && var_17 )
            {
                level thread hint( var_10 );
                var_16 = 1;
            }
            ...
            if ( self meleebuttonpressed() )
            {
                ...
                {
                    var_21.allowdeath = 0;
                    var_21 set_ignoreme( 1 );
                    var_21 set_ignoreall( 1 );
                }
                ...
                if ( var_23 || var_24 )
                {
                    self._id_C309 = spawn_anim_model( "worldbody" );
                    self._id_C309 hide();
                    ...
                    if ( var_23 )
                    {
                        ...
                        self._id_C309 attach( var_8, "tag_knife_attach", 1 );
                    }
                    ...
                    if ( var_24 )
                    {
                        ...
                        self._id_C309 attach( var_9, "tag_knife_attach2", 1 );
                    }
                }
                ...
                if ( isdefined( var_13 ) )
                {
                    var_28 maps\_anim::anim_first_frame_solo( level.player._id_C309, var_1 );
                    var_6 = maps\_anim::_id_D101( level.player._id_C309, var_2, var_3, var_6, var_13 );
                }

                setsaveddvar( "compass", 0 );
                setsaveddvar( "hud_showStance", 0 );
                setsaveddvar( "actionSlotsHide", 1 );
                var_28 _id_C0F0( var_1, var_29, var_32, var_6, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, var_12 );
                wait 0.05;
                ...
                if ( isdefined( var_14 ) )
                {
                    level.player setlocalplayerprofiledata( "sp_doItWithStyle", var_14, 1 );
                ...
                foreach ( var_21 in var_0 )
                {
                    if ( !_func_2A5( var_21 ) )
                    {
                        var_21.disabledamagefeedbacksnd = 1;
                        var_21.skipdeathsound = 1;
                        var_21.skiphitmarker = 1;
                        thread _id_CD8F( var_21 );
                        var_21 notify( "stealth_takedown_ended" );

                        if ( var_0.size > 1 && ( isdefined( level._id_B5A0 ) && level._id_B5A0 || isdefined( level._id_B5C6 ) && level._id_B5C6 ) )
                            wait 0.05;
                    }
                }
...
_id_CD8F( var_0 )
{
    ...
    if ( level.script == "ending" )
        var_0._id_A87F.martyr_ignore = 1;

    var_0.allowdeath = 1;
    var_0.a.nodeath = 1;
    var_0 set_battlechatter( 0 );
    _id_B190::_id_D55F( var_0 );
    var_0 kill( var_0.origin, level.player );
    thread _id_C0C3::cheat_death_corpse_check();
}

_id_A92C( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( self._id_CD51 ) && !self._id_CD51 )
        return 0;
    ...
    {
        if ( !isalive( var_8 ) || var_8.alertlevel != "noncombat" && ( !isdefined( var_8.stealth_grace_window_end_in_ms ) || var_8.stealth_grace_window_end_in_ms < gettime() ) )
            var_6 = 0;
    }

    if ( var_6 && level.player getstance() != "prone" && !level.player ismeleeing() && gettime() > self._id_AC49 )
    {
        var_10 = cos( var_2 );
        var_11 = cos( var_3 );
        var_12 = ( 0.0, 0.0, 0.0 );
        ...
        {
            var_12 += var_0[var_16].origin;
            var_17 = var_0[var_16] geteye();
            var_18 = var_17[2] - var_0[var_16].origin[2];
            var_13 += ( var_0[var_16].origin + ( 0, 0, var_18 * 0.5 ) );
            var_14 += var_17;
            var_19 = ( var_0[var_16].angles[0], var_0[var_16].angles[1] + var_4, var_0[var_16].angles[2] );
            var_20 = vectordot( anglestoforward( self.angles ), anglestoforward( var_19 ) );
            var_15 = var_15 && var_20 > var_11;
        }

        var_12 /= var_0.size;

        if ( distancesquared( var_12, level.player.origin ) < var_1 * var_1 )
        {
            if ( level.player issprinting() )
            {
                foreach ( var_8 in var_0 )
                {
                    var_8.alertlevel = "alert";
                    var_8.ignoreall = 0;
                }
            }
            else
            {
                var_23 = player_looking_at( var_12, var_10, 1 ) || player_looking_at( var_13, var_10, 1 ) || player_looking_at( var_14, var_10, 1 );
                var_5 = var_15 && var_23;
            }
        }
    }
...
_id_C0F0( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13 )
{
    _id_B556( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_13 );
    _id_BD3F( var_2, var_4, var_11, var_12 );
}

_id_CA12( var_0, var_1 )
{
    _id_C0F0( var_0, var_1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, 1 );
}

_id_B556( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    if ( !isdefined( var_3 ) )
        var_3 = 0;
    ...
    if ( !isdefined( level.player._id_C309 ) )
    {
        if ( isdefined( level.scr_model["worldbody"] ) )
            level.player._id_C309 = spawn_anim_model( "worldbody" );
        else if ( isdefined( level.scr_model["worldhands"] ) )
            level.player._id_C309 = spawn_anim_model( "worldhands" );
        else
        {
    ...
    if ( isarray( var_1 ) )
        var_13 = common_scripts\utility::array_add( var_1, level.player._id_C309 );
    else
        var_13 = make_array( level.player._id_C309, var_1 );
    ...
    {
        var_14 = spawnstruct();
        var_14.origin = level.player.origin;
        var_14.angles = level.player.angles;
    }

    var_14 maps\_anim::anim_first_frame_solo( level.player._id_C309, var_0, var_10 );
    ...
    if ( var_3 > 0 )
    {
        level.player playerlinktoblend( level.player._id_C309, "tag_player", var_3, var_3 * 0.25, var_3 * 0.25 );
        wait(var_3);
    }
    else if ( isdefined( var_5 ) && var_5 )
        level.player playerlinktodelta( level.player._id_C309, "tag_player", 1.0, var_7, var_6, var_8, var_9 );
    else
        level.player playerlinktoabsolute( level.player._id_C309, "tag_player" );

    level.player _meth_8491();
    waittillframeend;
    wait 0.05;
    ...
    if ( isdefined( var_12 ) )
    {
        var_18 = level.player._id_C309 getanim( var_0 );
        var_19 = getanimlength( var_18 );
        level.player._id_C309 thread maps\_anim::_id_B695( "player_anim_height", var_18, var_19 - var_12, var_14 );
    }

    level.player._id_C309 show();
    var_14 maps\_anim::anim_single( var_13, var_0, var_10 );

    foreach ( var_21 in var_13 )
    {
        if ( isdefined( var_21 ) && var_21.code_classname == "misc_turret" )
            var_21 clearanim( var_21 getanim( var_0 ), 0 );
    }
}

_id_BD3F( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_1 ) )
        var_1 = 0;
    ...
    if ( isdefined( var_0 ) && var_0 )
    {
        var_4 = playerphysicstrace( level.player.origin + ( 0.0, 0.0, 40.0 ), level.player.origin + ( 0.0, 0.0, -100.0 ) );
        level.player setorigin( var_4 );
    }
}

_id_B7FB( var_0, var_1, var_2 )
{
    var_2 endon( "death" );
    ...
    {
        var_3 = common_scripts\utility::ter_op( var_0, "slide_back_in", "slide_in" );
        self clearanim( level.scr_anim["worldbody"][var_3], 0 );
    }

    if ( ent_flag( "sliding_out" ) )
        return;

    var_4 = common_scripts\utility::ter_op( var_0, "slide_back_loop", "slide_loop" );
    self setflaggedanim( "slide_loop", level.scr_anim["worldbody"][var_4][0] );

    if ( !var_0 )
    {
        self setanimlimited( level.scr_anim["worldbody"]["slide_al"], 1 );
        self setanimlimited( level.scr_anim["worldbody"]["slide_ar"], 1 );
    }

    thread maps\_anim::start_notetrack_wait( self, "slide_loop", var_4, "worldbody" );
    thread maps\_anim::animscriptdonotetracksthread( self, "slide_loop", var_4 );
}

_id_C55C( var_0 )
{
    if ( level.player common_scripts\utility::is_player_gamepad_enabled() && isdefined( var_0 ) )
    {
...
_id_BD5A( var_0, var_1, var_2, var_3, var_4 )
{
    _id_B65B();
    ...
    var_5 = 0;
    var_6 = common_scripts\utility::_id_D5D2();

    if ( var_6 == "LANGUAGE_TRADITIONAL_CHINESE" || var_6 == "LANGUAGE_SIMPLIFIED_CHINESE" )
        var_5 = 3;

    level.player._id_CC41 = [];
    level.player._id_A800 = 0.7;

    if ( level.player common_scripts\utility::is_player_gamepad_enabled() )
    {
        var_7 = 1.5 * level.player._id_A800;
        var_8 = int( 30 * level.player._id_A800 );
        var_9 = int( 30 * level.player._id_A800 );
        var_10 = 0.2;
        var_11 = 0.1;
        var_12 = _id_C55C( var_4 );

        if ( var_12 )
        {
            var_7 = 1.15 * level.player._id_A800;
            var_8 = 0;
            var_9 = 0;
        ...
        level.player._id_B1FD = level.player maps\_hud_util::createclientfontstring( "timer", var_7 );
        level.player._id_B1FD.color = ( 1.0, 1.0, 1.0 );
        level.player._id_B1FD settext( var_0 );
        level.player._id_B1FD.x = 0;
        level.player._id_B1FD.y = 18.5 + var_2 + var_5;
        level.player._id_B1FD.alpha = 0;
        level.player._id_B1FD.sort = -1;
        level.player._id_B1FD._id_B97D = 1;
        level.player._id_B1FD._id_B20B = var_7;
        level.player._id_B1FD._id_C599 = var_12;
        var_13 = maps\_hud_util::createicon( "h2_prompt_anticipation", var_9, var_8 );
        var_13.color = ( 1.0, 1.0, 1.0 );
        var_13.x = var_10;
        var_13.y = 20 + var_2 + var_11;
        var_13.alpha = 0;
        var_13.sort = -2;
        var_13._id_B97D = 0.75;

        if ( !level.player._id_B1FD._id_C599 )
        {
            var_13._id_C07F = 0.25;
            var_13._id_B7C0 = 1;
            var_13._id_C3E1 = int( 30 * level.player._id_A800 );
            var_13._id_B7CF = int( 30 * level.player._id_A800 );
            var_13._id_BC01 = int( ( var_13._id_C3E1 - 12 ) * level.player._id_A800 );
            var_13._id_AB9F = int( ( var_13._id_B7CF - 12 ) * level.player._id_A800 );
        }
        else
        {
            var_13._id_C07F = 0.25;
            var_13._id_B7C0 = 0;
            var_13._id_C3E1 = int( 35 * level.player._id_A800 );
            var_13._id_B7CF = int( 10 * level.player._id_A800 );
            var_13._id_BC01 = 0;
            var_13._id_AB9F = 0;
        }

        var_13._id_C5FE = 0.3;
        level.player._id_B628 = var_13;
        level.player._id_CC41[0] = level.player._id_B628;
        level.player._id_CC41[1] = level.player._id_B1FD;
    }
    else
    {
        var_7 = 0.65;
        level.player._id_B1FD = level.player maps\_hud_util::createclientfontstring( "timer", var_7 );
        level.player._id_B1FD.color = ( 1.0, 1.0, 1.0 );
        level.player._id_B1FD settext( var_1 );
        level.player._id_B1FD.x = 0;
        level.player._id_B1FD.y = 20 + var_2;
        level.player._id_B1FD.sort = -1;
        level.player._id_B1FD.alpha = 0.25;
        level.player._id_B1FD.hidewhendead = 1;
        level.player._id_B1FD._id_B97D = 1;
        level.player._id_B69D = maps\_hud_util::createicon( "h1_hud_tutorial_blur", 225, 20 );
        level.player._id_BA40 = maps\_hud_util::createicon( "h1_hud_tutorial_border", 225, 1 );
        level.player._id_C383 = maps\_hud_util::createicon( "h1_hud_tutorial_border", 225, 1 );
        level.player._id_B69D.y = 20 + var_2;
        level.player._id_B69D.sort = -3;
        level.player._id_B69D.alpha = 0.1;
        level.player._id_B69D.hidewhendead = 1;
        level.player._id_B69D._id_B97D = 0.9;
        level.player._id_B69D.base_width = 225;
        level.player._id_B69D.base_height = 20;
        level.player._id_B69D.pulse_width = 240;
        level.player._id_B69D.pulse_height = 20;
        level.player._id_BA40.y = 10 + var_2;
        level.player._id_BA40.sort = -2;
        level.player._id_BA40.alpha = 0.02;
        level.player._id_BA40.hidewhendead = 1;
        level.player._id_BA40._id_B97D = 0.05;
        level.player._id_BA40.base_width = 225;
        level.player._id_BA40.base_height = 1;
        level.player._id_BA40.pulse_width = 240;
        level.player._id_BA40.pulse_height = 1;
        level.player._id_C383.y = 30 + var_2;
        level.player._id_C383.sort = -2;
        level.player._id_C383.alpha = 0.02;
        level.player._id_C383.hidewhendead = 1;
        level.player._id_C383._id_B97D = 0.05;
        level.player._id_C383.base_width = 225;
        level.player._id_C383.base_height = 1;
        level.player._id_C383.pulse_width = 240;
        level.player._id_C383.pulse_height = 1;
        level.player._id_B628 = level.player._id_B1FD;
        level.player._id_B628._id_C3E1 = 38;
        level.player._id_B628._id_B7CF = 38;
        level.player._id_B628._id_BC01 = 38;
        level.player._id_B628._id_AB9F = 38;
        level.player._id_B628._id_C07F = 0.75;
        level.player._id_B628._id_B7C0 = 1;
        level.player._id_B628._id_C5FE = 0.3;
        level.player._id_B628.basefontscale = var_7;
        level.player._id_B628.pulsefontscale = var_7 * 1.1;
        level.player._id_CC41[0] = level.player._id_B628;
        level.player._id_CC41[1] = level.player._id_B69D;
        level.player._id_CC41[2] = level.player._id_BA40;
        level.player._id_CC41[3] = level.player._id_C383;
    }

    foreach ( var_15 in level.player._id_CC41 )
    {
        var_15.alignx = "center";
        var_15.aligny = "middle";
        var_15.horzalign = "center";
        var_15.vertalign = "middle";
        var_15.foreground = 1;
        var_15.hidewheninmenu = 1;

        if ( isdefined( var_3 ) && var_3 )
            var_15.alpha = var_15._id_B97D;
    }
}
...
_id_C2BA()
{
    ...
    level.player._id_AD93 = level.player._id_B628._id_C07F;
    level.player._id_B45E = level.player._id_B628._id_B7C0;
    level.player._id_B628.alpha = 0;
    level.player._id_B1FD.alpha = 0;
    var_0 = 1;
    _id_B55D( var_0 );
    thread _id_AF53();
...
_id_B55D( var_0 )
{
    ...
    var_1 = int( 30 * level.player._id_A800 );
    var_2 = int( 36 * level.player._id_A800 );
    var_3 = level.player._id_B1FD._id_B20B + 0.3;
    var_4 = level.player._id_B1FD._id_B20B;
    var_5 = level.player._id_B9DB;
    var_6 = level.player._id_B1FD;
    var_6.alpha = 0.4;
    ...
    var_5 = maps\_hud_util::createicon( "h2_prompt_anticipation", var_1, var_1 );
    var_5.color = ( 1.0, 1.0, 1.0 );
    var_5.x = level.player._id_B628.x;
    var_5.y = level.player._id_B628.y;
    var_5.alpha = 0.4;
    var_5.sort = -2;
    var_5.alignx = "center";
    var_5.aligny = "middle";
    ...
    level.player._id_B9DB = var_5;
    level.player._id_CC41[level.player._id_CC41.size] = var_5;
...
_id_BCA7()
{
    ...
    if ( !isdefined( level.player._id_B628 ) )
        return;

    var_0 = level.player._id_B628;
    var_0.color = ( 1.0, 1.0, 1.0 );
    var_1 = 0.5;
    var_2 = int( 60 * level.player._id_A800 );
    var_3 = int( 60 * level.player._id_A800 );
    var_4 = int( 30 * level.player._id_A800 );
    var_5 = int( 30 * level.player._id_A800 );
    var_6 = 0.75;
    var_7 = 0;
...
_id_AF53()
{
    ...
    level.player._id_B628.state = "idle";

    if ( var_0 )
        level waittill_or_timeout( "other_anim_complete", 1 );

    var_1 = level.player._id_B628;
    var_1.color = ( 1.0, 1.0, 1.0 );
    var_2 = 0.5;
    var_3 = int( 60 * level.player._id_A800 );
    var_4 = int( 60 * level.player._id_A800 );
    var_5 = int( 30 * level.player._id_A800 );
    var_6 = int( 30 * level.player._id_A800 );
    var_7 = 0.75;
    var_8 = 0;
...
quick_hint_mash_idle_anim_kbm()
{
    ...
    var_1 = level.player._id_B628;
    var_2 = level.player._id_B628._id_C5FE;
    var_1.alpha = var_1._id_C07F;

    for (;;)
    {
        var_1 fadeovertime( var_2 );
        var_1.alpha = var_1._id_B7C0;
        wait(var_2);
        var_1 fadeovertime( var_2 );
        var_1.alpha = var_1._id_C07F;
...
_id_B9E2()
{
    return level.player._id_B628.state;
}
...
_id_D3BA()
{
    ...
    if ( !isdefined( level.player._id_B628 ) || !isdefined( level.player._id_B1FD ) )
        return;
    ...
    level.player._id_B628.state = "active";

    if ( var_0 )
        level waittill_or_timeout( "other_anim_complete", 1 );

    var_1 = 0.3;
    var_2 = level.player._id_B1FD._id_B20B - 0.3;
    var_3 = level.player._id_B1FD._id_B20B;
    var_4 = int( 30 * level.player._id_A800 );
    var_5 = int( 30 * level.player._id_A800 );
    var_6 = int( 22 * level.player._id_A800 );
    var_7 = int( 22 * level.player._id_A800 );
    var_8 = 1;
    var_9 = 0.5;
    var_10 = 1;
    var_11 = 0.5;
    var_12 = level.player._id_B1FD;
    var_13 = level.player._id_B9DB;
    var_13.x -= 0.15;
    var_13.y -= 0.25;
...
quick_hint_mash_active_anim_kbm()
{
    ...
    for (;;)
    {
        foreach ( var_2 in level.player._id_CC41 )
        {
            ...
            if ( isdefined( var_2.pulsefontscale ) )
            {
                ...
                var_2.fontscale = var_2.pulsefontscale;
            }
        }
        ...
        foreach ( var_2 in level.player._id_CC41 )
        {
            ...
            if ( isdefined( var_2.basefontscale ) )
            {
                var_2 changefontscaleovertime( 0.1 );
                var_2.fontscale = var_2.basefontscale;
            }
        }
...
_id_BA76( var_0, var_1 )
{
    level endon( "clear_quick_hint" );
    level notify( "success_quick_hint" );

    if ( isdefined( var_0 ) || isdefined( var_1 ) )
        common_scripts\utility::waittill_any( var_0, var_1 );
    ...
    level.player._id_B628.state = "success";
    ...
    var_3 = 0.2;
    var_4 = int( 60 * level.player._id_A800 );
    var_5 = int( 60 * level.player._id_A800 );
    var_6 = int( 30 * level.player._id_A800 );
    var_7 = int( 30 * level.player._id_A800 );
    var_8 = 0.3 * level.player._id_A800;
    var_9 = 0.5;
    var_10 = 0.15;

    if ( !isdefined( level.player._id_ADFD ) )
    {
        var_11 = maps\_hud_util::createicon( "h2_prompt_circle_full", var_6, var_7 );
        var_11.color = ( 0.0, 1.0, 0.0 );
        var_11.x = level.player._id_B628.x - 0.1;
        var_11.y = level.player._id_B628.y - 0.1;
        var_11.sort = 2;
        ...
        var_11.foreground = 1;
        level.player._id_ADFD = var_11;
        level.player._id_CC41[level.player._id_CC41.size] = level.player._id_ADFD;
    }

    level.player._id_B9DB.x -= 0.1;
    level.player._id_B9DB.y -= 0.1;
    level.player._id_ADFD.alpha = 0.15;
    level.player._id_B9DB.color = ( 0.0, 1.0, 0.0 );
    level.player._id_B9DB.alpha = var_9;
    level.player._id_B1FD changefontscaleovertime( var_3 );
    level.player._id_B1FD.fontscale = var_8;
    level.player._id_B1FD fadeovertime( var_3 );
    level.player._id_B1FD.alpha = 0;
    level.player._id_B9DB scaleovertime( var_3, var_4, var_5 );
    level.player._id_B9DB fadeovertime( var_3 );
    level.player._id_B9DB.alpha = 0;
    level.player._id_ADFD scaleovertime( var_3, var_4, var_5 );
    level.player._id_ADFD fadeovertime( var_3 );
    level.player._id_ADFD.alpha = 0;
    wait(var_3);
    level.player._id_ADFD scaleovertime( 0.05, var_6, var_7 );
    wait 0.05;
    _id_B65B();
}

_id_CBD8( var_0, var_1 )
{
    level endon( "clear_quick_hint" );
    level notify( "fail_quick_hint" );

    if ( isdefined( var_0 ) || isdefined( var_1 ) )
        level.player common_scripts\utility::waittill_any( var_0, var_1 );
    ...
    level.player._id_B628.state = "fail";
    var_2 = 0.25;
    var_3 = int( 20 * level.player._id_A800 );
    var_4 = int( 20 * level.player._id_A800 );
    var_5 = int( 30 * level.player._id_A800 );
    var_6 = int( 30 * level.player._id_A800 );
    var_7 = 0.5 * level.player._id_A800;
    var_8 = 1;
    var_9 = 0.15;

    if ( !isdefined( level.player._id_ADFD ) )
    {
        var_10 = maps\_hud_util::createicon( "h2_prompt_circle_full", var_5, var_6 );
        var_10.color = ( 1.0, 0.0, 0.0 );
        var_10.x = level.player._id_B628.x - 0.2;
        var_10.y = level.player._id_B628.y - 0.4;
        var_10.sort = 2;
        ...
        level.player._id_ADFD = var_10;
        level.player._id_CC41[level.player._id_CC41.size] = level.player._id_ADFD;
    }

    level.player._id_B628.alpha = 0;
    level.player._id_B9DB.x -= 0.2;
    level.player._id_B9DB.y -= 0.4;
    level.player._id_ADFD.alpha = 0.15;
    level.player._id_B9DB.color = ( 1.0, 0.0, 0.0 );
    level.player._id_B9DB.alpha = var_8;
    level.player._id_B1FD changefontscaleovertime( var_2 );
    level.player._id_B1FD.fontscale = var_7;
    level.player._id_B1FD fadeovertime( var_2 );
    level.player._id_B1FD.alpha = 0;
    level.player._id_ADFD scaleovertime( var_2, var_3, var_4 );
    level.player._id_B9DB scaleovertime( var_2, var_3, var_4 );
    level.player._id_B9DB fadeovertime( var_2 );
    level.player._id_B9DB.alpha = var_9;
    wait(var_2);
    level.player._id_B9DB fadeovertime( 0.05 );
    level.player._id_B9DB.alpha = 0;
    level.player._id_ADFD fadeovertime( 0.05 );
    level.player._id_ADFD.alpha = 0;
    level.player._id_ADFD scaleovertime( 0.05, var_5, var_6 );
    wait 0.05;
    _id_B65B();
}
...
_id_AAA6( var_0 )
{
    ...
    foreach ( var_2 in level.player._id_CC41 )
        var_2.alpha = var_2._id_B97D;

    thread _id_C5D2( var_0 );

    while ( var_0 >= level.player._id_B628._id_C5FE )
    {
...
_id_C5D2( var_0 )
{
    ...
    var_1 = level.player._id_B628;
    var_2 = level.player._id_B628._id_C5FE;
    var_3 = var_1._id_C3E1;
    var_4 = var_1._id_B7CF;
    var_5 = var_1._id_BC01;
    var_6 = var_1._id_AB9F;
    var_7 = level.player._id_B628._id_B7C0;
    var_8 = 0;
    var_9 = 1;
    ...
    for (;;)
    {
        ...
        var_1.alpha = level.player._id_B628._id_C07F;
        wait(var_2);
        var_0 -= var_2;

        if ( level.player common_scripts\utility::is_player_gamepad_enabled() && var_8 == var_9 )
        {
            var_1.alpha = 0;
            break;
        }
...
_id_B65B()
{
    if ( !isdefined( level.player._id_CC41 ) || level.player._id_CC41.size == 0 )
        return;

    foreach ( var_1 in level.player._id_CC41 )
        var_1 maps\_hud_util::destroyelem();

    level.player._id_B628.state = undefined;
    level.player._id_CC41 = [];
...
_id_BA69()
{
    ...
    return level.player._id_B1FD.alpha > 0;
}

_id_BAB8( var_0, var_1 )
{
    if ( !isdefined( level.player._id_CC41 ) || level.player._id_CC41.size == 0 )
        return;
    ...
    if ( var_0 == "hide" )
    {
        level.player._id_B45E = 0;
        level.player._id_AD93 = 0;

        foreach ( var_3 in level.player._id_CC41 )
        {
            if ( isdefined( var_1 ) )
                var_3 fadeovertime( var_1 );

            var_3.alpha = level.player._id_B45E;
        }
    }
    else if ( var_0 == "show" )
    {
        ...
        {
            if ( isdefined( var_1 ) )
                level.player._id_B1FD fadeovertime( var_1 );

            level.player._id_B1FD.alpha = level.player._id_B1FD._id_B97D;
        }
        else
        {
            foreach ( var_3 in level.player._id_CC41 )
...
_id_CBD7( var_0, var_1 )
{
    if ( var_0 == "default" )
        return var_0;

    var_2 = [ ( 30.0, 0.0, 0.0 ), ( -30.0, 0.0, 0.0 ), ( 0.0, 30.0, 0.0 ), ( 0.0, -30.0, 0.0 ) ];

    foreach ( var_4 in var_2 )
    {
        var_5 = bullettrace( var_1 + ( 0.0, 0.0, 30.0 ) + var_4, var_1 - ( 0.0, 0.0, 100.0 ) + var_4, 0, self );
...
_id_D193( var_0, var_1, var_2 )
{
    if ( !isdefined( level._id_C179 ) )
        level._id_C179 = [];

    var_3 = spawnstruct();

    if ( isdefined( var_1 ) )
        var_3._id_C296 = var_1;

    if ( isdefined( var_2 ) )
        var_3._id_C173 = var_2;

    level._id_C179[var_0] = var_3;
}

_id_CD67( var_0, var_1 )
{
    if ( isarray( var_1 ) )
    {
        foreach ( var_3 in var_1 )
            _id_BA2A( var_0, var_3 );
    }
    else
        _id_BA2A( var_0, var_1 );
}

_id_BA2A( var_0, var_1 )
{
    var_2 = level._id_C179[var_0];

    if ( !isdefined( var_2._id_C168 ) )
        var_2._id_C168 = [];

    var_3 = spawnstruct();
    var_3.type = "info_volume";
    var_3._id_CC71 = var_1;
    var_2._id_C168[var_2._id_C168.size] = var_3;
}
...
_id_B32F( var_0, var_1 )
{
    if ( !isdefined( var_0 ) && !isdefined( var_1 ) )
    {
        level._id_A9A7 = undefined;
        return;
    }

    if ( !isdefined( level._id_A9A7 ) )
        level._id_A9A7 = spawnstruct();

    level._id_A9A7._id_C296 = var_0;
    level._id_A9A7._id_C173 = var_1;
}

_id_D29A( var_0, var_1 )
{
    foreach ( var_3 in var_0 )
    {
        if ( !isalive( var_3 ) )
        ...
        var_3.ignoresuppression = var_1;
        var_3.a.disablepain = var_1;
        var_3.allowpain = !var_1;
...
_id_C636( var_0 )
{
    if ( !isdefined( level._id_AF28 ) )
        level._id_AF28 = getdvar( "r_dof_physical_adsFocusSpeed" );

    if ( !isdefined( var_0 ) )
    {
        var_0 = level._id_AF28;
        level._id_AF28 = undefined;
    }
...
_id_D295( var_0 )
{
    ...
    if ( isdefined( level._id_C17A ) )
        var_1 = level._id_C17A;
    else if ( isdefined( level._id_CC2F ) )
        var_1 = level._id_CC2F;
...
_id_C0C2( var_0, var_1 )
{
    if ( isdefined( var_1 ) && var_1 )
        level._id_C17A = var_0;
    else
        level._id_CC2F = var_0;
}

_id_AB48( var_0, var_1, var_2 )
{
    level.player endon( "death" );
    ...
    for (;;)
    {
        var_6 = self.origin - level.player geteye();
        var_7 = anglestoforward( level.player _meth_846A() );
...
_id_B0A0( var_0 )
{
    ...
    common_scripts\utility::delay_script_call( var_0, ::_id_BEC5 );
    return !level.player._id_B3CE;
}
...
_id_B630()
{
    ...
    level._id_B3B6 = var_0;
}

_id_C402()
{
    setsaveddvar( "cg_gunDownAnimDelayTimeForFriendlyFire", level._id_B3B6 );
    level._id_B3B6 = undefined;
}
...
_id_D118()
{
    ...
    level._id_A8F8 = var_0;
}

_id_C12E()
{
    setsaveddvar( "cg_gunDownAnimDelayTimeForWorldGeo", level._id_A8F8 );
    level._id_A8F8 = undefined;
}
