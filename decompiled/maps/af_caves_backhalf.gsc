...
barrel_explosive()
{
    ...
    for (;;)
    {
        ...
        var_2 = var_0.origin + ( 0.0, 0.0, 15.0 );
...
_id_C0AB()
{
    var_0 = spawn( "script_origin", self.origin + ( 0.0, 0.0, 32.0 ) );
...
_id_B247()
{
    ...
    var_0 = 4;
    objective_add( var_0, "active", &"AF_CAVES_OBJ_BREACH", ( 0.0, 0.0, 0.0 ) );
...
after_death_vfx( var_0, var_1, var_2 )
{
    ...
    var_3.origin = var_4 + ( 0.0, 0.0, 10.0 );
