...
_id_B750()
{
    ...
    level._id_B8D5 = -2000;
    level._id_AD92 = 6;
    level._id_BA1A = spawn( "script_origin", level.player.origin + ( 0.0, 0.0, 88.0 ) );
...
_id_BB86()
{
    ...
    level._id_BAA5 = spawn( "script_model", ( 0.0, 0.0, 0.0 ) );
...
_id_AEF4( var_0 )
{
    ...
    for ( var_3 = 0; var_3 < var_0.size; var_3++ )
    {
        ...
        var_9 = get_position_from_spline( var_4, var_4._id_AB4E, var_7 );
        _id_B42C( var_4.z, var_8, var_9, ( 0.0, 0.5, 1.0 ), 1, 1, 50000 );
        var_10 = get_position_from_spline( var_4, 0, var_7 * -1 );
        var_11 = get_position_from_spline( var_4, var_4._id_AB4E, var_7 * -1 );
        _id_B42C( var_4.z, var_10, var_11, ( 0.0, 0.5, 1.0 ), 1, 1, 50000 );
        _id_B42C( var_4.z, var_8, var_10, ( 0.0, 0.5, 1.0 ), 1, 1, 50000 );
        _id_B42C( var_4.z, var_9, var_11, ( 0.0, 0.5, 1.0 ), 1, 1, 50000 );
        ...
        foreach ( var_16 in var_4.col_lines )
        {
            ...
            _id_B42C( var_4.z, var_17, var_18, ( 1.0, 0.0, 0.0 ), 1, 1, 50000 );
        }
    }
}
...
draw_col_vol( var_0, var_1 )
{
    ...
    _id_B42C( var_0, var_2, var_3, ( 0.5, 0.0, 1.0 ), 1, 1, 50000 );
...
_id_CFB2( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    _id_B42C( var_0, var_6, var_7, ( 0.5, 0.0, 1.0 ), 1, 1, 50000 );
}
...
_id_B365( var_0, var_1 )
{
    ...
    if ( isdefined( level.player._id_BF88 ) )
        var_6 = 0;
...
_id_B44C()
{
    ...
    var_6 = bullettrace( var_4 + ( 0.0, 0.0, 1500.0 ), var_4 + ( 0.0, 0.0, -12000.0 ), 0, undefined, 0, 0, 1, 0, 0, 1 );
    var_4 = var_6["position"];
    var_7 = getent( "snowmobile_spawner", "targetname" );
    var_8 = var_3["targ"];
    var_7.origin = var_4;
    var_7.angles = vectortoangles( var_8.next_node.midpoint - var_8.midpoint );
    var_9 = var_7 maps\_vehicle_code::get_vehicle_ai_spawners();

    foreach ( var_11 in var_9 )
        var_11.origin = var_7.origin;

    var_13 = maps\_vehicle::vehicle_spawn( var_7 );
    var_13._id_D4A7 = var_3["offset"];
    var_13 vehphys_setspeed( 90 );
    var_13 thread _id_D3A7();
    var_13._id_CB7A = gettime() - 3000;
    var_8 _id_C27E( var_13 );
}
...
_id_C27E( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_0.wipeout )
        {
            ...
            var_0 common_scripts\utility::delaycall( var_5, ::vehphys_crash );

            if ( isdefined( var_0._id_BBBC ) && var_0._id_BBBC )
            {
                var_6 = var_0 vehicle_getspeed();
                var_7 = var_0 _meth_84BC();
                var_6 = var_6 / var_7 * 750;
                var_0 common_scripts\utility::delaycall( var_5 + 0.25, ::_meth_823A, ( 0.0, 0.0, 1.0 ), 10, var_6, 2 );
            }

            foreach ( var_9 in var_0.riders )
            {
                ...
                if ( isdefined( var_9 ) )
                    _id_BDE2::rider_death_animate_or_ragdoll( var_0, var_9 );
            }
...
{
    while ( maps\_utility::player_looking_at( self.origin, 0.75, 1 ) )
    {
        wait 0.5;
    ...
    {
        if ( !maps\_utility::player_looking_at( var_5.origin, 0.75, 1 ) )
            var_5 delete();
    }
...
_id_C446()
{
    ...
    for (;;)
    {
        ...
        var_3 += var_4;
        var_0 = self.origin;
        var_5 = _id_D0EB( self._id_AAAC, var_3 );
...
match_player_speed( var_0, var_1 )
{
    ...
    if ( isdefined( self._id_C5AA.next_node ) )
        var_3 = vectornormalize( self._id_C5AA.next_node.midpoint - self._id_C5AA.midpoint );

    var_4 = get_progression_between_points( level.player.vehicle.origin, self.origin + var_3, self.origin );
    var_5 = var_4["progress"];
    self._id_B5E0 = 0;
...
_id_AC20( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            level._id_CEB7 = maps\_utility::array_removedead( level._id_CEB7 );
...
_id_C2CD( var_0 )
{
    ...
    if ( var_5 != var_5.next_node )
    {
        var_25 = var_1 _id_C2A1( var_5, var_3, var_4, var_1.origin[2] );
        var_26 = ( var_1.origin[0], var_1.origin[1], level.player.origin[2] );
        var_27 = maps\_utility::get_dot( var_26, var_1.angles, level.player.origin );
        var_16 = 1.0;
        ...
        if ( isdefined( var_1._id_B5E0 ) )
        {
            var_1.veh_topspeed = var_1._id_B5E0 * 1.25;
            var_1 vehicledriveto( var_25, var_1._id_B5E0 * var_16 );
        }
    }
...
_id_D0EB( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 < 0 )
        {
            var_1 += var_0.prev_node._id_AB4E;
            var_0 = var_0.prev_node;
            continue;
        }
