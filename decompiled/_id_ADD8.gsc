...
{
    maps\_vehicle::build_template( "suburban", var_0, var_1, var_2 );
    maps\_vehicle::build_localinit( ::init_local );
    maps\_vehicle::build_deathmodel( "vehicle_suburban", "vehicle_suburban_destroyed" );
    maps\_vehicle::build_deathmodel( "vehicle_suburban_minigun_viewmodel", "vehicle_suburban_minigun_viewmodel" );
    maps\_vehicle::build_deathfx( "fx/fire/firelp_med_pm", "TAG_CAB_FIRE", "fire_metal_medium", undefined, undefined, 1, 0 );
    maps\_vehicle::build_deathfx( "fx/explosions/vehicle_explosion_suburban", "TAG_DEATH_FX", "explo_metal_rand" );
    ...
    maps\_vehicle::build_radiusdamage( ( 0.0, 0.0, 32.0 ), 300, 200, 0, 0 );
    maps\_vehicle::build_light( var_2, "combined", "tag_body", "fx/misc/car_suburban_combined_emission", "combined" );
    maps\_vehicle::build_light( var_2, "strobe_01", "tag_headlight_left", "fx/misc/car_suburban_bottom_front_strobe_l", "strobelights" );
    maps\_vehicle::build_light( var_2, "strobe_02", "tag_headlight_right", "fx/misc/car_suburban_bottom_front_strobe_r", "strobelights" );
}
...
setanims()
{
    ...
    var_0[5].idle = %suburban_idle_backl;
    ...
    var_0[5].getout = %suburban_dismount_backl;
    var_0[4].getout = %suburban_dismount_backr;
