...
doimmediateragdolldeath()
{
    ...
    if ( level._id_AE66 || isdefined( level._id_C08E ) && self.damageweapon == level._id_C08E )
    ...
    if ( isdefined( level._id_AE66 ) && level._id_AE66 && self.damageweapon == "riotshield" )
...
play_blood_pool( var_0, var_1 )
{
    ...
    var_8 = common_scripts\utility::ter_op( isdefined( anim._id_B274 ) && isdefined( anim._id_B274[var_7["surfacetype"]] ), var_7["surfacetype"], "default" );

    if ( isdefined( level._id_B41F ) )
        var_8 = [[ level._id_B41F ]]( var_8, var_2 );

    if ( var_7["normal"][2] > 0.9 )
        playfx( level._effect["bloodpool_" + var_8], var_7["position"] );
}

specialdeath()
{
    if ( ( level._id_AE66 || isdefined( level._id_C08E ) && self.damageweapon == level._id_C08E ) && getdvarint( "ragdoll_enable" ) && !issubstr( self.classname, "actor_civilian_slum_" ) )
    {
        doimmediateragdolldeath();
        return 1;
    }
    ...
    switch ( self.a.special )
    {
        case "cover_right":
            ...
            else
            {
                ...
                if ( animscripts\utility::damagelocationisany( "head", "neck" ) )
                    var_0 = animscripts\utility::lookupanim( "death", "cover_right_crouch_head" )[animscripts\corner::_id_C35D( self )];
                else
                    var_0 = animscripts\utility::lookupanim( "death", "cover_right_crouch_default" )[animscripts\corner::_id_C35D( self )];
        ...
        case "cover_left":
            ...
            {
                var_0 = animscripts\utility::lookupanim( "death", "cover_left_crouch" )[animscripts\corner::_id_C35D( self )];
                dodeathfromarray( var_0 );
            }
        ...
        case "dog_attack":
            ...
            dodeathfromarray( animscripts\utility::lookupanim( "death", "dog_attack" ) );
            return 1;
    }
...
helmetpop( var_0 )
{
    ...
    var_1 = getpartname( self.hatmodel, 0 );
    var_2 = spawn( "script_model", self.origin + ( 0.0, 0.0, 64.0 ) );
    var_3 = _id_B001();
    var_2 setmodel( var_3 );
    var_2.origin = self gettagorigin( var_1 );
    var_2.angles = self gettagangles( var_1 );
    var_2 thread helmetlaunch( common_scripts\utility::ter_op( isdefined( var_0 ), var_0, self.damagedir ) );
    var_4 = self.hatmodel;
...
_id_B001()
{
    ...
    foreach ( var_3, var_2 in level._id_B8B8 )
    {
        if ( var_0 == var_3 )
        {
            var_0 = var_2;
...
{
    level._id_B8B8 = [];
    level._id_B8B8["helmet_sp_arab_regular_tariq"] = "helmet_sp_arab_regular_tariq_nostrap";
    level._id_B8B8["helmet_sp_arab_regular_suren"] = "helmet_sp_arab_regular_suren_nostrap";

    foreach ( var_1 in level._id_B8B8 )
        precachemodel( var_1 );
}
...
getcrouchdeathanim()
{
    ...
    else
    {
        ...
        if ( animscripts\utility::damagelocationisany( "head", "neck" ) )
            var_0 = animscripts\utility::lookupanim( "death", var_1 + "crouch_head" );

        if ( animscripts\utility::damagelocationisany( "torso_upper", "torso_lower", "left_arm_upper", "right_arm_upper", "neck" ) )
            var_0 = common_scripts\utility::array_combine( var_0, animscripts\utility::lookupanim( "death", var_1 + "crouch_torso" ) );

        if ( var_0.size < 2 )
            var_0 = common_scripts\utility::array_combine( var_0, animscripts\utility::lookupanim( "death", var_1 + "crouch_default1" ) );

        if ( var_0.size < 2 )
            var_0 = common_scripts\utility::array_combine( var_0, animscripts\utility::lookupanim( "death", var_1 + "crouch_default2" ) );
    }
