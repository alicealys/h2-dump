...
_id_D368( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( isdefined( var_0["stairs"] ) && var_0["normal"][2] < 0.9962 )
    {
        ...
        var_9 = var_10["pos"];
        var_11 = _id_B710( self.lookaheaddir, self.lookaheaddist, var_9, var_0["normal"], self.origin, ( 0.0, 0.0, 1.0 ), 15 );
...
_id_C39A( var_0, var_1, var_2, var_3 )
{
    ...
    var_9 = _id_C4A5( var_6, var_7, var_8, 0, 48 );
    var_14 = _id_B710( self.lookaheaddir, self.lookaheaddist, var_9, var_10, self.origin, ( 0.0, 0.0, 1.0 ), 15 );
...
_id_CF97( var_0 )
{
    ...
    var_14 = _id_B710( self.lookaheaddir, self.lookaheaddist, var_1["pos"], var_1["normal"], var_13, ( 0.0, 0.0, 1.0 ), 15 );
    var_15["wantedPos"] = var_14["position"];
    var_15["stairEdgeDir"] = var_14["stairEdgeDirection"];
...
_id_BCC4( var_0, var_1, var_2, var_3 )
{
    ...
    if ( self.stairsstate == "none" && var_8 )
    {
        ...
        var_11 = self.origin + ( 0.0, 0.0, 1.0 );
