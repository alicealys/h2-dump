...
aimedatshootentorpos()
{
    ...
    if ( self.a.pose == "crouch" && distancesquared( self geteye(), self.shootpos ) < anim._id_AF5C )
        var_5 = anim._id_C918;
...
needtoreload( var_0 )
{
    ...
    if ( animscripts\stairs_utility::_id_D4EB( 100 ) )
    {
        if ( self.bulletsinclip < weaponclipsize( self.weapon ) * 0.5 )
            self.bulletsinclip = int( weaponclipsize( self.weapon ) * 0.5 );
...
_id_B4A5( var_0 )
{
    ...
    {
        self._id_AE7D = spawn( "script_model", self gettagorigin( "tag_inhand" ) );
        var_1 = animscripts\utility::getgrenademodel();
        self._id_AE7D setmodel( var_1 );
        self._id_AE7D linkto( self, "tag_inhand", ( 0.0, 0.0, 3.0 ), ( 0.0, 0.0, 0.0 ) );
    }
    else if ( var_0 == "grenade_throw" )
    {
        self._id_AE7D delete();
        self._id_AE7D = undefined;
        return "end";
    }
}
...
{
    if ( !self isgrenadepossafe( var_0, var_1 ) && !_id_C0C3::iswolf( self ) )
        return 0;
...
trygrenade( var_0, var_1 )
{
    ...
    if ( isdefined( self.enemy ) && var_0 == self.enemy )
    {
        ...
        {
            if ( !self isgrenadepossafe( var_0, var_0.origin ) && !_id_C0C3::iswolf( self ) )
                return 0;
        ...
        else
        {
            ...
            if ( !self isgrenadepossafe( var_0, var_3 ) && !_id_C0C3::iswolf( self ) )
                return 0;
...
trygrenadethrow( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( !var_7 && animscripts\stairs_utility::_id_D458() )
        return 0;
    ...
    else
    {
        ...
        var_12 = self.randomgrenaderange;
    ...
    if ( isdefined( self.nextgrenadetrydelayminmax ) )
        self.a.nextgrenadetrytime = gettime() + randomintrange( self.nextgrenadetrydelayminmax[0], self.nextgrenadetrydelayminmax[1] );
    else
    ...
    if ( isdefined( var_10 ) )
    {
        ...
        var_13 = getdesiredgrenadetimervalue();
        setgrenadetimer( self.activegrenadetimer, min( gettime() + 3000, var_13 ) );
        var_14 = 0;
        ...
        if ( isdefined( var_6 ) )
            thread dogrenadethrow( var_8, var_10, var_13, var_14 );
        else
            dogrenadethrow( var_8, var_10, var_13, var_14 );
...
checkgrenadethrowdist()
{
    ...
    if ( isdefined( level._id_B48D ) && level._id_B48D )
...
monitorflash()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self._id_B5B8 ) && self._id_B5B8 )
