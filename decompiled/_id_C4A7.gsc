...
_id_AEF4( var_0 )
{
    ...
    for ( var_3 = 0; var_3 < var_0.size; var_3++ )
    {
        ...
        _id_B42C( var_4.z, var_12, var_13, ( 0.0, 0.5, 1.0 ), 1, 1, 50000 );
        _id_B42C( var_4.z, var_10, var_12, ( 0.0, 0.5, 1.0 ), 1, 1, 50000 );
        _id_B42C( var_4.z, var_11, var_13, ( 0.0, 0.5, 1.0 ), 1, 1, 50000 );
        ...
        foreach ( var_18 in var_4.col_lines )
        {
            ...
            _id_B42C( var_4.z, var_19, var_20, ( 1.0, 0.0, 0.0 ), 1, 1, 50000 );
        }
    }
}
