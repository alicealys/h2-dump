...
init_locked_list()
{
    ...
    level._createfx.lockedlist["del"] = 1;
    level._createfx.lockedlist["x"] = 1;
}
...
_id_B0D9()
{
    ...
    var_1._id_BD42 = 0;
    var_1._id_BFCF = 0;
    var_1._id_BAF5 = -0.002;
    var_1.glowcolor = ( 0.0, 0.0, 0.0 );
    var_1._id_B756 = 0.5;
    var_1._id_CA69 = -0.1;
    var_1._id_B48A = 0;
    var_1._id_D329 = ( 0.0, 0.0, 0.0 );
    var_1._id_BD52 = 0.75;
    var_0._id_B01B = var_1;
    level._createfx._id_D30F = var_0;
}

_id_C336( var_0 )
{
    var_1 = level._createfx._id_D30F._id_B01B;
    var_0 _meth_8355( var_1._id_B982, var_1._id_BD42, var_1._id_BFCF, var_1._id_BAF5, var_1.glowcolor, var_1._id_B756, var_1._id_CA69, var_1._id_B48A, var_1._id_D329, var_1._id_BD52 );
}
...
createfxlogic()
{
    ...
    if ( isdefined( level.func_position_player ) )
    ...
    for (;;)
    {
        ...
        if ( button_is_clicked( "h" ) )
            show_help();

        if ( level.createfx_help_active )
            common_scripts\_createfxmenu::help_navigation_buttons();
...
modify_player_speed()
{
    ...
    if ( !level.createfx_help_active && ( var_0 || !isdefined( level._createfx.player_speed_hud ) ) )
        set_player_speed_hud();
}
...
set_player_speed_hud()
{
    if ( !isdefined( level._createfx.player_speed_hud ) )
    {
        ...
        var_0.aligny = "bottom";
        var_0.foreground = 1;
        var_0.fontscale = level._createfx._id_D30F.fontscale;
        var_0.alpha = 1.0;
        var_0.x = 0;
        var_0.y = 450;
        _id_C336( var_0 );
...
_id_B121()
{
    if ( isdefined( level._createfx.player_speed_hud ) )
    {
        level._createfx.player_speed_hud destroy();
        level._createfx.player_speed_hud = undefined;
    }
}
...
manipulate_createfx_ents( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    for ( var_5 = 0; var_5 < level.createfxent.size; var_5++ )
    {
        ...
        if ( _id_B649( var_6, getdvar( "createfx_filter" ), 0 ) )
            continue;

        if ( _id_B649( var_6, getdvar( "createfx_filter_out" ), 1 ) )
            continue;
...
{
    level.createfx_help_active = 0;
    common_scripts\_createfxmenu::draw_effects_list( "Select by name" );
}
...
handle_selected_ents( var_0 )
{
    if ( level._createfx.selected_fx_ents.size > 0 && level.createfx_help_active == 0 )
    {
        ...
        if ( !current_mode_hud( "selected_ents" ) )
        {
            ...
            set_tool_hudelem( "Mode( KP 5 ):", "move" );
        ...
        {
            set_tool_hudelem( "Mode( KP 5 ):", "rotate" );
...
{
    if ( button_is_clicked( "kp_5", "BUTTON_X" ) )
        toggle_axismode();
...
modify_rate()
{
    ...
    if ( button_is_clicked( "=", "kp_plus" ) )
    {
        ...
        else if ( level._createfx.rate < 0.1 )
            level._createfx.rate = 0.1;
        else
            level._createfx.rate += 0.1;
    }
    else if ( button_is_clicked( "-", "kp_minus" ) )
    {
        if ( var_0 )
            level._createfx.rate -= 0.025;
        else if ( var_1 )
...
delete_selection()
{
    ...
    for ( var_1 = 0; var_1 < level.createfxent.size; var_1++ )
    {
        ...
        if ( ent_is_selected( var_2 ) )
        {
            ...
            {
                var_2.loopsound_ent stopsounds();
...
createfx_centerprint_thread( var_0 )
{
    ...
    var_1 = var_0.size;
    var_2 = level.createfx_centerprint.size;
    ...
    while ( level.createfx_inputlocked )
        wait 0.1;
...
get_selected_move_vector()
{
    ...
    if ( buttondown( "kp_pgup", "BUTTON_Y" ) )
    {
    ...
    else if ( buttondown( "kp_pgdn", "BUTTON_B" ) )
    {
        if ( level.selectedmove_up > 0 )
            level.selectedmove_up = 0;
...
process_button_held_and_clicked()
{
    ...
    add_kb_button( "kp_leftarrow" );
    add_kb_button( "kp_rightarrow" );
    add_kb_button( "kp_uparrow" );
    add_kb_button( "kp_downarrow" );
    add_kb_button( "kp_home" );
    add_kb_button( "kp_end" );
    add_kb_button( "kp_pgup" );
    add_kb_button( "kp_pgdn" );
    add_kb_button( "kp_ins" );
    add_kb_button( "kp_del" );
    add_kb_button( "kp_enter" );
    add_kb_button( "kp_plus" );
    add_kb_button( "kp_minus" );
    add_kb_button( "kp_star" );
    add_kb_button( "kp_slash" );
    add_kb_button( "kp_5" );
}

locked( var_0 )
{
    if ( level._id_B193 && isdefined( level.button_is_kb[var_0] ) )
        return 1;
...
kb_locked( var_0 )
{
    return ( level._id_B193 || level.createfx_inputlocked ) && isdefined( level.button_is_kb[var_0] );
}
...
init_huds()
{
    ...
    for ( var_0 = 0; var_0 < level._createfx.hudelem_count; var_0++ )
    {
        ...
        var_2.location = 0;
        var_2.foreground = 1;
        var_2.fontscale = level._createfx._id_D30F.fontscale;
        var_2.sort = 20;
        var_2.alpha = 1;
        var_2.x = 0;
        var_2.y = 30 + var_0 * level._createfx._id_D30F._id_AAD8;
        _id_C336( var_2 );
    ...
    for ( var_0 = 0; var_0 < 5; var_0++ )
    {
        ...
        var_2.alpha = 1;
        var_2.x = 320;
        var_2.y = 280 + var_0 * level._createfx._id_D30F._id_AAD8;
        _id_C336( var_2 );
        var_1[var_1.size] = var_2;
    }
...
new_tool_hudelem( var_0 )
{
    ...
    var_1.location = 0;
    var_1.foreground = 1;
    var_1.fontscale = level._createfx._id_D30F.fontscale;
    var_1.alpha = 1;
    var_1.x = 0;
    var_1.y = 350 + var_0 * level._createfx._id_D30F._id_AAD8;
    _id_C336( var_1 );
    return var_1;
}
    ...
    if ( var_0.size > 0 )
    {
        for ( var_2 = 0; var_2 < var_0.size; var_2++ )
        {
            ...
            if ( isdefined( var_0[var_2].v ) )
            {
                ...
                var_3.v["kill_on_delete"] = var_0[var_2].v["kill_on_delete"];
                var_3.v["ignore_fx_volume_groups"] = var_0[var_2].v["ignore_fx_volume_groups"];
...
_id_C30A()
{
    ...
    if ( isdefined( self.v["ignore_fx_volume_groups"] ) && self.v["ignore_fx_volume_groups"] )
    {
        self.v["fx_volume_groups"] = undefined;
        return;
    }

    self.v["fx_volume_groups"] = [];

    foreach ( var_6, var_1 in level._id_C179 )
    {
        var_2 = 0;

        if ( !isdefined( var_1._id_C168 ) )
            continue;

        foreach ( var_4 in var_1._id_C168 )
        {
            if ( _id_D56A( self.v["origin"], var_4 ) )
            {
                var_2 = 1;
                break;
            }
        ...
        if ( var_2 )
            self.v["fx_volume_groups"][self.v["fx_volume_groups"].size] = var_6;
    }
}
...
_id_D56A( var_0, var_1 )
{
    ...
    {
        case "info_volume":
            if ( !isdefined( level._id_AD22 ) )
                level._id_AD22 = spawn( "script_origin", ( 0.0, 0.0, 0.0 ) );

            level._id_AD22.origin = var_0;
            var_2 = level._id_AD22 istouching( var_1._id_CC71 );
            break;
        default:
            common_scripts\utility::error( "Unhandled FX volume type!" );
            break;
    }
